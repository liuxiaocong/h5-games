...
var addToHome = function(e) {
	...
	window.VoyagerApi = function() {
		...
		e.prototype._apiRequest = function(e, t, n, r, i) {
			...
			navigator.userAgent.toLowerCase().indexOf("android") >= 0 && e === "GET" && (t += ""),
			s = this._openXHR(e, t),
...
function() {
	...
	I18n.fallbacks = !0,
	SG_jQuery('<link rel="stylesheet" type="text/css" href="./voyager-4a539c83e86cc1b9c591d5ced5e8165a.css" >').appendTo("head"),
	//Softgames.prototype.defaultSubsystem = "m.softgames.de",
	//Softgames.prototype.defaultSubsystem = "#",
