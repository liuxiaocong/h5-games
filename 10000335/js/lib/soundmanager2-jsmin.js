...
(function(h, g) {
    function fa(fa, wa) {
        ...
        this.createSound = function(b, d) {
            ...
            f = B(b);
            f.url = pa(f.url);
            void 0 === f.id && (f.id = c.setupOptions.idPrefix + kb++);
            ...
            if (ra(f)) a = e(), c._wD(f.id + ": Using HTML5"), a._setup_html5(f);
                ...
                a = e();
                8 === n ? k._createSound(f.id, f.loops || 1, f.usePolicyFile) : (k._createSound(f.id, f.url, f.usePeakData, f.useWaveformData, f.useEQData, f.isMovieStar, f.isMovieStar ? f.bufferTime : !1, f.loops || 1, f.serverURL, f.duration || null, f.autoPlay, !0, f.autoLoad, f.usePolicyFile), f.serverURL || (a.connected = !0, f.onconnect && f.onconnect.apply(a)));
        ...
        this.reboot = function(b, d) {
            ...
            kb = 0;
            if (b) F = [];
            else for (e in F) if (F.hasOwnProperty(e)) {
                a = 0;
        ...
        Ua = function(b) {
            ...
            this.url = b.url;
            this._iO = this.instanceOptions = this.options = B(b);
            ...
            this.load = function(b) {
                ...
                a.playState = 0;
                a.id3 = {};
                if (ra(e)) d = a._setup_html5(e), d._called_load ? c._wD(a.id + ": Ignoring request to load again") : (a._html5_canplay = !1, a.url !== e.url && (c._wD(p("manURL") + ": " + e.url), a._a.src = e.url, a.setPosition(0)), a._a.autobuffer = "auto", a._a.preload = "auto", a._a._called_load = !0, e.autoPlay && a.play());
                else {
            ...
            this.start = this.play = function(b, d) {
                ...
                1 === a.playState && !a.paused && ((f = a._iO.multiShot) ? c._wD(e + "Already playing (multi-shot)", 1) : (c._wD(e + "Already playing (one-shot)", 1), a.isHTML5 && a.setPosition(a._iO.position), x = a));
                if (null !== x) return x;
                ...
                if (a.paused && 0 <= a.position && (!a._iO.serverURL || 0 < a.position)) c._wD(e + "Resuming from paused state", 1), a.resume();
                    ...
                    a.isHTML5 ? 2 > a.instanceCount ? (m(), e = a._setup_html5(), a.setPosition(a._iO.position), e.play()) : (c._wD(a.id + ": Cloning Audio() for instance #" + a.instanceCount + "..."), l = new Audio(a._iO.url), z = function() {
                        ...
                        l.play()
                    }, w.add(l, "ended", z), a._iO.position ? w.add(l, "canplay", h) : l.play()) : (x = k._start(a.id, a._iO.loops || 1, 9 === n ? a.position : a.position / 1E3, a._iO.multiShot || !1), 9 === n && !x && (c._wD(e + "No sound hardware, or 32-sound ceiling hit", 2), a._iO.onplayerror && a._iO.onplayerror.apply(a)))
                }
                return a
            };
            this.stop = function(b) {
            ...
            this.resume = function() {
                ...
                a.paused = !1;
                a.playState = 1;
                a.isHTML5 ? (a._setup_html5().play(), m()) : (b.isMovieStar && !b.serverURL && a.setPosition(a.position), k._pause(a.id, b.multiShot));
            ...
            this._setup_html5 = function(b) {
                ...
                if (c) {
                    if (c._s) if (E) c._s && (c._s.playState && !e) && c._s.stop();
                    else if (!E && d === decodeURI(u)) return a._apply_loop(c, b.loops), c;
                    e || (f(!1), c.src = b.url, La = u = a.url = b.url, c._called_load = !1)
        ...
        Aa = function(b, d) {
            ...
            for (e in b) if (b.hasOwnProperty(e)) if ("object" !== typeof b[e] || null === b[e] || b[e] instanceof Array || b[e] instanceof RegExp) f && O[d] !== g ? c[d][e] = b[e] : x[e] !== g ? (c.setupOptions[e] = b[e], c[e] = b[e]) : O[e] === g ? (J(r(c[e] === g ? "setupUndef" : "setupError", e), 2), a = !1) : c[e] instanceof Function ? c[e].apply(c, b[e] instanceof Array ? b[e] : [b[e]]) : c[e] = b[e];
        ...
        G = {
            ...
            progress: s(function(b) {
                ...
                if (z && z.length) {
                    ...
                    g && !isNaN(l) && c._wD(this._s.id + ": progress, " + Math.floor(100 * l) + "% loaded")
                }
        ...
        ra = function(b) {
            return !b || !b.type && !b.url && !b.serverURL ? !1 : b.serverURL || b.type && ga(b.type) ? !1 : b.type ? ba({
                type: b.type
            }) : ba({
                url: b.url
        ...
        gb = function() {
            ...
            var d = Audio !== g ? Oa && 10 > opera.version() ? new Audio(null) : new Audio : null,
                ...
                h;
            h = c.audioFormats;
            for (e in h) if (h.hasOwnProperty(e) && (a = "audio/" + e, f[e] = b(h[e].type), f[a] = f[e], e.match(nb) ? (c.flash[e] = !0, c.flash[a] = !0) : (c.flash[e] = !1, c.flash[a] = !1), h[e] && h[e].related)) for (a = h[e].related.length - 1; 0 <= a; a--) f["audio/" + h[e].related[a]] = f[e], c.html5[h[e].related[a]] = f[e], c.flash[h[e].related[a]] = f[e];
        ...
        Ia = function() {
            ...
            c.ok() ? (c.didFlashBlock && c._wD(b + ": Unblocked"), c.oMC && (c.oMC.className = [T(), "movieContainer", "swf_loaded" + (c.didFlashBlock ? " swf_unblocked" : "")].join(" "))) : (u && (c.oMC.className = T() + " movieContainer " + (null === d ? "swf_timedout" : "swf_error"), c._wD(b + ": " + r("fbTimeout") + (d ? " (" + r("fbLoaded") + ")" : ""))), c.didFlashBlock = !0, M({
                type: "ontimeout",
                ignoreInit: !0,
                error: e
            }), S(e))
        ...
        fb = function() {
            ...
            if (c.useHTML5Audio && c.hasHTML5) for (d in qa = !0, e) if (e.hasOwnProperty(d) && e[d].required) if (c.html5.canPlayType(e[d].type)) {
        ...
        cb = function(b) {
            b._hasTimer || (b._hasTimer = !0, !Pa && c.html5PollingInterval && (null === aa && 0 === oa && (aa = setInterval(eb, c.html5PollingInterval)), oa++))
        };
        db = function(b) {
        ...
        la = function(b, d) {
            ...
            Fa();
            l = T();
            if (k = ka()) if (c.oMC = A(c.movieID) || m.createElement("div"), c.oMC.id) q = c.oMC.className, c.oMC.className = (q ? q + " " : "movieContainer") + (l ? " " + l : ""), c.oMC.appendChild(f), L && (p = c.oMC.appendChild(m.createElement("div")), p.className = "sm2-object-box", p.innerHTML = s), W = !0;
            else {
                c.oMC.id = c.movieID;
        ...
        ia = function() {
            if (Ra || !va) return w.remove(h, "focus", ia), !0;
            Ra = mb = !0;
            p("gotFocus");
            $ = !1;
            Q();
        ...
        ya = function() {
            ...
            ja();
            try {
                k._externalInterfaceTest(!1), Ya(!0, c.flashPollingInterval || (c.useHighPerformance ? 10 : 50)), c.debugMode || k._disableDebug(), c.enabled = !0, C("jstoflash", !0), c.html5Only || w.add(h, "unload", xa)
            } catch (b) {
        ...
        R = function() {
            ...
            var b = null,
                b = null,
                d = U.toLowerCase(); - 1 !== d.indexOf("sm2-usehtml5audio\x3d") && (b = "1" === d.charAt(d.indexOf("sm2-usehtml5audio\x3d") + 18), da && console.log((b ? "Enabling " : "Disabling ") + "useHTML5Audio via URL parameter"), c.setup({
                useHTML5Audio: b
            ...
            m.removeEventListener && m.removeEventListener("DOMContentLoaded", R, !1);
            ja();
            return !0
        };
        Ka = function() {
