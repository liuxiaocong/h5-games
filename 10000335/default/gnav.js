...
else if(gnav.ImsHost.indexOf('localhost') > -1 || gnav.ImsHost.indexOf('day.adobe.com') > -1 || gnav.ImsHost.indexOf('macromedia.com') > -1 || gnav.ImsHost.indexOf('127.0.0.1') > -1 || gnav.ImsHost.indexOf('aceui.') > -1)
{
gnav.ImsJS = '-dev2';
gnav.ImsClientId = gnav.ImsTestClientId;
