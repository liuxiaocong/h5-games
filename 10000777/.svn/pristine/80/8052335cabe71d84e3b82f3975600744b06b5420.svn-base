...
(function(t) {
    ...
    function d(t, n, o, s, u) {
        this.version = "0.13.2", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new t({
            isMaster: !0
    ...
    (function(t) {
        ...
        function x(t) {
            return function() {
                return R([this, N(arguments)], function(e, n) {
                    return t.apply(e, n)
                })
            }
        }
        ...
        function G(t) {
            return g(t, function(t) {
                return t = K(t, p), g(N(K(t, function(t) {
                    return g(t, H, H)
                })), function() {
                    return t
                })
        ...
        }, p.Promise = d, p.promise = d, d.race = h, d.all = N, d.reject = T, d.resolve = p, p.passByCopy = function(t) {
            return t
        ...
        p.resetUnhandledRejections = w, p.getUnhandledReasons = function() {
            ...
            w(), oe = !1
        }, w(), p.reject = T, p.fulfill = I, p.master = M, p.spread = R, f.prototype.spread = function(t, e) {
        ...
        }, p.all = N, f.prototype.all = function() {
            return N(this)
        }, p.allResolved = c(G, "allResolved", "allSettled"), f.prototype.allResolved = function() {
            return G(this)
