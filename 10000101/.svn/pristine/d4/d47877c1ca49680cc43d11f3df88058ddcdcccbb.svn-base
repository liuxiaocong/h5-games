...
FieldContainer.prototype.getSprTile = function(x, y, drawId) {
    ...
    if (XY != drawId) XY = 0;
    else XY = 1; if (X1Y != drawId) X1Y = 0;
    else X1Y = 1; if (X1Y1 != drawId) X1Y1 = 0;
    else X1Y1 = 1; if (XY1 != drawId) XY1 = 0;
    else XY1 = 1; if (XY == 0 && (X1Y == 0 && (X1Y1 == 0 && XY1 == 0))) return null;
...
FieldContainer.prototype.checkWin = function() {
    ...
    console.log("WIN!!!");
    //PK WIN
    console.log(this.gameManager.levelId);
    updateShareScore(this.gameManager.levelId);
    return true
};
...
GameOverDialog = function(gameManager) {
    ...
    //PK ending
	//updateShareScore(localStorage["levelComplete"]);
    //console.log(localStorage["levelComplete"]);
