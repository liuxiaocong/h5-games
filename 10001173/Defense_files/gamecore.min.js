...
function(d, a) {
	return new(d.extend({
		...
		_updateSize: function() {
			this.isTouch && (this.isAndroid || this.isIPhone) ? (this.width = window.innerWidth, this.isAndroid ? (this.height = window.outerHeight / this.pixelRatio) : this.isIPhone && ("portrait" == this.orientation ? this.height = window.screen.height: this.height = window.screen.width, this.height -= 20, this.isFullScreen || (this.height -= "portrait" == this.orientation ? 44 : 32))) : (this.width = window.innerWidth, this.height = window.innerHeight);
...
function(d, a, c, b) {
	...
	return new(d.extend({
		...
		_autoSize: function() {
			...
			if((document.body.clientHeight/document.body.clientWidth)>(480/320))
				{
					g = document.body.clientHeight/480;
				}else
				{
					g = document.body.clientWidth/320;
				}
			console.log(c);
			console.log(g);
			...
			var top = (document.body.clientHeight - 480 * g)/2
			console.log(top);
			e.style.top = top + "px";
			this.fire("resize")
		}
