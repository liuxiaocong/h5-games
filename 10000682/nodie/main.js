        ...
        init: function () {
            ...
            e.run(function () {
                ...
                e.canvas.fillStyle("#000").font("30px Arial").fillText(c, i - e.canvas.measureText(c).width - 20, 50), t = null
                    ...
                    var h = w * 138 / 480;
                    e.canvas.fillStyle("#FFF").fillScreen().drawImageT("logo", 0, 10, w, h), e.buttonLayout.released("difficulty1") ? (l.moduleName = "我的成绩", c(2)) : e.buttonLayout.released("difficulty2") ? (l.moduleName = "噩梦模式", c(3)) : e.buttonLayout.released("difficulty3") ? (l.moduleName = "地狱模式", c(4)) : e.buttonLayout.released("difficulty4") ? (l.moduleName = "炼狱模式", c(5)) : e.buttonLayout.released("rank")
                }).zone(function () {
            ...
            var l = {
                            ...
                            if (!this.hostDied) {
                                ...
                                if (o - this.displayDate >= this.displayTimeout) {
                                    ...
                                    this.boxes.unshift({
                                        ...
                                        width: u,
                                        height: a
                                    }), this.displayTimeout = e.comm.getRandom(1e3, 9e3), u = a = null
                                }
                ...
                h = function () {
                    ...
                    // console.log(n);
                    n == null && (n = "0"), l.bestTime = parseInt(n), l.time > l.bestTime && e.localStorage.setItem("NotDieAnyoneBestTime" + l.module, l.time.toString())
