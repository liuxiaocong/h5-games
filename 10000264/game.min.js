...
!
    function(a, b) {
        ...
        c.InteractionManager = function() {}, d.Utils = {
            ...
            a = a.first;
            do
                if (b = a.worldTransform, a.visible) if (a.renderable) {
            ...
            var b, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A = a.first,
                ...
                F = 1 / 0;
            do {
                if (A.visible) if (A instanceof c.Sprite) d = A.texture.frame.width, e = A.texture.frame.height, f = A.anchor.x, g = A.anchor.y, h = d * (1 - f), i = d * -f, j = e * (1 - g), k = e * -g, l = !0;
        ...
        return c.WebGLRenderGroup.prototype.handleFilterBlock = function(a, b) {
            ...
            var d = a.first,
                e = a.last._iNext;
            do d.__renderGroup = this, d.renderable && (this.insertObject(d, b, c), b = d), d = d._iNext;
            while (d != e)
            ...
            if (c.EventTarget.call(this), this.width = 100, this.height = 100, this.hasLoaded = !1, this.source = a, a) {
                if (this.source instanceof Image || this.source instanceof HTMLImageElement) if (this.source.complete) this.hasLoaded = !0, this.width = this.source.width, this.height = this.source.height, c.texturesToUpdate.push(this);
                else {
                    var b = this;
            ...
            swap: function(a, b) {
                ...
                do h !== a && h !== b && (h.first === a ? h.first = b : h.first === b && (h.first = a), h.last === a ? h.last = b : h.last === b && (h.last = a)), h = h._iNext;
                while (h != g);
            ...
            setAll: function(a, b, c, d, e) {
                if (a = a.split("."), "undefined" == typeof c && (c = !1), "undefined" == typeof d && (d = !1), e = e || 0, this._container.children.length > 0 && this._container.first._iNext) {
                    ...
                    do(c === !1 || c && f.alive) && (d === !1 || d && f.visible) && this.setProperty(f, a, b, e), f = f._iNext;
            ...
            callAll: function(a, b) {
                if ("undefined" != typeof a) {
                    ...
                    if (this._container.children.length > 0 && this._container.first._iNext) {
                        ...
                        do f = this.callbackFromArray(h, a, c), b && f ? (g = this.callbackFromArray(h, b, d), f && f.apply(g, e)) : f && f.apply(h, e), h = h._iNext;
            ...
            forEach: function(a, b, c) {
                ...
                if (d.unshift(null), this._container.children.length > 0 && this._container.first._iNext) {
                    ...
                    do(c === !1 || c && e.exists) && (d[0] = e, a.apply(b, d)), e = e._iNext;
            ...
            if (this.currentRenderOrderID = 0, this.game.stage._stage.first._iNext) {
                ...
                do a = !1, b.preUpdate && (a = b.preUpdate() === !1), b.update && (a = b.update() === !1 || a), b = a ? b.last._iNext : b._iNext;
            ...
            start: function() {
                this.isRunning = !0;
                var a = this;
                (this._isSetTimeOut = !0, this._onLoop = function() {
            ...
            var g = [],
                h = "";
            if (c > b) for (var i = b; c >= i; i++) h = "number" == typeof f ? d.Utils.pad(i.toString(), f, "0", 1) : i.toString(), h = a + h + e, g.push(h);
            else for (var i = b; i >= c; i--) h = "number" == typeof f ? d.Utils.pad(i.toString(), f, "0", 1) : i.toString(), h = a + h + e, g.push(h);
            return g
            ...
            getFrames: function(a, b, c) {
                ...
                else for (var d = 0, e = a.length; e > d; d++) b ? c.push(this.getFrame(a[d])) : c.push(this.getFrameByName(a[d]));
                return c
            },
            getFrameIndexes: function(a, b, c) {
                if ("undefined" == typeof b && (b = !0), "undefined" == typeof c && (c = []), "undefined" == typeof a || 0 === a.length) for (var d = 0, e = this._frames.length; e > d; d++) c.push(this._frames[d].index);
            ...
            overlapGroupVsGroup: function(a, b, c, d, e) {
                if (0 !== a.length && 0 !== b.length && a._container.first._iNext) {
                    ...
                    do f.exists && this.overlapSpriteVsGroup(f, b, c, d, e), f = f._iNext;
            ...
            collideGroupVsTilemapLayer: function(a, b, c, d, e) {
                if (0 !== a.length && 0 !== a.length && a._container.first._iNext) {
                    var f = a._container.first._iNext;
                    do f.exists && this.collideSpriteVsTilemapLayer(f, b, c, d, e), f = f._iNext;
                    while (f != a._container.last._iNext)
                }
            },
            ...
            collideGroupVsGroup: function(a, b, c, d, e) {
                if (0 !== a.length && 0 !== b.length && a._container.first._iNext) {
                    var f = a._container.first._iNext;
                    do f.exists && this.collideSpriteVsGroup(f, b, c, d, e), f = f._iNext;
                    while (f != a._container.last._iNext)
                }
            },
            ...
            a = a.first;
            do
                if (a.visible) if (a.renderable && 0 !== a.alpha) {
                    ...
                    else if (a instanceof c.FilterBlock) if (a.open) {
                        this.context.save();
                        var d = a.mask.alpha,
...
var _0x5eb8 = ["\x49\x6E\x69\x74\x47\x61\x6D\x65", "\x67\x61\x6D\x65\x4A\x65\x6C\x6C\x79\x47\x6C\x6F\x62\x61\x6C", "\x67\x61\x6D\x65\x43\x6F\x6E\x74\x61\x69\x6E\x65\x72", "\x42\x6F\x6F\x74", "\x61\x64\x64", "\x73\x74\x61\x74\x65", "\x50\x72\x65\x6C\x6F\x61\x64\x65\x72", "\x4D\x61\x69\x6E\x4D\x65\x6E\x75", "\x47\x61\x6D\x65", "\x73\x74\x61\x72\x74", "\x70\x72\x6F\x74\x6F\x74\x79\x70\x65", "\x62\x67\x31", "\x61\x73\x73\x65\x74\x73\x2F\x62\x67\x31\x2E\x6A\x70\x67", "\x69\x6D\x61\x67\x65", "\x6C\x6F\x61\x64", "\x70\x72\x65\x6C\x6F\x61\x64\x65\x72\x42\x61\x72", "\x61\x73\x73\x65\x74\x73\x2F\x70\x72\x65\x6C\x6F\x61\x64\x72\x5F\x62\x61\x72\x2E\x70\x6E\x67", "\x61\x31\x30\x73\x70\x6C\x61\x73\x68", "\x61\x73\x73\x65\x74\x73\x2F\x61\x31\x30\x73\x70\x6C\x61\x73\x68\x2E\x70\x6E\x67", "\x6D\x61\x78\x50\x6F\x69\x6E\x74\x65\x72\x73", "\x69\x6E\x70\x75\x74", "\x67\x61\x6D\x65", "\x64\x69\x73\x61\x62\x6C\x65\x56\x69\x73\x69\x62\x69\x6C\x69\x74\x79\x43\x68\x61\x6E\x67\x65", "\x73\x74\x61\x67\x65", "\x73\x63\x61\x6C\x65\x4D\x6F\x64\x65", "\x53\x48\x4F\x57\x5F\x41\x4C\x4C", "\x53\x74\x61\x67\x65\x53\x63\x61\x6C\x65\x4D\x6F\x64\x65", "\x73\x65\x74\x53\x68\x6F\x77\x41\x6C\x6C", "\x73\x63\x61\x6C\x65", "\x72\x65\x66\x72\x65\x73\x68"];
JellyFriend[_0x5eb8[0]] = function() {
    JellyFriend[_0x5eb8[1]] = new Phaser.Game(640, 960, Phaser.CANVAS, _0x5eb8[2]);
    JellyFriend[_0x5eb8[1]][_0x5eb8[5]][_0x5eb8[4]](_0x5eb8[3], JellyFriend.Boot);
    JellyFriend[_0x5eb8[1]][_0x5eb8[5]][_0x5eb8[4]](_0x5eb8[6], JellyFriend.Preloader);
    JellyFriend[_0x5eb8[1]][_0x5eb8[5]][_0x5eb8[4]](_0x5eb8[7], JellyFriend.MainMenu);
    JellyFriend[_0x5eb8[1]][_0x5eb8[5]][_0x5eb8[4]](_0x5eb8[8], JellyFriend.Game);
    JellyFriend[_0x5eb8[1]][_0x5eb8[5]][_0x5eb8[9]](_0x5eb8[3]);
};
JellyFriend[_0x5eb8[3]] = function(_0x279ex1) {};
JellyFriend[_0x5eb8[3]][_0x5eb8[10]] = {
    preload: function() {
        this[_0x5eb8[14]][_0x5eb8[13]](_0x5eb8[11], _0x5eb8[12]);
        this[_0x5eb8[14]][_0x5eb8[13]](_0x5eb8[15], _0x5eb8[16]);
        this[_0x5eb8[14]][_0x5eb8[13]](_0x5eb8[17], _0x5eb8[18]);
    },
    create: function() {
        this[_0x5eb8[21]][_0x5eb8[20]][_0x5eb8[19]] = 4;
        this[_0x5eb8[21]][_0x5eb8[23]][_0x5eb8[22]] = true;
        this[_0x5eb8[21]][_0x5eb8[23]][_0x5eb8[24]] = Phaser[_0x5eb8[26]][_0x5eb8[25]];
        this[_0x5eb8[21]][_0x5eb8[23]][_0x5eb8[28]][_0x5eb8[27]]();
        this[_0x5eb8[21]][_0x5eb8[23]][_0x5eb8[28]][_0x5eb8[29]]();
        this[_0x5eb8[21]][_0x5eb8[5]][_0x5eb8[9]](_0x5eb8[6]);
    }
};
var _0xe1e0 = ["\x50\x72\x65\x6C\x6F\x61\x64\x65\x72", "\x62\x61\x63\x6B\x67\x72\x6F\x75\x6E\x64", "\x70\x72\x65\x6C\x6F\x61\x64\x42\x61\x72", "\x61\x31\x30\x73\x70\x6C\x61\x73\x68", "\x61\x31\x30\x6C\x6F\x67\x6F", "\x70\x72\x6F\x74\x6F\x74\x79\x70\x65", "\x72\x65\x73\x69\x7A\x65", "\x61\x64\x64\x45\x76\x65\x6E\x74\x4C\x69\x73\x74\x65\x6E\x65\x72", "\x6F\x72\x69\x65\x6E\x74\x61\x74\x69\x6F\x6E\x63\x68\x61\x6E\x67\x65", "\x62\x67\x31", "\x73\x70\x72\x69\x74\x65", "\x61\x64\x64", "\x73\x65\x74\x54\x6F", "\x73\x63\x61\x6C\x65", "\x70\x72\x65\x6C\x6F\x61\x64\x65\x72\x42\x61\x72", "\x61\x6E\x63\x68\x6F\x72", "\x69\x6E\x70\x75\x74\x45\x6E\x61\x62\x6C\x65\x64", "\x75\x73\x65\x48\x61\x6E\x64\x43\x75\x72\x73\x6F\x72", "\x69\x6E\x70\x75\x74", "\x68\x74\x74\x70\x3A\x2F\x2F\x61\x31\x30\x2E\x63\x6F\x6D", "\x5F\x62\x6C\x61\x6E\x6B", "\x6F\x70\x65\x6E", "\x6F\x6E\x49\x6E\x70\x75\x74\x44\x6F\x77\x6E", "\x65\x76\x65\x6E\x74\x73", "\x73\x65\x74\x50\x72\x65\x6C\x6F\x61\x64\x53\x70\x72\x69\x74\x65", "\x6C\x6F\x61\x64", "\x63\x6C\x69\x63\x6B", "\x61\x73\x73\x65\x74\x73\x2F\x63\x6C\x69\x63\x6B\x2E\x77\x61\x76", "\x61\x75\x64\x69\x6F", "\x62\x6C\x6F\x62", "\x61\x73\x73\x65\x74\x73\x2F\x62\x6C\x6F\x62\x2E\x77\x61\x76", "\x65\x72\x72\x6F\x72", "\x61\x73\x73\x65\x74\x73\x2F\x65\x72\x72\x6F\x72\x2E\x77\x61\x76", "\x73\x6E\x64\x5F\x63\x6F\x6F\x6C", "\x61\x73\x73\x65\x74\x73\x2F\x73\x6E\x64\x5F\x63\x6F\x6F\x6C\x2E\x77\x61\x76", "\x77\x69\x6E", "\x61\x73\x73\x65\x74\x73\x2F\x77\x69\x6E\x2E\x77\x61\x76", "\x73\x6E\x64\x5F\x6C\x6F\x6F\x73\x65", "\x61\x73\x73\x65\x74\x73\x2F\x73\x6E\x64\x5F\x6C\x6F\x6F\x73\x65\x2E\x77\x61\x76", "\x4A\x61\x6E\x64\x61\x4D\x61\x6E\x61\x74\x65\x65\x53\x6F\x6C\x69\x64", "\x61\x73\x73\x65\x74\x73\x2F\x4A\x61\x6E\x64\x61\x4D\x61\x6E\x61\x74\x65\x65\x53\x6F\x6C\x69\x64\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x4A\x61\x6E\x64\x61\x4D\x61\x6E\x61\x74\x65\x65\x53\x6F\x6C\x69\x64\x2E\x78\x6D\x6C", "\x62\x69\x74\x6D\x61\x70\x46\x6F\x6E\x74", "\x6A\x65\x6C\x6C\x79", "\x61\x73\x73\x65\x74\x73\x2F\x31\x32\x33\x34\x35\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x31\x32\x33\x34\x35\x2E\x78\x6D\x6C", "\x61\x74\x6C\x61\x73\x58\x4D\x4C", "\x6A\x65\x6C\x6C\x79\x5F\x63\x6F\x6C\x6F\x72", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x63\x6F\x6C\x6F\x72\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x63\x6F\x6C\x6F\x72\x2E\x78\x6D\x6C", "\x73\x68\x31", "\x61\x73\x73\x65\x74\x73\x2F\x73\x68\x31\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x73\x68\x31\x2E\x78\x6D\x6C", "\x6A\x65\x6C\x6C\x79\x5F\x67\x72\x65\x65\x6E", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x67\x72\x65\x65\x6E\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x67\x72\x65\x65\x6E\x2E\x78\x6D\x6C", "\x6A\x65\x6C\x6C\x79\x5F\x6F\x72\x61\x6E\x67\x65", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x6F\x72\x61\x6E\x67\x65\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x6F\x72\x61\x6E\x67\x65\x2E\x78\x6D\x6C", "\x6A\x65\x6C\x6C\x79\x5F\x76\x69\x6F\x6C\x65\x74", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x76\x69\x6F\x6C\x65\x74\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x76\x69\x6F\x6C\x65\x74\x2E\x78\x6D\x6C", "\x6A\x65\x6C\x6C\x79\x5F\x73\x70\x6C\x61\x73\x68", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x73\x70\x6C\x61\x73\x68\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x6A\x65\x6C\x6C\x79\x5F\x73\x70\x6C\x61\x73\x68\x2E\x78\x6D\x6C", "\x68\x61\x74\x73", "\x61\x73\x73\x65\x74\x73\x2F\x68\x61\x74\x73\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x68\x61\x74\x73\x2E\x78\x6D\x6C", "\x73\x68\x32", "\x61\x73\x73\x65\x74\x73\x2F\x73\x68\x32\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x73\x68\x32\x2E\x78\x6D\x6C", "\x74\x75\x74\x6F\x72\x73", "\x61\x73\x73\x65\x74\x73\x2F\x74\x75\x74\x6F\x72\x73\x2E\x70\x6E\x67", "\x61\x73\x73\x65\x74\x73\x2F\x74\x75\x74\x6F\x72\x73\x2E\x78\x6D\x6C", "\x62\x67\x32", "\x61\x73\x73\x65\x74\x73\x2F\x62\x67\x32\x2E\x6A\x70\x67", "\x69\x6D\x61\x67\x65", "\x62\x67\x33", "\x61\x73\x73\x65\x74\x73\x2F\x62\x67\x33\x2E\x70\x6E\x67", "\x74\x75\x74\x6F\x72\x5F\x62\x67", "\x61\x73\x73\x65\x74\x73\x2F\x74\x75\x74\x6F\x72\x5F\x62\x67\x2E\x70\x6E\x67", "\x6D\x6F\x72\x65\x67\x61\x6D\x65\x73\x5F\x62\x74\x6E", "\x61\x73\x73\x65\x74\x73\x2F\x6D\x6F\x72\x65\x67\x61\x6D\x65\x73\x5F\x62\x74\x6E\x2E\x70\x6E\x67", "\x73\x70\x69\x6C\x4C\x6F\x67\x6F", "\x61\x73\x73\x65\x74\x73\x2F\x61\x31\x30\x5F\x32\x30\x30\x78\x36\x32\x2E\x70\x6E\x67", "\x77\x69\x64\x74\x68", "\x63\x72\x6F\x70", "\x63\x72\x6F\x70\x45\x6E\x61\x62\x6C\x65\x64", "\x73\x6E\x64\x43\x6C\x69\x63\x6B", "\x67\x61\x6D\x65", "\x73\x6E\x64\x42\x6C\x6F\x62", "\x73\x6E\x64\x45\x72\x72\x6F\x72", "\x73\x6E\x64\x57\x69\x6E", "\x73\x6E\x64\x4C\x6F\x6F\x73\x65", "\x73\x6E\x64\x43\x6F\x6F\x6C", "\x76\x69\x73\x69\x62\x6C\x65", "\x73\x74\x61\x72\x74", "\x6F\x6E\x43\x6F\x6D\x70\x6C\x65\x74\x65", "\x4C\x69\x6E\x65\x61\x72", "\x45\x61\x73\x69\x6E\x67", "\x74\x6F", "\x74\x77\x65\x65\x6E", "\x64\x65\x73\x74\x72\x6F\x79", "\x4D\x61\x69\x6E\x4D\x65\x6E\x75", "\x73\x74\x61\x74\x65", "\x62\x6F\x64\x79", "\x6F\x66\x66\x73\x65\x74\x57\x69\x64\x74\x68", "\x63\x6F\x6D\x70\x61\x74\x4D\x6F\x64\x65", "\x43\x53\x53\x31\x43\x6F\x6D\x70\x61\x74", "\x64\x6F\x63\x75\x6D\x65\x6E\x74\x45\x6C\x65\x6D\x65\x6E\x74", "\x69\x6E\x6E\x65\x72\x57\x69\x64\x74\x68", "\x6C\x65\x66\x74", "\x73\x74\x79\x6C\x65", "\x67\x61\x6D\x65\x48\x6F\x6C\x64\x65\x72", "\x67\x65\x74\x45\x6C\x65\x6D\x65\x6E\x74\x42\x79\x49\x64", "\x63\x6C\x69\x65\x6E\x74\x57\x69\x64\x74\x68", "\x63\x61\x6E\x76\x61\x73", "\x67\x61\x6D\x65\x4A\x65\x6C\x6C\x79\x47\x6C\x6F\x62\x61\x6C", "\x70\x78", "\x73\x65\x74\x54\x69\x6D\x65\x6F\x75\x74"];
JellyFriend[_0xe1e0[0]] = function(_0x67d7x1) {
    this[_0xe1e0[1]] = null;
    this[_0xe1e0[2]] = null;
    this[_0xe1e0[3]] = null;
    this[_0xe1e0[4]] = null;
};
JellyFriend[_0xe1e0[0]][_0xe1e0[5]] = {
    preload: function() {
        window[_0xe1e0[7]](_0xe1e0[6], doAlignOnRisize, false);
        window[_0xe1e0[7]](_0xe1e0[8], doAlignOnRisize, false);
        doAlignOnRisize();
        this[_0xe1e0[1]] = this[_0xe1e0[11]][_0xe1e0[10]](0, 0, _0xe1e0[9]);
        this[_0xe1e0[1]][_0xe1e0[13]][_0xe1e0[12]](2, 2);
        this[_0xe1e0[2]] = this[_0xe1e0[11]][_0xe1e0[10]](120, 480, _0xe1e0[14]);
        this[_0xe1e0[4]] = this[_0xe1e0[11]][_0xe1e0[10]](310, 270, _0xe1e0[3]);
        this[_0xe1e0[4]][_0xe1e0[13]] = this[_0xe1e0[4]][_0xe1e0[15]][_0xe1e0[12]](0.5, 0.5);
        this[_0xe1e0[4]][_0xe1e0[16]] = true;
        this[_0xe1e0[4]][_0xe1e0[18]][_0xe1e0[17]] = true;
        this[_0xe1e0[4]][_0xe1e0[23]][_0xe1e0[22]][_0xe1e0[11]](function() {
            window[_0xe1e0[21]](_0xe1e0[19], _0xe1e0[20]);
        }, this);
        this[_0xe1e0[25]][_0xe1e0[24]](this[_0xe1e0[2]]);
        this[_0xe1e0[25]][_0xe1e0[28]](_0xe1e0[26], _0xe1e0[27]);
        this[_0xe1e0[25]][_0xe1e0[28]](_0xe1e0[29], _0xe1e0[30]);
        this[_0xe1e0[25]][_0xe1e0[28]](_0xe1e0[31], _0xe1e0[32]);
        this[_0xe1e0[25]][_0xe1e0[28]](_0xe1e0[33], _0xe1e0[34]);
        this[_0xe1e0[25]][_0xe1e0[28]](_0xe1e0[35], _0xe1e0[36]);
        this[_0xe1e0[25]][_0xe1e0[28]](_0xe1e0[37], _0xe1e0[38]);
        this[_0xe1e0[25]][_0xe1e0[42]](_0xe1e0[39], _0xe1e0[40], _0xe1e0[41]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[43], _0xe1e0[44], _0xe1e0[45]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[47], _0xe1e0[48], _0xe1e0[49]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[50], _0xe1e0[51], _0xe1e0[52]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[53], _0xe1e0[54], _0xe1e0[55]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[56], _0xe1e0[57], _0xe1e0[58]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[59], _0xe1e0[60], _0xe1e0[61]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[62], _0xe1e0[63], _0xe1e0[64]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[65], _0xe1e0[66], _0xe1e0[67]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[68], _0xe1e0[69], _0xe1e0[70]);
        this[_0xe1e0[25]][_0xe1e0[46]](_0xe1e0[71], _0xe1e0[72], _0xe1e0[73]);
        this[_0xe1e0[25]][_0xe1e0[76]](_0xe1e0[74], _0xe1e0[75]);
        this[_0xe1e0[25]][_0xe1e0[76]](_0xe1e0[77], _0xe1e0[78]);
        this[_0xe1e0[25]][_0xe1e0[76]](_0xe1e0[79], _0xe1e0[80]);
        this[_0xe1e0[25]][_0xe1e0[76]](_0xe1e0[81], _0xe1e0[82]);
        this[_0xe1e0[25]][_0xe1e0[76]](_0xe1e0[83], _0xe1e0[84]);
    },
    create: function() {
        this[_0xe1e0[2]][_0xe1e0[86]][_0xe1e0[85]] = 409;
        this[_0xe1e0[2]][_0xe1e0[87]] = false;
        this[_0xe1e0[89]][_0xe1e0[88]] = this[_0xe1e0[89]][_0xe1e0[11]][_0xe1e0[28]](_0xe1e0[26], 0.5);
        this[_0xe1e0[89]][_0xe1e0[90]] = this[_0xe1e0[89]][_0xe1e0[11]][_0xe1e0[28]](_0xe1e0[29], 0.25);
        this[_0xe1e0[89]][_0xe1e0[91]] = this[_0xe1e0[89]][_0xe1e0[11]][_0xe1e0[28]](_0xe1e0[31]);
        this[_0xe1e0[89]][_0xe1e0[92]] = this[_0xe1e0[89]][_0xe1e0[11]][_0xe1e0[28]](_0xe1e0[35], 0.25);
        this[_0xe1e0[89]][_0xe1e0[93]] = this[_0xe1e0[89]][_0xe1e0[11]][_0xe1e0[28]](_0xe1e0[37], 0.5);
        this[_0xe1e0[89]][_0xe1e0[94]] = this[_0xe1e0[89]][_0xe1e0[11]][_0xe1e0[28]](_0xe1e0[33], 0.25);
        this[_0xe1e0[2]][_0xe1e0[95]] = false;
        this[_0xe1e0[4]][_0xe1e0[95]] = false;
        this[_0xe1e0[3]] = this[_0xe1e0[11]][_0xe1e0[10]](285, 480, _0xe1e0[3]);
        this[_0xe1e0[3]][_0xe1e0[15]][_0xe1e0[12]](0.5, 0.5);
        this[_0xe1e0[3]][_0xe1e0[16]] = true;
        this[_0xe1e0[3]][_0xe1e0[18]][_0xe1e0[17]] = true;
        this[_0xe1e0[3]][_0xe1e0[23]][_0xe1e0[22]][_0xe1e0[11]](function() {
            window[_0xe1e0[21]](_0xe1e0[19], _0xe1e0[20]);
        }, this);
        this[_0xe1e0[89]][_0xe1e0[11]][_0xe1e0[101]](new Object())[_0xe1e0[100]]({
            alpha: 1.0
        }, 3200, Phaser[_0xe1e0[99]][_0xe1e0[98]].In, true)[_0xe1e0[97]][_0xe1e0[11]](this[_0xe1e0[96]], this);
    },
    start: function() {
        this[_0xe1e0[1]][_0xe1e0[102]]();
        this[_0xe1e0[2]][_0xe1e0[102]]();
        this[_0xe1e0[3]][_0xe1e0[102]]();
        this[_0xe1e0[4]][_0xe1e0[102]]();
        this[_0xe1e0[89]][_0xe1e0[104]][_0xe1e0[96]](_0xe1e0[103]);
    }
};

function doAlignOnRisize() {
    window[_0xe1e0[119]](function() {
        var _0x67d7x3 = 640;
        if (document[_0xe1e0[105]] && document[_0xe1e0[105]][_0xe1e0[106]]) {
            _0x67d7x3 = document[_0xe1e0[105]][_0xe1e0[106]];
        };
        if (document[_0xe1e0[107]] == _0xe1e0[108] && document[_0xe1e0[109]] && document[_0xe1e0[109]][_0xe1e0[106]]) {
            _0x67d7x3 = document[_0xe1e0[109]][_0xe1e0[106]];
        };
        if (window[_0xe1e0[110]]) {
            _0x67d7x3 = window[_0xe1e0[110]];
        };
        document.getElementById('gameHolder').style.left = (_0x67d7x3 - JellyFriend.gameJellyGlobal.canvas.clientWidth) / 2 + "px";
    }, 1);
};
var _0xe044 = ["\x4D\x61\x69\x6E\x4D\x65\x6E\x75", "\x6D\x75\x73\x69\x63", "\x70\x6C\x61\x79\x42\x75\x74\x74\x6F\x6E", "\x62\x61\x63\x6B\x67\x72\x6F\x75\x6E\x64", "\x6D\x61\x70\x4A\x65\x6C\x6C\x79", "\x6E\x43\x75\x72\x50\x61\x67\x65", "\x6E\x43\x75\x72\x50\x61\x67\x65\x49\x63\x6F\x6E", "\x62\x74\x6E\x4C\x65\x66\x74", "\x62\x74\x6E\x52\x69\x67\x68\x74", "\x70\x72\x6F\x74\x6F\x74\x79\x70\x65", "\x73\x61\x76\x65\x73", "\x67\x61\x6D\x65", "\x73\x68\x6F\x77\x4D\x61\x69\x6E\x4D\x65\x6E\x75", "\x6E\x53\x68\x6F\x77\x54\x72\x6F\x70\x68\x69\x65\x73", "\x6F\x6E\x42\x74\x6E\x54\x72\x6F\x70\x68\x69\x65\x73\x43\x6C\x69\x63\x6B", "\x73\x68\x6F\x77\x4D\x61\x70", "\x6F\x70\x61\x63\x69\x74\x79", "\x73\x74\x79\x6C\x65", "\x67\x61\x6D\x65\x43\x6F\x6E\x74\x61\x69\x6E\x65\x72", "\x67\x65\x74\x45\x6C\x65\x6D\x65\x6E\x74\x42\x79\x49\x64", "\x67\x72\x6F\x75\x70", "\x61\x64\x64", "\x73\x65\x74\x54\x6F", "\x73\x63\x61\x6C\x65", "\x62\x67\x31", "\x63\x72\x65\x61\x74\x65", "\x6A\x65\x6C\x6C\x79", "\x61\x6E\x67\x6C\x65", "\x6E\x43\x75\x72\x41\x6E\x69\x6D\x4E\x75\x6D", "\x69\x6E\x74\x65\x67\x65\x72\x49\x6E\x52\x61\x6E\x67\x65", "\x72\x6E\x64", "\x69\x64\x6C\x65", "", "\x67\x65\x6E\x65\x72\x61\x74\x65\x46\x72\x61\x6D\x65\x4E\x61\x6D\x65\x73", "\x41\x6E\x69\x6D\x61\x74\x69\x6F\x6E", "\x61\x6E\x69\x6D\x61\x74\x69\x6F\x6E\x73", "\x6D\x6F\x72\x70\x68\x5F\x62\x65\x61\x72", "\x6D\x6F\x72\x70\x68\x5F\x62\x65\x61\x72\x5F\x62\x61\x63\x6B", "\x6D\x6F\x72\x70\x68\x5F\x63\x61\x63\x74\x75\x73", "\x6D\x6F\x72\x70\x68\x5F\x63\x61\x63\x74\x75\x73\x5F\x62\x61\x63\x6B", "\x6D\x6F\x72\x70\x68\x5F\x63\x6F\x77", "\x6D\x6F\x72\x70\x68\x5F\x63\x6F\x77\x5F\x62\x61\x63\x6B", "\x6D\x6F\x72\x70\x68\x5F\x74\x65\x61\x70\x6F\x74", "\x6D\x6F\x72\x70\x68\x5F\x74\x65\x61\x70\x6F\x74\x5F\x62\x61\x63\x6B", "\x6D\x6F\x72\x70\x68\x5F\x73\x74\x61\x72", "\x6D\x6F\x72\x70\x68\x5F\x73\x74\x61\x72\x5F\x62\x61\x63\x6B", "\x70\x6C\x61\x79", "\x6F\x6E\x4A\x65\x6C\x6C\x79\x41\x6E\x69\x6D\x43\x6F\x6D\x70\x6C\x65\x74\x65", "\x6F\x6E\x41\x6E\x69\x6D\x61\x74\x69\x6F\x6E\x43\x6F\x6D\x70\x6C\x65\x74\x65", "\x65\x76\x65\x6E\x74\x73", "\x61\x6C\x70\x68\x61", "\x42\x61\x63\x6B", "\x45\x61\x73\x69\x6E\x67", "\x74\x6F", "\x74\x77\x65\x65\x6E", "\x73\x68\x31", "\x66\x72\x61\x6D\x65\x4E\x61\x6D\x65", "\x62\x69\x67\x5F\x6C\x6F\x67\x6F", "\x6D\x6F\x72\x65\x67\x61\x6D\x65\x73\x5F\x62\x74\x6E", "\x6F\x6E\x42\x74\x6E\x53\x70\x6F\x6E\x73\x6F\x72\x43\x6C\x69\x63\x6B", "\x73\x65\x74\x42\x75\x74\x74\x6F\x6E\x57\x69\x74\x68\x49\x6E\x70\x75\x74\x44\x6F\x77\x6E", "\x6D\x65\x6E\x75\x5F\x70\x6C\x61\x79\x5F\x62\x74\x6E", "\x6F\x6E\x42\x74\x6E\x50\x6C\x61\x79\x43\x6C\x69\x63\x6B", "\x69\x6E\x66\x6F\x5F\x62\x74\x6E", "\x6F\x6E\x42\x74\x6E\x49\x6E\x66\x6F\x43\x6C\x69\x63\x6B", "\x74\x72\x6F\x70\x68\x69\x65\x73\x5F\x62\x74\x6E", "\x73\x70\x69\x6C\x4C\x6F\x67\x6F", "\x63\x72\x65\x61\x74\x65\x53\x6F\x75\x6E\x64\x42\x74\x6E", "\x4C\x69\x6E\x65\x61\x72", "\x61\x6E\x69\x6D\x44\x69\x72\x65\x63\x74\x69\x6F\x6E", "\x6E\x6F\x72\x6D\x61\x6C", "\x62\x61\x63\x6B", "\x6E\x61\x6D\x65", "\x63\x75\x72\x72\x65\x6E\x74\x41\x6E\x69\x6D", "\x5F\x62\x61\x63\x6B", "\x72\x61\x6E\x64\x6F\x6D", "\x6D\x6F\x72\x70\x68\x5F", "\x77\x61\x76", "\x64\x65\x76\x69\x63\x65", "\x62\x53\x6F\x75\x6E\x64", "\x73\x6F\x75\x6E\x64\x5F\x62\x74\x6E", "\x6F\x6E\x42\x74\x6E\x53\x6F\x75\x6E\x64\x43\x6C\x69\x63\x6B", "\x6F\x6E\x42\x74\x6E\x4D\x6F\x75\x73\x65\x4F\x75\x74", "\x61\x6E\x63\x68\x6F\x72", "\x78", "\x73\x6E\x64\x43\x6C\x69\x63\x6B", "\x62\x74\x6E\x41\x72\x72\x6F\x77\x4C\x65\x66\x74", "\x61\x72\x72\x6F\x77", "\x6F\x6E\x42\x74\x6E\x54\x72\x4C\x41\x72\x72\x6F\x77\x43\x6C\x69\x63\x6B", "\x62\x74\x6E\x41\x72\x72\x6F\x77\x52\x69\x67\x68\x74", "\x6F\x6E\x42\x74\x6E\x54\x72\x52\x41\x72\x72\x6F\x77\x43\x6C\x69\x63\x6B", "\x6F\x6E\x42\x74\x6E\x4D\x6F\x75\x73\x65\x4F\x75\x74\x41\x72\x72\x6F\x77\x52\x69\x67\x68\x74", "\x64\x6F\x74\x5F\x65\x6D\x70\x74\x79", "\x64\x6F\x74", "\x74\x72\x6F\x70\x68\x69\x65\x73\x5F\x62\x61\x63\x6B\x31", "\x73\x68\x32", "\x74\x72\x6F\x70\x68\x69\x65\x73\x5F\x62\x61\x63\x6B\x32", "\x74\x72\x6F\x70\x68\x69\x65\x73\x5F\x6C\x6F\x67\x6F", "\x74\x72\x5F\x6A\x65\x6C\x6C\x79\x70\x61\x64", "\x74\x72\x5F\x6D\x69\x73\x74\x65\x72\x73\x69\x72", "\x74\x72\x5F\x63\x75\x62\x69\x65", "\x74\x72\x5F\x68\x65\x61\x72\x74\x73", "\x74\x72\x5F\x63\x6F\x6F\x6C\x66\x69\x6E\x67\x65\x72", "\x74\x72\x5F\x63\x6F\x6F\x6C\x74\x69\x6D\x65\x72", "\x74\x72\x5F\x63\x6F\x6F\x6C\x6D\x61\x74\x63\x68\x65\x72", "\x74\x72\x5F\x73\x74\x61\x72\x6D\x61\x73\x74\x65\x72", "\x73\x68\x6F\x77\x54\x72\x6F\x70\x68\x69\x65\x73\x50\x61\x67\x65", "\x6D\x65\x6E\x75\x5F\x62\x61\x63\x6B\x5F\x62\x74\x6E", "\x6F\x6E\x42\x74\x6E\x4D\x61\x69\x6E\x4D\x65\x6E\x75\x43\x6C\x69\x63\x6B", "\x76\x69\x73\x69\x62\x6C\x65", "\x74\x72\x6F\x70\x68\x69\x65\x73", "\x31", "\x74\x6F\x74\x61\x6C\x45\x6C\x61\x70\x73\x65\x64\x53\x65\x63\x6F\x6E\x64\x73", "\x74\x69\x6D\x65", "\x73\x75\x62\x73\x74\x72\x69\x6E\x67", "\x73\x61\x76\x65\x54\x72\x6F\x70\x68\x69\x65\x73", "\x30", "\x63\x72\x65\x61\x74\x65\x64\x5F\x62\x79", "\x4D\x45", "\x4D\x4E", "\x73\x61\x76\x65\x53\x6F\x75\x6E\x64", "\x69\x73\x54\x77\x65\x65\x6E\x69\x6E\x67", "\x74\x77\x65\x65\x6E\x73", "\x64\x65\x73\x74\x72\x6F\x79", "\x62\x67\x33", "\x73\x70\x72\x69\x74\x65", "\x6D\x61\x70\x5F\x6A\x65\x6C\x6C\x79", "\x6C\x65\x76\x65\x6C\x5F\x73\x65\x6C\x65\x63\x74", "\x6F\x6E\x42\x74\x6E\x4C\x65\x66\x74\x43\x6C\x69\x63\x6B", "\x6F\x6E\x42\x74\x6E\x52\x69\x67\x68\x74\x43\x6C\x69\x63\x6B", "\x63\x68\x65\x63\x6B\x41\x72\x72\x6F\x77\x73\x56\x69\x73\x69\x62\x6C\x65", "\x73\x68\x6F\x77\x50\x61\x67\x65", "\x68\x61\x6E\x64\x5F\x69\x63\x6F\x6E", "\x6D\x61\x74\x63\x68\x5F\x69\x63\x6F\x6E", "\x74\x69\x6D\x65\x72\x5F\x69\x63\x6F\x6E", "\x73\x74\x61\x72\x73", "\x6C\x6F\x63\x6B\x65\x64\x5F\x6C\x65\x76\x65\x6C", "\x6C\x76\x6C", "\x69\x6E\x64\x65\x78", "\x6F\x6E\x4C\x65\x76\x65\x6C\x53\x65\x6C\x65\x63\x74", "\x79", "\x68\x65\x69\x67\x68\x74", "\x73\x74\x61\x72\x73\x5F\x62\x61\x63\x6B", "\x73\x74\x61\x72", "\x6E\x43\x75\x72\x4C\x65\x76\x65\x6C", "\x73\x74\x61\x72\x74\x47\x61\x6D\x65", "\x47\x61\x6D\x65", "\x73\x74\x61\x72\x74", "\x73\x74\x61\x74\x65", "\x69\x6E\x70\x75\x74\x45\x6E\x61\x62\x6C\x65\x64", "\x75\x73\x65\x48\x61\x6E\x64\x43\x75\x72\x73\x6F\x72", "\x69\x6E\x70\x75\x74", "\x6F\x6E\x49\x6E\x70\x75\x74\x44\x6F\x77\x6E", "\x6F\x6E\x49\x6E\x70\x75\x74\x55\x70", "\x6F\x6E\x49\x6E\x70\x75\x74\x4F\x75\x74", "\x68\x74\x74\x70\x3A\x2F\x2F\x61\x31\x30\x2E\x63\x6F\x6D", "\x5F\x62\x6C\x61\x6E\x6B", "\x6F\x70\x65\x6E", "\x53\x61\x76\x65\x73", "\x76\x65\x72\x73\x69\x6F\x6E", "\x5F\x76\x30\x2E\x39\x35", "\x39\x30\x30\x30\x30\x30\x39\x30\x30\x30\x30\x30\x39\x30\x30\x30\x30\x30", "\x30\x30\x30\x30\x30\x30\x30\x30", "\x6A\x65\x6C\x6C\x6F\x66\x5F\x73\x6F\x75\x6E\x64", "\x63\x6F\x6F\x6B\x69\x65\x45\x78\x73\x69\x73\x74\x73", "\x63\x6F\x6F\x6B\x69\x65\x47\x65\x74", "\x6A\x65\x6C\x6C\x6F\x66\x5F\x74\x72\x6F\x70\x68\x69\x65\x73", "\x6A\x65\x6C\x6C\x6F\x66\x5F\x73\x74\x61\x72\x73", "\x63\x6F\x6F\x6B\x69\x65\x53\x65\x74", "\x67\x65\x74\x44\x61\x74\x65", "\x73\x65\x74\x44\x61\x74\x65", "\x3B\x20\x65\x78\x70\x69\x72\x65\x73\x3D", "\x74\x6F\x55\x54\x43\x53\x74\x72\x69\x6E\x67", "\x63\x6F\x6F\x6B\x69\x65", "\x3D", "\x20", "\x69\x6E\x64\x65\x78\x4F\x66", "\x3B", "\x6C\x65\x6E\x67\x74\x68"];
JellyFriend[_0xe044[0]] = function(_0x16aax1) {
    this[_0xe044[1]] = null;
    this[_0xe044[2]] = null;
    this[_0xe044[3]] = null;
    this[_0xe044[4]] = null;
...
JellyFriend[_0xe044[0]][_0xe044[9]] = {
    create: function() {
        if (this[_0xe044[11]][_0xe044[10]] == null) {
            this[_0xe044[11]][_0xe044[10]] = new JellyFriend.Saves();
            this[_0xe044[12]](300);
        } else {
            if (this[_0xe044[11]][_0xe044[13]] != null) {
                this[_0xe044[14]]();
                this[_0xe044[11]][_0xe044[13]] = null;
            } else {
                groupMMenu = null;
                this[_0xe044[15]]();
            };
    ...
    update: function() {
        document[_0xe044[19]](_0xe044[18])[_0xe044[17]][_0xe044[16]] = 0.99;
        setTimeout(function() {
            document[_0xe044[19]](_0xe044[18])[_0xe044[17]][_0xe044[16]] = 1;
        }, 0);
    },
    showMainMenu: function(_0x16aax5) {
        if (_0x16aax5 == null) {
            _0x16aax5 = 0;
        };
        groupMMenu = this[_0xe044[11]][_0xe044[21]][_0xe044[20]]();
        groupMMenu[_0xe044[25]](0, 0, _0xe044[24])[_0xe044[23]][_0xe044[22]](2, 2);
        var _0x16aax6 = groupMMenu[_0xe044[25]](76, 250, _0xe044[26]);
        _0x16aax6[_0xe044[23]][_0xe044[22]](0.75, 0.75);
        _0x16aax6[_0xe044[27]] = -10;
        _0x16aax6[_0xe044[28]] = this[_0xe044[30]][_0xe044[29]](0, 5);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[31], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 0, 16, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[36], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 28, 42, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[37], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 42, 27, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[38], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 43, 55, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[39], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 55, 43, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[40], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 56, 70, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[41], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 70, 56, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[42], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 71, 79, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[43], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 79, 71, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[44], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 80, 95, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[21]](_0xe044[45], Phaser[_0xe044[34]][_0xe044[33]](_0xe044[26], 95, 80, _0xe044[32], 4), 24, true);
        _0x16aax6[_0xe044[35]][_0xe044[46]](_0xe044[31], 24, false);
        _0x16aax6[_0xe044[49]][_0xe044[48]][_0xe044[21]](this[_0xe044[47]], this);
        _0x16aax6[_0xe044[50]] = 0;
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax6)[_0xe044[53]]({
            alpha: 1
        }, 200, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 800 + _0x16aax5);
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax6)[_0xe044[53]]({
            y: 110
        }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 800 + _0x16aax5);
        var _0x16aax7 = groupMMenu[_0xe044[25]](40, -470, _0xe044[55]);
        _0x16aax7[_0xe044[56]] = _0xe044[57];
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax7)[_0xe044[53]]({
            y: 270
        }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 200 + _0x16aax5);
        _0x16aax7 = groupMMenu[_0xe044[25]](210, 1120, _0xe044[58]);
        this[_0xe044[60]](_0x16aax7, this[_0xe044[59]]);
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax7)[_0xe044[53]]({
            y: 725
        }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 200 + _0x16aax5);
        _0x16aax7 = groupMMenu[_0xe044[25]](210, -100, _0xe044[55]);
        _0x16aax7[_0xe044[56]] = _0xe044[61];
        this[_0xe044[60]](_0x16aax7, this[_0xe044[62]]);
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax7)[_0xe044[53]]({
            y: 600
        }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 200 + _0x16aax5);
        _0x16aax7 = groupMMenu[_0xe044[25]](-322, 780, _0xe044[55]);
        _0x16aax7[_0xe044[56]] = _0xe044[63];
        this[_0xe044[60]](_0x16aax7, this[_0xe044[64]]);
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax7)[_0xe044[53]]({
            x: 22
        }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 200 + _0x16aax5);
        _0x16aax7 = groupMMenu[_0xe044[25]](770, 780, _0xe044[55]);
        _0x16aax7[_0xe044[56]] = _0xe044[65];
        this[_0xe044[60]](_0x16aax7, this[_0xe044[14]]);
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax7)[_0xe044[53]]({
            x: 470
        }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 200 + _0x16aax5);
        _0x16aax7 = groupMMenu[_0xe044[25]](-220, 20, _0xe044[66]);
        this[_0xe044[60]](_0x16aax7, this[_0xe044[59]]);
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax7)[_0xe044[53]]({
            x: 20
        }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 200 + _0x16aax5);
        this[_0xe044[67]](groupMMenu, true, _0x16aax5);
        groupMMenu[_0xe044[50]] = 0.0;
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](groupMMenu)[_0xe044[53]]({
            alpha: 1.0
        }, 300, Phaser[_0xe044[52]][_0xe044[68]].In, true);
    },
    onJellyAnimComplete: function(_0x16aax8) {
        if (_0x16aax8[_0xe044[69]] == _0xe044[70]) {
            _0x16aax8[_0xe044[69]] = _0xe044[71];
            _0x16aax8[_0xe044[35]][_0xe044[46]](_0x16aax8[_0xe044[35]][_0xe044[73]][_0xe044[72]] + _0xe044[74], 24, false);
        } else {
            if (Math[_0xe044[75]]() > 0.4) {
                _0x16aax8[_0xe044[35]][_0xe044[46]](_0xe044[31], 24, false);
            } else {
                _0x16aax8[_0xe044[28]] = _0x16aax8[_0xe044[28]] >= 4 ? 0 : _0x16aax8[_0xe044[28]] + 1;
                _0x16aax8[_0xe044[69]] = _0xe044[70];
                _0x16aax8[_0xe044[35]][_0xe044[46]](_0xe044[76] + arJellyMorphAnimations[_0x16aax8[_0xe044[28]]], 24, false);
            };
        };
    },
    createSoundBtn: function(_0x16aax9, _0x16aaxa, _0x16aax5) {
        if (!this[_0xe044[11]][_0xe044[78]][_0xe044[77]]) {
            this[_0xe044[11]][_0xe044[10]][_0xe044[79]] = false;
            return;
        };
        var _0x16aax7 = _0x16aax9[_0xe044[25]](590, 54, _0xe044[55]);
        _0x16aax7[_0xe044[56]] = _0xe044[80];
        this[_0xe044[60]](_0x16aax7, this[_0xe044[81]], this[_0xe044[82]]);
        _0x16aax7[_0xe044[83]][_0xe044[22]](0.5, 0.5);
        _0x16aax7[_0xe044[50]] = this[_0xe044[11]][_0xe044[10]][_0xe044[79]] ? 1.0 : 0.5;
        if (_0x16aaxa != null) {
            _0x16aax7[_0xe044[84]] = 700;
            this[_0xe044[11]][_0xe044[21]][_0xe044[54]](_0x16aax7)[_0xe044[53]]({
                x: 590
            }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 200 + _0x16aax5);
        };
    ...
    onBtnPlayClick: function() {
        if (this[_0xe044[11]][_0xe044[10]][_0xe044[79]]) {
            this[_0xe044[11]][_0xe044[85]][_0xe044[46]]();
        };
        this[_0xe044[15]]();
    },
    onBtnTrophiesClick: function() {
        if (groupMMenu != null) {
            removeGroup(groupMMenu);
        };
        groupMMenu = this[_0xe044[11]][_0xe044[21]][_0xe044[20]]();
        groupMMenu[_0xe044[25]](0, 0, _0xe044[24])[_0xe044[23]][_0xe044[22]](2, 2);
        (groupMMenu[_0xe044[86]] = groupMMenu[_0xe044[25]](150, 840, _0xe044[55]))[_0xe044[56]] = _0xe044[87];
        this[_0xe044[60]](groupMMenu[_0xe044[86]], this[_0xe044[88]], this[_0xe044[82]]);
        (groupMMenu[_0xe044[89]] = groupMMenu[_0xe044[25]](500, 840, _0xe044[55]))[_0xe044[56]] = _0xe044[87];
        groupMMenu[_0xe044[89]][_0xe044[23]][_0xe044[22]](-1, 1);
        this[_0xe044[60]](groupMMenu[_0xe044[89]], this[_0xe044[90]], this[_0xe044[91]], this[_0xe044[91]]);
        groupMMenu[_0xe044[25]](240, 855, _0xe044[55])[_0xe044[56]] = _0xe044[92];
        groupMMenu[_0xe044[25]](340, 855, _0xe044[55])[_0xe044[56]] = _0xe044[92];
        groupMMenu[_0xe044[93]] = groupMMenu[_0xe044[25]](240, 855, _0xe044[55]);
        groupMMenu[_0xe044[93]][_0xe044[56]] = _0xe044[93];
        (groupMMenu[_0xe044[94]] = groupMMenu[_0xe044[25]](40, 120, _0xe044[95]))[_0xe044[56]] = _0xe044[94];
        (groupMMenu[_0xe044[96]] = groupMMenu[_0xe044[25]](40, 190, _0xe044[95]))[_0xe044[56]] = _0xe044[96];
        groupMMenu[_0xe044[25]](165, 20, _0xe044[95])[_0xe044[56]] = _0xe044[97];
        (groupMMenu[_0xe044[98]] = groupMMenu[_0xe044[25]](38, 232, _0xe044[95]))[_0xe044[56]] = _0xe044[98];
        (groupMMenu[_0xe044[99]] = groupMMenu[_0xe044[25]](358, 120, _0xe044[95]))[_0xe044[56]] = _0xe044[99];
        (groupMMenu[_0xe044[100]] = groupMMenu[_0xe044[25]](65, 480, _0xe044[95]))[_0xe044[56]] = _0xe044[100];
        (groupMMenu[_0xe044[101]] = groupMMenu[_0xe044[25]](322, 574, _0xe044[95]))[_0xe044[56]] = _0xe044[101];
        (groupMMenu[_0xe044[102]] = groupMMenu[_0xe044[25]](81, 192, _0xe044[95]))[_0xe044[56]] = _0xe044[102];
        (groupMMenu[_0xe044[103]] = groupMMenu[_0xe044[25]](393, 185, _0xe044[95]))[_0xe044[56]] = _0xe044[103];
        (groupMMenu[_0xe044[104]] = groupMMenu[_0xe044[25]](47, 517, _0xe044[95]))[_0xe044[56]] = _0xe044[104];
        (groupMMenu[_0xe044[105]] = groupMMenu[_0xe044[25]](372, 555, _0xe044[95]))[_0xe044[56]] = _0xe044[105];
        if (this[_0xe044[11]][_0xe044[13]] != null) {
            this[_0xe044[106]](this[_0xe044[11]][_0xe044[13]] < 4 ? 1 : 2);
        } else {
            this[_0xe044[106]](1);
            if (this[_0xe044[11]][_0xe044[10]][_0xe044[79]]) {
                this[_0xe044[11]][_0xe044[85]][_0xe044[46]]();
        ...
        var _0x16aax7 = groupMMenu[_0xe044[25]](20, 20, _0xe044[55]);
        _0x16aax7[_0xe044[56]] = _0xe044[107];
        this[_0xe044[60]](_0x16aax7, this[_0xe044[108]]);
        this[_0xe044[67]](groupMMenu);
        _0x16aax7 = groupMMenu[_0xe044[25]](80, 110, _0xe044[66]);
        this[_0xe044[60]](_0x16aax7, this[_0xe044[59]]);
        groupMMenu[_0xe044[50]] = 0.0;
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](groupMMenu)[_0xe044[53]]({
            alpha: 1.0
    ...
    onBtnTrLArrowClick: function(_0x16aax7) {
        _0x16aax7[_0xe044[23]][_0xe044[22]](1.1, 1.1);
        if (this[_0xe044[11]][_0xe044[10]][_0xe044[79]]) {
            this[_0xe044[11]][_0xe044[85]][_0xe044[46]]();
        };
        if (groupMMenu[_0xe044[93]][_0xe044[84]] == 340) {
            groupMMenu[_0xe044[93]][_0xe044[84]] = 240;
            this[_0xe044[106]](1);
        };
    },
    onBtnTrRArrowClick: function(_0x16aax7) {
        _0x16aax7[_0xe044[23]][_0xe044[22]](-1.1, 1.1);
        if (this[_0xe044[11]][_0xe044[10]][_0xe044[79]]) {
            this[_0xe044[11]][_0xe044[85]][_0xe044[46]]();
        };
        if (groupMMenu[_0xe044[93]][_0xe044[84]] == 240) {
            groupMMenu[_0xe044[93]][_0xe044[84]] = 340;
            this[_0xe044[106]](2);
        };
    },
    showTrophiesPage: function(_0x16aaxb) {
        var _0x16aaxc = [_0xe044[98], _0xe044[99], _0xe044[100], _0xe044[101], _0xe044[102], _0xe044[104], _0xe044[103], _0xe044[105]];
        groupMMenu[_0xe044[94]][_0xe044[109]] = !(_0x16aaxb == 2);
        groupMMenu[_0xe044[96]][_0xe044[109]] = (_0x16aaxb == 2);
        groupMMenu[_0xe044[93]][_0xe044[84]] = _0x16aaxb == 1 ? 240 : 340;
        if (this[_0xe044[11]][_0xe044[10]][_0xe044[110]][0] != _0xe044[111] && this[_0xe044[11]][_0xe044[113]][_0xe044[112]]() >= 600) {
            this[_0xe044[11]][_0xe044[10]][_0xe044[110]] = _0xe044[111] + this[_0xe044[11]][_0xe044[10]][_0xe044[110]][_0xe044[114]](1, 8);
            this[_0xe044[11]][_0xe044[10]][_0xe044[115]]();
        };
        for (var _0x16aaxd = 0; _0x16aaxd < 8; _0x16aaxd++) {
            groupMMenu[_0x16aaxc[_0x16aaxd]][_0xe044[109]] = !(this[_0xe044[11]][_0xe044[10]][_0xe044[110]][_0x16aaxd] == _0xe044[116] || (_0x16aaxb == 1 && _0x16aaxd > 3) || (_0x16aaxb == 2 && _0x16aaxd < 4));
        };
    },
    onBtnInfoClick: function() {
        ...
        groupMMenu = this[_0xe044[11]][_0xe044[21]][_0xe044[20]]();
        groupMMenu[_0xe044[25]](0, 0, _0xe044[24])[_0xe044[23]][_0xe044[22]](2, 2);
        var _0x16aaxe = groupMMenu[_0xe044[25]](120, 175, _0xe044[55]);
        _0x16aaxe[_0xe044[56]] = _0xe044[57];
        _0x16aaxe[_0xe044[23]][_0xe044[22]](0.75, 0.75);
        groupMMenu[_0xe044[25]](245, 400, _0xe044[55])[_0xe044[56]] = _0xe044[117];
        groupMMenu[_0xe044[25]](35, 500, _0xe044[95])[_0xe044[56]] = _0xe044[118];
        groupMMenu[_0xe044[25]](320, 530, _0xe044[55])[_0xe044[56]] = _0xe044[119];
        _0x16aaxe = groupMMenu[_0xe044[25]](20, 20, _0xe044[55]);
        _0x16aaxe[_0xe044[56]] = _0xe044[107];
        this[_0xe044[60]](_0x16aaxe, this[_0xe044[108]]);
        this[_0xe044[67]](groupMMenu);
        _0x16aaxe = groupMMenu[_0xe044[25]](240, 30, _0xe044[66]);
        this[_0xe044[60]](_0x16aaxe, this[_0xe044[59]]);
        if (this[_0xe044[11]][_0xe044[10]][_0xe044[79]]) {
            this[_0xe044[11]][_0xe044[85]][_0xe044[46]]();
        };
        groupMMenu[_0xe044[50]] = 0.0;
    ...
    onBtnSoundClick: function(_0x16aax7) {
        if (!this[_0xe044[11]][_0xe044[78]][_0xe044[77]]) {
            _0x16aax7[_0xe044[50]] = 0.5;
            this[_0xe044[11]][_0xe044[10]][_0xe044[79]] = false;
            return;
        };
        this[_0xe044[11]][_0xe044[10]][_0xe044[79]] = !this[_0xe044[11]][_0xe044[10]][_0xe044[79]];
        _0x16aax7[_0xe044[50]] = this[_0xe044[11]][_0xe044[10]][_0xe044[79]] ? 1.0 : 0.5;
        _0x16aax7[_0xe044[23]][_0xe044[22]](1.1, 1.1);
        if (this[_0xe044[11]][_0xe044[10]][_0xe044[79]]) {
            this[_0xe044[11]][_0xe044[85]][_0xe044[46]]();
        };
        this[_0xe044[11]][_0xe044[10]][_0xe044[120]]();
    },
    onBtnMainMenuClick: function() {
        if (groupLevels != null) {
            if (this[_0xe044[11]][_0xe044[122]][_0xe044[121]](groupMap)) {
                return;
            };
            removeGroup(groupLevels);
            groupLevels = null;
            removeGroup(groupMap);
            groupMap = this[_0xe044[7]] = this[_0xe044[8]] = this[_0xe044[6]] = null;
            this[_0xe044[3]][_0xe044[123]]();
            this[_0xe044[3]] = null;
            this[_0xe044[4]][_0xe044[123]]();
            this[_0xe044[4]] = null;
        };
        if (groupMMenu != null) {
            removeGroup(groupMMenu);
    ...
    showMap: function() {
        ...
        this[_0xe044[3]] = this[_0xe044[11]][_0xe044[21]][_0xe044[125]](0, 0, _0xe044[124]);
        this[_0xe044[3]][_0xe044[23]][_0xe044[22]](2, 2);
        (this[_0xe044[4]] = this[_0xe044[11]][_0xe044[21]][_0xe044[125]](370, 1100, _0xe044[55]))[_0xe044[56]] = _0xe044[126];
        groupMap = this[_0xe044[11]][_0xe044[21]][_0xe044[20]]();
        (groupMap[_0xe044[25]](170, 20, _0xe044[55]))[_0xe044[56]] = _0xe044[127];
        var _0x16aax7 = groupMap[_0xe044[25]](20, 20, _0xe044[55]);
        _0x16aax7[_0xe044[56]] = _0xe044[107];
        this[_0xe044[60]](_0x16aax7, this[_0xe044[108]]);
        this[_0xe044[67]](groupMap);
        (this[_0xe044[7]] = groupMap[_0xe044[25]](80, 190, _0xe044[55]))[_0xe044[56]] = _0xe044[87];
        this[_0xe044[60]](this[_0xe044[7]], this[_0xe044[128]], this[_0xe044[82]]);
        (this[_0xe044[8]] = groupMap[_0xe044[25]](570, 190, _0xe044[55]))[_0xe044[56]] = _0xe044[87];
        this[_0xe044[8]][_0xe044[23]][_0xe044[22]](-1, 1);
        this[_0xe044[60]](this[_0xe044[8]], this[_0xe044[129]], this[_0xe044[91]], this[_0xe044[91]]);
        _0x16aax7 = groupMap[_0xe044[25]](55, 870, _0xe044[66]);
        this[_0xe044[60]](_0x16aax7, this[_0xe044[59]]);
        this[_0xe044[130]]();
        this[_0xe044[131]]();
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](this[_0xe044[4]])[_0xe044[53]]({
            y: 800
        }, 500, Phaser[_0xe044[52]][_0xe044[51]].Out, true, 500);
        groupMap[_0xe044[84]] = -700;
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](groupMap)[_0xe044[53]]({
            x: 0.0
        }, 1000, Phaser[_0xe044[52]][_0xe044[51]].Out, true);
        groupLevels[_0xe044[84]] = -700;
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](groupLevels)[_0xe044[53]]({
            x: 0.0
        }, 1000, Phaser[_0xe044[52]][_0xe044[51]].Out, true);
    },
    showPage: function() {
        ...
        if (this[_0xe044[6]] != null) {
            this[_0xe044[6]][_0xe044[123]]();
        };
        this[_0xe044[6]] = groupMap[_0xe044[25]](this[_0xe044[5]] == 2 ? 150 : 170, 90, _0xe044[55]);
        this[_0xe044[6]][_0xe044[56]] = this[_0xe044[5]] == 0 ? _0xe044[132] : (this[_0xe044[5]] == 1 ? _0xe044[133] : _0xe044[134]);
        groupLevels = this[_0xe044[11]][_0xe044[21]][_0xe044[20]]();
        var _0x16aaxe;
        var _0x16aaxf = 0;
        for (var _0x16aaxd = 1; _0x16aaxd < 7; _0x16aaxd += 1) {
            _0x16aaxf = this[_0xe044[11]][_0xe044[10]][_0xe044[135]][this[_0xe044[5]] * 6 + _0x16aaxd - 1];
            _0x16aaxe = groupLevels[_0xe044[25]](((_0x16aaxd - 1) % 3) * 200 + 50, 400 + (_0x16aaxd > 3 ? 225 : 0), _0xe044[55]);
            _0x16aaxe[_0xe044[56]] = _0x16aaxf == 0 ? _0xe044[136] : _0xe044[32] + (this[_0xe044[5]] * 6 + _0x16aaxd) + _0xe044[137];
            _0x16aaxe[_0xe044[138]] = this[_0xe044[5]] * 6 + _0x16aaxd;
            if (_0x16aaxf != 0) {
                this[_0xe044[60]](_0x16aaxe, this[_0xe044[139]]);
            };
            var _0x16aax10 = groupLevels[_0xe044[25]](_0x16aaxe[_0xe044[84]], _0x16aaxe[_0xe044[140]] + _0x16aaxe[_0xe044[141]], _0xe044[55]);
            _0x16aax10[_0xe044[56]] = _0xe044[142];
            if (_0x16aaxf != 9) {
                for (var _0x16aax11 = 0; _0x16aax11 < _0x16aaxf; _0x16aax11 += 1) {
                    (groupLevels[_0xe044[25]](_0x16aax10[_0xe044[84]] + _0x16aax11 * 52 + 2, _0x16aax11 == 1 ? _0x16aax10[_0xe044[140]] + 14 : _0x16aax10[_0xe044[140]] + 3, _0xe044[55]))[_0xe044[56]] = _0xe044[143];
                };
            };
        };
        groupLevels[_0xe044[50]] = 0.0;
        this[_0xe044[11]][_0xe044[21]][_0xe044[54]](groupLevels)[_0xe044[53]]({
            alpha: 1.0
        }, 500, Phaser[_0xe044[52]][_0xe044[68]].In, true);
    },
    onBtnLeftClick: function(_0x16aax7) {
        if (this[_0xe044[11]][_0xe044[122]][_0xe044[121]](groupMap) || this[_0xe044[11]][_0xe044[122]][_0xe044[121]](groupLevels)) {
            return;
        };
        if (_0x16aax7[_0xe044[50]] < 1) {
            return;
        };
        if (this[_0xe044[11]][_0xe044[10]][_0xe044[79]]) {
            this[_0xe044[11]][_0xe044[85]][_0xe044[46]]();
    ...
    onBtnRightClick: function(_0x16aax7) {
        if (this[_0xe044[11]][_0xe044[122]][_0xe044[121]](groupMap) || this[_0xe044[11]][_0xe044[122]][_0xe044[121]](groupLevels)) {
            return;
        };
        if (_0x16aax7[_0xe044[50]] < 1) {
    ...
    checkArrowsVisible: function() {
        this[_0xe044[7]][_0xe044[50]] = this[_0xe044[5]] != 0 ? 1 : 0.2;
        this[_0xe044[8]][_0xe044[50]] = this[_0xe044[5]] != 2 ? 1 : 0.2;
    },
    onLevelSelect: function(_0x16aaxe) {
        if (this[_0xe044[11]][_0xe044[10]][_0xe044[79]]) {
            this[_0xe044[11]][_0xe044[85]][_0xe044[46]]();
        };
        this[_0xe044[11]][_0xe044[144]] = _0x16aaxe[_0xe044[138]];
        this[_0xe044[145]]();
    },
    startGame: function() {
        removeGroup(groupLevels);
        groupLevels = null;
        removeGroup(groupMap);
        groupMap = this[_0xe044[6]] = null;
        this[_0xe044[3]][_0xe044[123]]();
        this[_0xe044[3]] = null;
        this[_0xe044[4]][_0xe044[123]]();
        this[_0xe044[4]] = null;
        this[_0xe044[11]][_0xe044[148]][_0xe044[147]](_0xe044[146]);
    },
    setButtonWithInputDown: function(_0x16aax7, _0x16aax12, _0x16aax13, _0x16aax14) {
        _0x16aax7[_0xe044[149]] = true;
        _0x16aax7[_0xe044[151]][_0xe044[150]] = true;
        _0x16aax7[_0xe044[49]][_0xe044[152]][_0xe044[21]](_0x16aax12, this);
        if (_0x16aax13 != null) {
            _0x16aax7[_0xe044[49]][_0xe044[153]][_0xe044[21]](_0x16aax13, this);
        };
        if (_0x16aax14 != null) {
            _0x16aax7[_0xe044[49]][_0xe044[154]][_0xe044[21]](_0x16aax14, this);
        } else {
            if (_0x16aax13 != null) {
                _0x16aax7[_0xe044[49]][_0xe044[154]][_0xe044[21]](this[_0xe044[82]], this);
            };
        };
    },
    onBtnMouseOut: function(_0x16aax7) {
        _0x16aax7[_0xe044[23]][_0xe044[22]](1.0, 1.0);
    },
    onBtnMouseOutArrowRight: function(_0x16aax7) {
        _0x16aax7[_0xe044[23]][_0xe044[22]](-1.0, 1.0);
    },
    onBtnSponsorClick: function() {
        window[_0xe044[157]](_0xe044[155], _0xe044[156]);
    }
};
JellyFriend[_0xe044[158]] = function() {
    this[_0xe044[159]] = _0xe044[160];
    this[_0xe044[135]] = _0xe044[161];
    this[_0xe044[79]] = true;
    this[_0xe044[110]] = _0xe044[162];
    if (this[_0xe044[164]](_0xe044[163] + this[_0xe044[159]]) == 1) {
        this[_0xe044[79]] = this[_0xe044[165]](_0xe044[163] + this[_0xe044[159]]) == _0xe044[111];
    };
    if (this[_0xe044[164]](_0xe044[166] + this[_0xe044[159]]) == 1) {
        this[_0xe044[110]] = this[_0xe044[165]](_0xe044[166] + this[_0xe044[159]]);
    };
    if (this[_0xe044[164]](_0xe044[167] + this[_0xe044[159]]) == 1) {
        this[_0xe044[135]] = this[_0xe044[165]](_0xe044[167] + this[_0xe044[159]]);
    };
};
JellyFriend[_0xe044[158]][_0xe044[9]] = {
    saveData: function() {
        this[_0xe044[168]](_0xe044[167] + this[_0xe044[159]], this[_0xe044[135]], 100);
    },
    saveSound: function() {
        this[_0xe044[168]](_0xe044[163] + this[_0xe044[159]], this[_0xe044[79]] ? _0xe044[111] : _0xe044[116], 100);
    },
    saveTrophies: function() {
        this[_0xe044[168]](_0xe044[166] + this[_0xe044[159]], this[_0xe044[110]], 100);
    },
    cookieSet: function(_0x16aax15, _0x16aax16, _0x16aax17) {
        try {
            var _0x16aax18 = new Date();
            _0x16aax18[_0xe044[170]](_0x16aax18[_0xe044[169]]() + _0x16aax17);
            var _0x16aax19 = escape(_0x16aax16) + ((_0x16aax17 == null) ? _0xe044[32] : _0xe044[171] + _0x16aax18[_0xe044[172]]());
            document[_0xe044[173]] = _0x16aax15 + _0xe044[174] + _0x16aax19;
            return 1;
        } catch (e) {
            return e;
        };
    },
    cookieGet: function(_0x16aax15) {
        try {
            var _0x16aax1a = _0x16aax15;
            var _0x16aax19 = document[_0xe044[173]];
            var _0x16aax1b = _0x16aax19[_0xe044[176]](_0xe044[175] + _0x16aax1a + _0xe044[174]);
            if (_0x16aax1b == -1) {
                _0x16aax1b = _0x16aax19[_0xe044[176]](_0x16aax1a + _0xe044[174]);
            };
            if (_0x16aax1b == -1) {
                _0x16aax19 = null;
            } else {
                _0x16aax1b = _0x16aax19[_0xe044[176]](_0xe044[174], _0x16aax1b) + 1;
                var _0x16aax1c = _0x16aax19[_0xe044[176]](_0xe044[177], _0x16aax1b);
                if (_0x16aax1c == -1) {
                    _0x16aax1c = _0x16aax19[_0xe044[178]];
                };
                _0x16aax19 = unescape(_0x16aax19[_0xe044[114]](_0x16aax1b, _0x16aax1c));
            };
            return _0x16aax19;
        } catch (e) {
            return e;
    ...
    cookieExsists: function(_0x16aax15) {
        try {
            var _0x16aax1d = this[_0xe044[165]](_0x16aax15);
            if (_0x16aax1d != null && _0x16aax1d != _0xe044[32]) {
                return 1;
            } else {
                return 0;
            };
...
JellyFriend.Game = function(a) {
    this.arLevelTimes = [
        [10, 10, 15, 15, 15, 15, 28, 16, 25, 25, 18, 18, 15, 18, 18, 8, 4, 4],
        [5, 4, 12, 10, 10, 10, 20, 14, 20, 20, 11, 11, 9, 10, 12, 4, 1.6, 1.6],
        [4, 3, 10, 7, 8, 8, 17, 12, 17, 17, 9, 9, 6, 8, 9, 2.5, 1.2, 1.2]
    ];
    this.arHelpStrings = "Tap jelly to start;Tap any jelly to start;Tap any jelly to start;Press any button to start;Tap any jelly to start;Tap any jelly to start;Tap one of two jelly to start;Press button\nwhich match color of jelly;Press button\nwhich match more jellies;Press button\nwhich match less jellies;Yes or No? Press correct button;Yes or No? Press correct button;Tap any jelly to start;Tap any jelly to start;Tap any jelly to start;Tap any jelly to start;Hold the button to start;Hold the button to start".split(";");
    this.btnPause = this.btnFastRestart = null
};
JellyFriend.Game.prototype = {
    create: function() {
        text_style_timer = {
            font: "60px JandaManateeSolid",
            align: "center"
        };
        nCurLevel = this.game.nCurLevel;
        this.game.stage.backgroundColor = "#00ccff";
        this.background = this.add.sprite(0, 0, "bg1");
        this.background.scale.setTo(2, 2);
        bStarted = bPause = bPauseTimer = !1;
        this.game.device.desktop && (this.arLevelTimes[0][3] = 20);
        this.initLevelGUI()
    },
    initLevel1: function(a) {
        null == a && (a = !1);
        groupJellys.numClicks = 0;
        if (a) {
            groupJellys.nPhaseNum += 1;
            for (a = 0; a < jellys.length; a += 1) jellys[a].shadow.destroy(), jellys[a].textCounter.destroy(), jellys[a].destroy();
            jellys = []
        } else groupJellys.nPhaseNum = 1;
        for (a = 0; a < groupJellys.nPhaseNum; a += 1) {
            var b = 1 == groupJellys.nPhaseNum ? this.createJelly(320, 600, a, arJellyColorTypes[a % 3]) : 2 == groupJellys.nPhaseNum ? this.createJelly(0 == a ? 200 : 400, 270 * a + 550, a, arJellyColorTypes[a % 3]) : this.createJelly(160 * a + 165, a % 2 * 250 + 550, a, arJellyColorTypes[a % 3]);
            b.animations.play("idle", 24, !0);
            b.events.onInputUp.add(this.onBtnMouseOut, this);
            b.events.onInputOut.add(this.onBtnMouseOut, this);
            b.textCounter = this.game.add.bitmapText(b.x - 10, b.y - b.height / 2 - 70, "0", text_style_timer);
            groupJellys.add(b.textCounter)
        }
    },
    onJellyAnimComplete: function(a) {
        "normal" == a.animDirection ? (a.animDirection = "back", a.animations.play(a.animations.currentAnim.name + "_back", 24, !1)) : (a.nCurAnimNum = 4 <= a.nCurAnimNum ? 0 : a.nCurAnimNum + 1, a.animDirection = "normal", a.animations.play("morph_" + arJellyMorphAnimations[a.nCurAnimNum], 24, !1))
    },
    initLevel2: function() {
        for (var a = 0; 3 > a; a += 1) {
            var b = this.createJelly(155 * a + 170, 1 == a ? 800 : 530, a, arJellyColorTypes[a], !1, 0.4);
            b.anchor.setTo(0.5, 1);
            b.shadow.scale = b.scale.setTo(0.4, 0.4);
            b.shadow.y = b.y + 6;
            b.animations.play("idle", 24, !0)
        }
    },
    initLevel3: function(a) {
        a || (groupJellys.nPhaseNum = 1);
        groupJellys.nNumClicks = 0;
        jellys.length = 0;
        groupJellys.nPhaseNum += 1;
        if (6 <= groupJellys.nPhaseNum) this.winLevel();
        else {
            for (var b = 0; b < groupJellys.nPhaseNum * groupJellys.nPhaseNum; b += 1) this.createJelly(b % groupJellys.nPhaseNum * 100 + (760 - 100 * groupJellys.nPhaseNum) / 2, 120 * Math.floor(b / groupJellys.nPhaseNum) + 100 + (1020 - 120 * groupJellys.nPhaseNum) / 2, b, "jelly_color", !1, 0.5).frameName = arJellyColorTypes[this.rnd.integerInRange(0, arJellyColorTypes.length)];
            a && this.showGreatMessage()
        }
    },
    initLevel4: function() {
        if (4 <= groupJellys.nCurPhase) funcCurUpdate = null, this.winLevel();
        else {
            groupJellys.bFinish = !1;
            groupJellys.strLastClick = "";
            groupJellys.nLastClickDelay = 0;
            groupJellys.fDistance = 0;
            groupJellys.fVelocity = 0;
            null == groupJellys.nCurPhase && (groupJellys.nCurPhase = 1);
            funcCurUpdate = "updateLevel4";
            if (1 == groupJellys.nCurPhase) {
                var a = groupJellys.create(320, 480, "sh2");
                a.frameName = "center_stripe";
                a.anchor.setTo(0.5, 0.5);
                (groupJellys.girl_platform = groupJellys.create(400, 700 - 150 * groupJellys.nCurPhase, "sh1")).frameName = "girl_platform";
                (groupJellys.boy_platform = groupJellys.create(320, 902, "sh1")).frameName = "lift_plate";
                groupJellys.boy_platform.anchor.setTo(0.5, 0.5);
                (groupJellys.wheel = groupJellys.create(320, 930, "sh1")).frameName = "lift_wheel";
                groupJellys.wheel.anchor.setTo(0.5, 0.5);
                groupJellys.jelly_girl = this.createJelly(490, 700 - 150 * groupJellys.nCurPhase, 1, "sh1", !0, 0.75);
                groupJellys.jelly_girl.frameName = "jelly_girl";
                groupJellys.jelly_boy = this.createJelly(320, 820, 0, "jelly_orange", !0, 0.5);
                groupJellys.jelly_boy.animations.play("idle", 24, !0)
            } else groupJellys.jelly_boy.x = groupJellys.jelly_boy.shadow.x = 320, groupJellys.jelly_boy.y = 820, groupJellys.jelly_boy.shadow.y = 876, groupJellys.boy_platform.y = 902, groupJellys.wheel.y = 930, groupJellys.girl_platform.y = 700 - 150 * groupJellys.nCurPhase, groupJellys.jelly_girl.shadow.destroy(), groupJellys.jelly_girl.destroy(), groupJellys.jelly_girl = null, groupJellys.jelly_girl = this.createJelly(490, 700 - 150 * groupJellys.nCurPhase, 1, "sh1", !0, 0.75), groupJellys.jelly_girl.frameName = "jelly_girl";
            groupJellys.jelly_girl.shadow.y -= 10;
            groupJellys.jelly_girl.shadow.scale.setTo(0.5, 0.5);
            groupJellys.jelly_girl.tween1 = this.game.add.tween(groupJellys.jelly_girl.scale).to({
                y: 0.75 * 1.1
            }, 300, Phaser.Easing.Linear.In).to({
                    y: 0.75
                }, 300, Phaser.Easing.Linear.In).loop().start();
            groupJellys.jelly_girl.tween2 = this.game.add.tween(groupJellys.jelly_girl).to({
                y: groupJellys.jelly_girl.y - 5
            }, 300, Phaser.Easing.Linear.In).to({
                    y: groupJellys.jelly_girl.y + 5
                }, 300, Phaser.Easing.Linear.In).loop().start();
            a = groupJellys.create(0, 960, "sh1");
            a.frameName = "a_btn";
            a.type = "left";
            a.anchor.setTo(0, 1);
            this.setButtonWithInputDown(a, this.onBtnLiftRunClick, this.onBtnMouseOut);
            a = groupJellys.create(640, 960, "sh1");
            a.frameName = "b_btn";
            a.type = "right";
            a.anchor.setTo(1, 1);
            this.setButtonWithInputDown(a, this.onBtnLiftRunClick, this.onBtnMouseOut)
    ...
    onBtnLiftRunClick: function(a) {
        groupJellys.bFinish || (bStarted || this.startLevel(), this.game.saves.bSound && this.game.sndBlob.play(), bPauseTimer && (bPauseTimer = !1, timeStart += this.game.time.now - timePause), a.scale.setTo(1.1, 1.1), groupJellys.fVelocity = Math.max(groupJellys.fVelocity, 0.3), groupJellys.fVelocity = Math.min(10, a.type != groupJellys.strLastClick ? 1.25 * groupJellys.fVelocity : 0.7 * groupJellys.fVelocity), groupJellys.strLastClick = a.type, groupJellys.nLastClickDelay = 0)
    },
    initLevel7: function(a) {
        null == a && (a = !1);
        if (a) {
            groupJellys.selectedJelly = null;
            for (var b = 0; 12 > b; b += 1) jellys[b].tween1.stop(), jellys[b].tween2.stop(), jellys[b].shadow.destroy(), jellys[b].hats.destroy(), jellys[b].destroy();
            jellys.length = 0
        } else groupJellys.numClicks = 0;
        for (var c = this.rnd.integerInRange(0, 5), d = this.rnd.integerInRange(0, 6), h = this.rnd.integerInRange(0, 12), g = this.rnd.integerInRange(0, 12); g == h;) g = this.rnd.integerInRange(0, 12);
        for (b = 0; 12 > b; b += 1) {
            var e = this.createJelly(b % 4 * 150 + 100, 205 * Math.floor(b / 4) + 430, b, "jelly_color", !1, 0.75);
            e.hats = groupJellys.create(e.x - 88, e.y - 108, "hats");
            e.hats.scale.setTo(0.75, 0.75);
            e.frame = h == b || g == b ? c : this.rnd.integerInRange(0, 5);
            e.hats.frame = h == b || g == b ? d : this.game.rnd.integerInRange(0, 6);
            this.checkHatPosition(e);
            this.game.add.tween(e.hats).to({
                y: e.hats.y - 5
            }, 300, Phaser.Easing.Linear.In).to({
                    y: e.hats.y + 5
                }, 300, Phaser.Easing.Linear.In).loop().start()
        }
        a || ((groupJellys.messPenalty = groupJellys.create(320, 570, "sh1")).frameName = "time_penalty", groupJellys.messPenalty.visible = !1)
    },
    checkHatPosition: function(a) {
        a.hats.x = a.index % 4 * 150 + 12;
        a.hats.y = 205 * Math.floor(a.index / 4) + 322;
        switch (a.hats.frame) {
            case 0:
                a.hats.x -= 6;
                break;
    ...
    initLevel9: function(a) {
        this.initCommonDataLevel9n10(a);
        a = this.rnd.integerInRange(0, 3);
        var b = [0, 1, 2, 3, 4, 5, 6, 7],
            c;
        for (i = 0; 6 > i; i += 1) c = this.rnd.integerInRange(0, b.length), this.putJelly(b[c], 3 > i ? arJellyColorTypes[i] : arJellyColorTypes[a]), b.splice(c, 1);
        for (i = 0; 2 > i; i += 1) {
            var d = this.rnd.integerInRange(0, 3);
            for (c = this.rnd.integerInRange(0, b.length); d == a;) d = this.rnd.integerInRange(0, 3);
            this.putJelly(b[c], arJellyColorTypes[d]);
            b.splice(c, 1)
        }
        jellys[0].strColorMax = arJellyColorTypes[a];
        (groupJellys.messPenalty = groupJellys.create(320, 570, "sh1")).frameName = "time_penalty";
        groupJellys.messPenalty.visible = !1
    },
    initLevel10: function(a) {
        this.initCommonDataLevel9n10(a);
        a = arJellyColorTypes.concat();
        var b = [0, 1, 2, 3, 4],
            c, d = this.rnd.integerInRange(0, 3);
        c = this.rnd.integerInRange(0, b.length);
        this.putJelly(b[c], a[d]);
        jellys[0].strColorMin = a[d];
        b.splice(c, 1);
        a.splice(d, 1);
        for (i = 0; 4 > i; i += 1) c = this.rnd.integerInRange(0, b.length), this.putJelly(b[c], 2 > i ? a[0] : a[1]), b.splice(c, 1);
        (groupJellys.messPenalty = groupJellys.create(320, 570, "sh1")).frameName = "time_penalty";
        groupJellys.messPenalty.visible = !1
    },
    initCommonDataLevel9n10: function(a) {
        a || (groupJellys.numClicks = 0, this.initColorButtons());
        for (a = 0; a < jellys.length; a += 1) jellys[a].shadow.destroy(), jellys[a].destroy();
        jellys.length = 0
    },
    putJelly: function(a, b) {
        (9 == nCurLevel ? this.createJelly(a % 4 * 155 + 85, 3 < a ? 600 : 400, a, "jelly_color", !0, 0.7) : this.createJelly(a % 3 * 155 + (2 > a ? 245 : 170), 1 < a ? 600 : 400, a, "jelly_color", !0, 0.7)).frameName = b
    },
    onBtnColorClick: function(a) {
        if (!bPause) switch (nCurLevel) {
            case 8:
                if (16 < groupJellys.numClicks) break;
                this.game.saves.bSound && this.game.sndBlob.play();
                bStarted || this.startLevel();
                a.scale.setTo(1.1, 1.1);
                if (a.strColor == jellys[jellys.length - 1].colorType) if (groupJellys.numClicks += 1, this.showGreatMessage(), 16 <= groupJellys.numClicks) this.winLevel();
                else {
                    var b = jellys.length;
                    a = arJellyColorTypes[this.rnd.integerInRange(0, 3)];
                    b = this.createJelly(b % 4 * 120 + 150, 100 * Math.floor(b / 4) + 370, b, "jelly_color", !0, 0.5);
                    b.frameName = a;
                    b.colorType = a
                } else this.showTimePenalty();
                break;
            case 9:
                if (15 < groupJellys.numClicks) break;
                this.game.saves.bSound && this.game.sndBlob.play();
                bStarted || this.startLevel();
                a.scale.setTo(1.1, 1.1);
                a.strColor == jellys[0].strColorMax ? (groupJellys.numClicks += 1, this.showGreatMessage(), 15 <= groupJellys.numClicks ? this.winLevel() : this.initLevel9(!0)) : this.showTimePenalty();
                break;
            case 10:
                if (15 < groupJellys.numClicks) break;
                this.game.saves.bSound && this.game.sndBlob.play();
                bStarted || this.startLevel();
                a.scale.setTo(1.1, 1.1);
                a.strColor == jellys[0].strColorMin ? (groupJellys.numClicks += 1, this.showGreatMessage(), 15 <= groupJellys.numClicks ? this.winLevel() : this.initLevel10(!0)) : this.showTimePenalty();
                break;
            case 17:
                bStarted || this.startLevel();
                this.game.saves.bSound && this.game.sndBlob.play();
                textHelp.setText("Wait for orange ...");
                3 > groupJellys.curJellyNum && (a.scale.setTo(1.1, 1.1), funcCurUpdate = "updateLevel17");
                break;
            case 18:
                bStarted || this.startLevel(), this.game.saves.bSound && this.game.sndBlob.play(), textHelp.setText("Wait for sombrero ..."), jellys[0].hats.frame = 2, a.scale.setTo(1.1, 1.1), funcCurUpdate = "updateLevel18"
        }
    },
    onBtnColorUp: function(a) {
        a.scale.setTo(1, 1);
        switch (nCurLevel) {
            case 17:
                if (null == funcCurUpdate) break;
                a = groupJellys.curJellyNum;
                var b = jellys[a];
                funcCurUpdate = null;
                bPauseTimer = !1;
                timePause = this.game.time.now;
                "jelly_orange" == b.colorType && 0 >= groupJellys.nWaitTimer ? (b.shadow.scale = b.scale.setTo(0.75, 0.75), b.shadow.y = b.y + 4, b.alpha = 0.75, a += 1, this.showGreatMessage(), 3 <= a ? this.winLevel() : (b = jellys[a], groupJellys.curJellyNum = a, groupJellys.nWaitTimer = this.rnd.integerInRange(120, 500), b.shadow.scale = b.scale.setTo(1, 1), b.shadow.y = b.y + 4, bPauseTimer = !0, textHelp.setText("Hold the button again"))) : (strLevelTime = "TOO EARLY", this.looseLevel());
                break;
            case 18:
                if (null == funcCurUpdate) break;
                funcCurUpdate = null;
                bPauseTimer = !1;
                timePause = this.game.time.now;
                groupJellys.nWaitTimer = this.rnd.integerInRange(100, 800);
                groupJellys.nChangeTimer = 30;
                1 == jellys[0].hats.currentFrame.index ? (groupJellys.nHatsNum += 1, this.showGreatMessage(), 3 <= groupJellys.nHatsNum ? this.winLevel() : (bPauseTimer = !0, textHelp.setText("Hold the button again"))) : (strLevelTime = "TOO EARLY", this.looseLevel())
        }
    },
    initColorButtons: function() {
        for (var a = ["green_btn", "orange_btn", "violet_btn"], b = 0; 3 > b; b += 1) {
            var c = groupJellys.create(200 * b + 120, 840, "sh1");
            c.frameName = a[b];
            c.strColor = arJellyColorTypes[b];
            c.anchor.setTo(0.5, 0.5);
            this.setButtonWithInputDown(c, this.onBtnColorClick, this.onBtnColorUp)
        }
    },
    initLevel5: function() {
        for (var a = groupJellys.numClicks = 0; a < (6 == nCurLevel ? 4 : 5); a += 1) {
            var b = 6 == nCurLevel ? this.createJelly(a % 2 * 250 + 200, 280 * Math.floor(a / 2) + 500, a, "jelly_color") : this.createJelly(540 * Math.random() + 50, 120 * a + 350, a, "jelly_color", !1, 0.5);
            b.frameName = arJellyColorTypes[a % 3];
            var c = 6 == nCurLevel ? 500 : Math.round(250 + 50 * Math.random());
            6 == nCurLevel && (b.hats = groupJellys.create(b.x - 118, b.y - 145, "hats"), b.hats.frame = a % 6, this.game.add.tween(b.hats).to({
                alpha: 0
            }, 300, Phaser.Easing.Linear.In, !0, c).to({
                    alpha: 1
                }, 300, Phaser.Easing.Linear.In, !0, 150).loop().start(), this.game.add.tween(b.hats).to({
                y: b.hats.y - 5
            }, 300, Phaser.Easing.Linear.In).to({
                    y: b.hats.y + 5
                }, 300, Phaser.Easing.Linear.In).loop().start());
            this.game.add.tween(b).to({
                alpha: 0
                    ...
                    alpha: 1
                }, 300, Phaser.Easing.Linear.In, !0, 150).loop().start().onComplete.add(function() {
                    6 != nCurLevel && (this.x = this.shadow.x = 540 * Math.random() + 50);
                    6 == nCurLevel && (this.hats.frame = Math.floor(6 * Math.random()))
                }, b);
            this.game.add.tween(b.shadow).to({
                alpha: 0
            }, 300, Phaser.Easing.Linear.In, !0, c).to({
                    alpha: 1
                }, 300, Phaser.Easing.Linear.In, !0, 150).loop().start();
            b.splash = groupJellys.create(60, 120 * a + 350, "jelly_splash");
            b.splash.anchor.setTo(0.5, 0.5);
            6 == nCurLevel ? b.splash.scale.setTo(1, 1) : b.splash.scale.setTo(0.5, 0.5);
            b.splash.animations.add("all");
            b.splash.visible = !1;
            b.animations.play("idle", 24, !0)
        }
    },
    initLevel8: function() {
        ...
        var a = arJellyColorTypes[this.rnd.integerInRange(0, 3)],
            b = this.createJelly(150, 370, 0, "jelly_color", !0, 0.5);
        b.frameName = a;
        b.colorType = a;
        (groupJellys.messPenalty = groupJellys.create(320, 630, "sh1")).frameName = "time_penalty";
        groupJellys.messPenalty.visible = !1
    },
    initLevel6: function() {
        this.initLevel5();
    ...
    initLevel17: function() {
        funcCurUpdate = null;
        bPauseTimer = !0;
        groupJellys.curJellyNum = 0;
        groupJellys.nWaitTimer = this.rnd.integerInRange(100, 300);
        var a = groupJellys.create(325, 800, "sh1");
        a.frameName = "orange_btn";
        a.anchor.setTo(0.5, 0.5);
        this.setButtonWithInputDown(a, this.onBtnColorClick, this.onBtnColorUp, this.onBtnColorUp);
        for (i = 0; 3 > i; i += 1) {
            var a = 1 == i ? "jelly_violet" : "jelly_green",
                b = this.createJelly(190 * i + 140, 600, i, a, !0, 0.75);
            b.anchor.setTo(0.5, 1);
            b.shadow.scale = b.scale.setTo(0.75, 0.75);
            b.shadow.y = b.y + 3;
            b.colorType = a;
            b.animations.play("idle", 24, !0)
        }
        jellys[0].shadow.scale = jellys[0].scale.setTo(1, 1);
        jellys[0].shadow.y = jellys[0].y + 4
    },
    initLevel18: function() {
        funcCurUpdate = null;
        bPauseTimer = !0;
        groupJellys.nHatsNum = 0;
        groupJellys.nWaitTimer = this.rnd.integerInRange(100, 300);
        groupJellys.nChangeTimer = 30;
        var a = groupJellys.create(325, 800, "sh1");
        a.frameName = "violet_btn";
        a.anchor.setTo(0.5, 0.5);
        this.setButtonWithInputDown(a, this.onBtnColorClick, this.onBtnColorUp, this.onBtnColorUp);
        a = this.createJelly(325, 500, 0, "jelly_color", !0);
        a.frameName = "jelly_violet";
        a.hats = groupJellys.create(208, 355, "hats");
        this.game.add.tween(a.hats).to({
            y: a.hats.y - 5
        }, 300, Phaser.Easing.Linear.In).to({
                y: a.hats.y + 5
            }, 300, Phaser.Easing.Linear.In).loop().start()
    },
    initLevel11: function(a) {
        a || (groupJellys.nTotalAnswers = 0, this.initYesNoButtonsWithQ());
        a = "";
        var b = this.rnd.integerInRange(0, arJellyColorTypes.length);
        for (a = arJellyColorTypes[b].substr(6) + "?"; groupJellys.strAnswer == a;) b = this.rnd.integerInRange(0, arJellyColorTypes.length), a = arJellyColorTypes[b].substr(6) + "?";
        groupJellys.strAnswer = a;
        this.createJelly(325, 520, 0, "jelly_color", !0).frameName = arJellyColorTypes[b];
        a = 0.6 < Math.random() ? a : arJellyColorTypes[this.rnd.integerInRange(0, arJellyColorTypes.length)].substr(6) + "?";
        groupJellys.textQ.setText(a);
        (groupJellys.messPenalty = groupJellys.create(320, 570, "sh1")).frameName = "time_penalty";
        groupJellys.messPenalty.visible = !1
    },
    initLevel12: function(a) {
        a || (groupJellys.nTotalAnswers = 0, this.initYesNoButtonsWithQ());
        var b = "";
        a = this.rnd.integerInRange(0, arJellyMorphAnimations.length);
        for (b = arJellyMorphAnimations[a] + "?"; groupJellys.strAnswer == b;) a = this.rnd.integerInRange(0, arJellyMorphAnimations.length), b = arJellyMorphAnimations[a] + "?";
        groupJellys.strAnswer = b;
        b = this.createJelly(195, 370, 0, "jelly", !0);
        b.anchor.setTo(0, 0);
        b.shadow.x = b.x + b.width / 2 + 20;
        b.shadow.y = b.y + b.height + 65;
        b.animations.play("morph_" + arJellyMorphAnimations[a], 24, !1);
        a = 0.6 < Math.random() ? groupJellys.strAnswer : arJellyMorphAnimations[this.rnd.integerInRange(0, arJellyMorphAnimations.length)] + "?";
        groupJellys.textQ.setText(a);
        (groupJellys.messPenalty = groupJellys.create(320, 570, "sh1")).frameName = "time_penalty";
        groupJellys.messPenalty.visible = !1
    },
    initYesNoButtonsWithQ: function() {
        var a = groupJellys.create(180, 800, "sh1");
        a.frameName = "yes_btn";
        a.type = "yes";
        a.anchor.setTo(0.5, 0.5);
        this.setButtonWithInputDown(a, this.onBtnYesNoClick, this.onBtnMouseOut);
        a = groupJellys.create(460, 800, "sh1");
        a.frameName = "no_btn";
        a.type = "no";
        a.anchor.setTo(0.5, 0.5);
        this.setButtonWithInputDown(a, this.onBtnYesNoClick, this.onBtnMouseOut);
        groupJellys.textQ = this.game.add.bitmapText(320, 330, "", {
            font: "80px JandaManateeSolid"
        });
        groupJellys.textQ.anchor.setTo(0.5, 0.5);
        groupJellys.add(groupJellys.textQ)
    },
    onBtnYesNoClick: function(a) {
        if (!(10 <= groupJellys.nTotalAnswers)) {
            bStarted || this.startLevel();
            this.game.saves.bSound && this.game.sndBlob.play();
            a.scale.setTo(1.1, 1.1);
            groupJellys.nTotalAnswers += 1;
            var b = !1;
            if (groupJellys.textQ.text != groupJellys.strAnswer && "yes" == a.type || groupJellys.textQ.text == groupJellys.strAnswer && "no" == a.type) b = !0;
            10 == groupJellys.nTotalAnswers ? this.winLevel() : (jellys[0].shadow.destroy(), jellys[0].destroy(), jellys.length = 0, this["initLevel" + nCurLevel](!0), b ? this.showTimePenalty() : this.showGreatMessage())
        }
    },
    initLevel14: function() {
        for (var a = groupJellys.numClicks = 0; 5 > a; a += 1) {
            var b = this.createJelly(2 > a ? -50 : 2 < a ? 550 : 200, 2 > a ? 350 * a + 480 : 2 < a ? 350 * (a - 3) + 480 : 400, a, "jelly");
            b.nCurAnimNum = this.rnd.integerInRange(0, 5);
            b.angle = b.shadow.angle = 2 > a ? 90 : 2 < a ? -90 : 0;
            b.animDirection = "normal";
            b.anchor.setTo(2 > a ? 1 : 0, 2 > a ? 1 : 2 < a ? 0.5 : 0);
            b.shadow.visible = 2 == a;
            2 == a && (b.shadow.x = b.x + b.width / 2 + 20, b.shadow.y = b.y + b.height + 65);
            b.animations.play("idle", 24, !0)
        }
    },
    initLevel16: function() {
        groupJellys.arLastJellys = [0, 1, 2, 3, 4];
        groupJellys.timeToNextGo = this.rnd.integerInRange(180, 360);
        groupJellys.isRunning = !1;
        bPauseTimer = !0;
        timePause = 0;
        funcCurUpdate = "updateLevel16";
        for (var a = 0; 5 > a; a += 1) {
            groupJellys.create(-10, 120 * a + 380, "sh1").frameName = "run_road";
            var b = this.createJelly(60, 120 * a + 350, a, "jelly_color", !1, 0.5);
            b.frameName = arJellyColorTypes[a];
            b.splash = groupJellys.create(60, 120 * a + 350, "jelly_splash");
            b.splash.anchor = b.splash.scale.setTo(0.5, 0.5);
            b.splash.animations.add("all");
            b.splash.visible = !1;
            b.animations.play("idle", 24, !0)
        }
    ...
    initLevel15: function() {
        for (var a = groupJellys.numClicks = 0; 6 > a; a += 1) {
            var b = this.createJelly(a % 3 * 205 + 120, 300 * Math.floor(a / 3) + 480, 0, "jelly_color");
            b.frame = a % 5;
            b.hats = groupJellys.create(b.x - 118, b.y - 145, "hats");
            b.hats.frame = a % 6;
            this.game.add.tween(b.hats).to({
                y: b.hats.y - 5
            }, 300, Phaser.Easing.Linear.In).to({
                    y: b.hats.y + 5
                }, 300, Phaser.Easing.Linear.In).loop().start()
    ...
    initLevel13: function() {
        groupJellys.numClicks = 0;
        groupJellys.numRespown = 5;
        for (var a = 0; 5 > a; a += 1) {
            var b = this.createJelly(120 * a + 80, 1050, a, arJellyColorTypes[a % 3], !1, 0.5);
            b.shadow.destroy();
            groupJellys.bringToTop(b);
            b.splash = groupJellys.create(b.x - 80, b.y - 90, "jelly_splash");
            b.splash.scale.setTo(0.5, 0.5);
            b.splash.animations.add("all");
            b.splash.visible = !1;
            var c = 200 * Math.random() + 200;
            this.game.add.tween(b).to({
                angle: 0
            }, c, Phaser.Easing.Linear.In).to({
                    angle: 180
                }, c, Phaser.Easing.Linear.In).loop().start();
            b.funcNewTween = this.level13CreateNewTween;
            this.level13CreateNewTween(b)
        }
    },
    level13CreateNewTween: function(a) {
        null != a.tweenMove && (a.tweenMove.stop(), a.tweenMove = null);
        if ("up" == a.direction) {
            a.direction = "down";
            var b = 650 / a.y * 200 + 300;
            a.tweenMove = this.game.add.tween(a).to({
                y: 1050
            }, b, Phaser.Easing.Cubic.In, !0, 0)
        } else {
            if (!1 == a.visible) if (0 < groupJellys.numRespown) a.visible = !0, groupJellys.numRespown -= 1;
            else return;
            var c = 350 * Math.random() + 300,
                b = 650 / c * 200 + 300,
                d = 200 * Math.random();
            a.direction = "up";
            a.tweenMove = this.game.add.tween(a).to({
                y: c
            }, b, Phaser.Easing.Cubic.Out, !0, d)
        }
        a.tweenMove.onComplete.add(a.funcNewTween, a)
    },
    updateLevel4: function() {
        400 <= groupJellys.jelly_boy.x && this.initLevel4();
        if (groupJellys.jelly_boy.y <= 700 - 150 * groupJellys.nCurPhase && !groupJellys.bFinish) this.showGreatMessage(), groupJellys.jelly_boy.y = 700 - 150 * groupJellys.nCurPhase, groupJellys.boy_platform.y = groupJellys.jelly_boy.y + 82, groupJellys.wheel.y = groupJellys.boy_platform.y + 28, bPauseTimer = groupJellys.bFinish = !0, timePause = this.game.time.now, groupJellys.nCurPhase += 1, this.game.add.tween(groupJellys.jelly_boy.shadow).to({
            x: groupJellys.jelly_boy.shadow.x + 80
        }, 490, Phaser.Easing.Linear.In, !0), this.game.add.tween(groupJellys.jelly_boy).to({
            x: groupJellys.jelly_boy.x + 80
        }, 500, Phaser.Easing.Linear.In, !0);
        else {
            if (!groupJellys.bFinish) {
                groupJellys.fVelocity = 30 > groupJellys.nLastClickDelay ? groupJellys.fVelocity : 60 < groupJellys.nLastClickDelay ? 0 : 0.6 * groupJellys.fVelocity;
                var a = groupJellys.fVelocity * (50 > this.game.time.fps ? 60 / this.game.time.fps : 1);
                groupJellys.jelly_boy.y -= a;
                groupJellys.jelly_boy.shadow.y -= a;
                groupJellys.boy_platform.y -= a;
                groupJellys.wheel.y -= a;
                groupJellys.wheel.angle += a
            }
            groupJellys.nLastClickDelay += Math.round(60 / this.game.time.fps)
        }
    },
    updateLevel18: function() {
        if (0 < groupJellys.nWaitTimer) if (groupJellys.nWaitTimer -= 50 > this.game.time.fps ? 60 / this.game.time.fps : 1, groupJellys.nChangeTimer -= 50 > this.game.time.fps ? 60 / this.game.time.fps : 1, 0 >= groupJellys.nWaitTimer) bPauseTimer = !1, textHelp.setText("RELEASE THE BUTTON NOW !!!"), jellys[0].hats.frame = 1, timeStart = 0 == groupJellys.nHatsNum ? this.game.time.now : timeStart + (this.game.time.now - timePause);
        else if (0 >= groupJellys.nChangeTimer) {
            for (var a = this.rnd.integerInRange(0, 6); 1 == a || a == jellys[0].hats.frame;) a = this.rnd.integerInRange(0, 6);
            jellys[0].hats.frame = a;
            groupJellys.nChangeTimer = 30
        }
    },
    updateLevel16: function() {
        !0 == groupJellys.bLose && (strLevelTime = " TOO LATE", this.looseLevel());
        if (!groupJellys.isRunning && (groupJellys.timeToNextGo -= 50 > this.game.time.fps ? 60 / this.game.time.fps : 1, 0 >= groupJellys.timeToNextGo)) {
            bPauseTimer = !1;
            timeStart = 5 > groupJellys.arLastJellys.length ? timeStart + (this.game.time.now - timePause) : this.game.time.now;
            timePause = 0;
            var a = this.rnd.integerInRange(0, groupJellys.arLastJellys.length),
                b = groupJellys.arLastJellys[a];
            groupJellys.arLastJellys.splice(a, 1);
            a = Math.round(1800 - 500 * Math.random());
            jellys[b].shadow.tweenMove = this.game.add.tween(jellys[b].shadow).to({
                x: 700
            }, a, Phaser.Easing.Linear.In, !0);
            jellys[b].tweenMove = this.game.add.tween(jellys[b]).to({
                x: 700
            }, a, Phaser.Easing.Linear.In, !0);
            jellys[b].tweenMove.onComplete.add(function() {
                groupJellys.bLose = !0
            }, this);
            groupJellys.isRunning = !0;
            textHelp.setText("CATCH !!!")
        }
    },
    updateLevel17: function() {
        if (0 < groupJellys.nWaitTimer && (groupJellys.nWaitTimer -= 50 > this.game.time.fps ? 60 / this.game.time.fps : 1, 0 >= groupJellys.nWaitTimer)) {
            bPauseTimer = !1;
            textHelp.setText("RELEASE THE BUTTON NOW !!!");
            timeStart = 0 == groupJellys.curJellyNum ? this.game.time.now : timeStart + (this.game.time.now - timePause);
            var a = this.createJelly(190 * groupJellys.curJellyNum + 140, 600, 0, "jelly_orange", !0);
            a.anchor.setTo(0.5, 1);
            a.shadow.y = a.y + 4;
            a.colorType = "jelly_orange";
            a.animations.play("idle", 24, !0);
            jellys[groupJellys.curJellyNum].shadow.destroy();
            jellys[groupJellys.curJellyNum].destroy();
            jellys[groupJellys.curJellyNum] = a
        }
    },
    winLevel: function() {
        bPause = !0;
        bStarted = !1;
        for (var a = 0; a < jellys.length; a += 1) jellys[a].animations.stop();
        this.game.tweens.removeAll();
        this.game.add.tween(groupJellys).to({
            alpha: 1
        }, 300, Phaser.Easing.Linear.In, !0).onComplete.add(this.showFinishMenu, this)
    },
    looseLevel: function() {
        bPause = !0;
        groupJellys.visible = !1;
        this.showFinishMenu("loose")
    },
    createJelly: function(a, b, c, d, h, g) {
        null == g && (g = 1);
        var e = groupJellys.create(a, b, "sh1");
        e.frameName = "jelly_shadow";
        e.anchor.setTo(0.5, 0.5);
        a = groupJellys.create(a, b, d);
        a.anchor.setTo(0.5, 0.5);
        a.scale.setTo(g, g);
        a.shadow = e;
        a.shadow.scale.setTo(g, g);
        a.shadow.y += a.height / 2 + 5;
        a.index = c;
        a.numClicks = 0;
        "jelly" == d ? (a.animations.add("idle", Phaser.Animation.generateFrameNames("jelly", 0, 16, "", 4), 24, !0), a.animations.add("morph_all", Phaser.Animation.generateFrameNames("jelly", 28, 95, "", 4), 24, !0), a.animations.add("morph_bear", Phaser.Animation.generateFrameNames("jelly", 28, 42, "", 4), 24, !0), a.animations.add("morph_bear_back", Phaser.Animation.generateFrameNames("jelly", 42, 27, "", 4), 24, !0), a.animations.add("morph_cactus", Phaser.Animation.generateFrameNames("jelly", 43, 55, "", 4), 24, !0), a.animations.add("morph_cactus_back", Phaser.Animation.generateFrameNames("jelly", 55, 43, "", 4), 24, !0), a.animations.add("morph_cow", Phaser.Animation.generateFrameNames("jelly", 56, 70, "", 4), 24, !0), a.animations.add("morph_cow_back", Phaser.Animation.generateFrameNames("jelly", 70, 56, "", 4), 24, !0), a.animations.add("morph_teapot", Phaser.Animation.generateFrameNames("jelly", 71, 79, "", 4), 24, !0), a.animations.add("morph_teapot_back", Phaser.Animation.generateFrameNames("jelly", 79, 71, "", 4), 24, !0), a.animations.add("morph_star", Phaser.Animation.generateFrameNames("jelly", 80, 95, "", 4), 24, !0), a.animations.add("morph_star_back", Phaser.Animation.generateFrameNames("jelly", 95, 80, "", 4), 24, !0)) : "jelly_color" == d ? (a.tween1 = this.game.add.tween(a.scale).to({
            y: 1.1 * g
        }, 300, Phaser.Easing.Linear.In).to({
                y: g
            }, 300, Phaser.Easing.Linear.In).loop().start(), a.tween2 = this.game.add.tween(a).to({
            y: a.y - 5
        }, 300, Phaser.Easing.Linear.In).to({
                y: a.y + 5
            }, 300, Phaser.Easing.Linear.In).loop().start()) : "sh1" != d && a.animations.add("idle", Phaser.Animation.generateFrameNames("jelly", 0, 16, "", 4), 24, !0);
        !0 != h && (a.inputEnabled = !0, a.input.useHandCursor = !0, a.events.onInputDown.add(this.onJellyClick, this));
        jellys.push(a);
        return a
    },
    onJellyClick: function(a) {
        if (!bPause) {
            switch (nCurLevel) {
                case 1:
                    if (5 <= a.numClicks) return;
                    this.game.saves.bSound && this.game.sndBlob.play();
                    a.numClicks += 1;
                    a.scale.setTo(1.1, 1.1);
                    groupJellys.numClicks += 1;
                    a.textCounter.setText("" + a.numClicks);
                    groupJellys.numClicks >= 5 * groupJellys.nPhaseNum && (3 == groupJellys.nPhaseNum ? this.winLevel() : (this.initLevel1(!0), this.showGreatMessage()));
                    break;
                case 2:
                    12 > a.numClicks && (this.game.saves.bSound && this.game.sndBlob.play(), a.numClicks += 1, a.shadow.scale = a.scale.setTo(0.4 + 0.05 * a.numClicks, 0.4 + 0.05 * a.numClicks), 12 == a.numClicks && (a.alpha = 0.7, this.showGreatMessage()), 1 <= jellys[0].scale.x && 1 <= jellys[1].scale.x && 1 <= jellys[2].scale.x && this.winLevel());
                    break;
                case 3:
                    this.game.saves.bSound && this.game.sndBlob.play();
                    a.shadow.destroy();
                    a.destroy();
                    groupJellys.nNumClicks += 1;
                    if (groupJellys.nNumClicks >= groupJellys.nPhaseNum * groupJellys.nPhaseNum) this["initLevel" + nCurLevel](!0);
                    break;
                case 5:
                    if (0.2 > a.alpha) return;
                    this.game.saves.bSound && this.game.sndBlob.play();
                    groupJellys.numClicks += 1;
                    this.showGreatMessage();
                    a.visible = a.shadow.visible = !1;
                    a.splash.x = a.x;
                    a.splash.y = a.y;
                    a.splash.visible = !0;
                    a.splash.animations.play("all", 24, !1);
                    a.splash.events.onAnimationComplete.add(function() {
                        this.visible = this.shadow.visible = !0;
                        this.splash.visible = !1
                    }, a);
                    20 <= groupJellys.numClicks && this.winLevel();
                    break;
                case 6:
                    if (0.2 > a.alpha) return;
                    2 != a.hats.frame ? (this.game.saves.bSound && this.game.sndBlob.play(), groupJellys.numClicks += 1, this.showGreatMessage()) : this.showTimePenalty();
                    a.visible = a.shadow.visible = a.hats.visible = !1;
                    a.splash.x = a.x;
                    a.splash.y = a.y;
                    a.splash.visible = !0;
                    a.splash.animations.play("all", 24, !1);
                    a.splash.events.onAnimationComplete.add(function() {
                        this.visible = this.hats.visible = this.shadow.visible = !0;
                        this.splash.visible = !1
                    }, a);
                    20 <= groupJellys.numClicks && this.winLevel();
                    break;
                case 7:
                    var b = !1;
                    this.game.saves.bSound && this.game.sndBlob.play();
                    null == groupJellys.selectedJelly ? (a.alpha = 0.5, groupJellys.selectedJelly = a) : a.frame == groupJellys.selectedJelly.frame && a.hats.frame == groupJellys.selectedJelly.hats.frame ? a == groupJellys.selectedJelly ? (groupJellys.selectedJelly.alpha = 1, groupJellys.selectedJelly = null) : (a.alpha = 0.5, groupJellys.numClicks += 1, this.showGreatMessage(), 10 <= groupJellys.numClicks ? this.winLevel() : b = !0) : (groupJellys.selectedJelly.alpha = 1, groupJellys.selectedJelly = null, this.showTimePenalty());
                    b && this.initLevel7(!0);
                    break;
                case 13:
                    groupJellys.numClicks += 1;
                    ...
                    10 <= groupJellys.numClicks && this.winLevel();
                    break;
                case 14:
                    b = !1;
                    this.game.saves.bSound && this.game.sndBlob.play();
                    if (50 < a.currentFrame.index && 56 > a.currentFrame.index) {
                        groupJellys.numClicks += 1;
                        this.showGreatMessage();
                        if (10 <= groupJellys.numClicks) {
                            this.winLevel();
                            return
                        }
                        b = !0
                    }
                    if (!bStarted || b) for (b = this.rnd.integerInRange(0, 5), a = 0; 5 > a; a += 1) {
                        if (a == b) jellys[a].nCurAnimNum = 1;
                        else for (jellys[a].nCurAnimNum = this.rnd.integerInRange(0, 5); 1 == jellys[a].nCurAnimNum;) jellys[a].nCurAnimNum = this.rnd.integerInRange(0, 5);
                        jellys[a].animations.play("morph_" + arJellyMorphAnimations[jellys[a].nCurAnimNum], 24, !1)
                    }
                    break;
                case 15:
                    b = !1;
                    this.game.saves.bSound && this.game.sndBlob.play();
                    bStarted ? 0 == a.frame && 0 == a.hats.frame ? (groupJellys.numClicks += 1, this.showGreatMessage(), 10 <= groupJellys.numClicks ? this.winLevel() : b = !0) : this.showTimePenalty() : b = !0;
                    if (b) {
                        var b = [0, 1, 2, 3, 4, 5],
                            c;
                        for (a = 0; 6 > a; a += 1) c = this.game.rnd.integerInRange(0, b.length), jellys[b[c]].frame = 3 > a ? 0 : this.game.rnd.integerInRange(2, 5), jellys[b[c]].hats.frame = 0 == a || 3 == a ? 0 : this.game.rnd.integerInRange(1, 6), b.splice(c, 1)
                    }
                    break;
                case 16:
                    bStarted || textHelp.setText("Now wait..."), null != a.tweenMove && (textHelp.setText("Now wait..."), bPauseTimer = !0, timePause = this.game.time.now, this.game.tweens.remove(a.tweenMove), this.game.tweens.remove(a.shadow.tweenMove), a.splash.x = a.x, a.splash.y = a.y, a.visible = a.shadow.visible = !1, a.splash.visible = !0, a.splash.animations.play("all", 24, !1, !0), this.showGreatMessage(), 0 == groupJellys.arLastJellys.length ? this.winLevel() : (groupJellys.timeToNextGo = this.rnd.integerInRange(180, 360), groupJellys.isRunning = !1), this.game.saves.bSound && this.game.sndBlob.play())
            }
            bStarted || this.startLevel()
        }
    },
    showGreatMessage: function() {
        if (null != groupJellys.messGreat.tweenMove2) {
            if (groupJellys.messGreat.tweenMove1.isRunning || groupJellys.messGreat.tweenMove2.isRunning) return;
            groupJellys.messGreat.tweenMove1.stop();
            groupJellys.messGreat.tweenMove2.stop();
            groupJellys.messGreat.tweenMove1 = groupJellys.messGreat.tweenMove2 = null
        }
        this.game.saves.bSound && this.game.sndCool.play();
        groupJellys.bringToTop(groupJellys.messGreat);
        groupJellys.messGreat.frameName = 0.75 < Math.random() ? "okay" : 0.75 < Math.random() ? "cool" : 0.75 < Math.random() ? "great" : "awesome";
        groupJellys.messGreat.visible = !0;
        groupJellys.messGreat.y = -100;
        groupJellys.messGreat.x = 320;
        groupJellys.messGreat.scale.setTo(3, 3);
        groupJellys.messGreat.tweenMove1 = this.game.add.tween(groupJellys.messGreat).to({
            y: 230
        }, 300, Phaser.Easing.Linear.In, !0);
        this.game.add.tween(groupJellys.messGreat.scale).to({
            x: 1,
            y: 1
        }, 300, Phaser.Easing.Linear.In, !0);
        groupJellys.messGreat.tweenMove2 = this.game.add.tween(groupJellys.messGreat).to({
            x: 700
        }, 300, Phaser.Easing.Linear.In, !0, 1500);
        groupJellys.messGreat.tweenMove2.onComplete.add(function() {
            this.visible = !1
        }, groupJellys.messGreat)
    },
    showTimePenalty: function() {
        timeStart -= 3E3;
        this.game.saves.bSound && this.game.sndError.play();
        null != groupJellys.messPenalty.tweenMove && (groupJellys.messPenalty.tweenMove.stop(), groupJellys.messPenalty.tweenMove = null);
        groupJellys.bringToTop(groupJellys.messPenalty);
        groupJellys.messPenalty.visible = !0;
        groupJellys.messPenalty.alpha = 1;
        groupJellys.messPenalty.anchor.setTo(0.5, 0.5);
        groupJellys.messPenalty.scale.setTo(0, 0);
        this.game.add.tween(groupJellys.messPenalty.scale).to({
            x: 1,
            y: 1
        }, 300, Phaser.Easing.Bounce.Out, !0);
        groupJellys.messPenalty.tweenMove = this.game.add.tween(groupJellys.messPenalty).to({
            alpha: 0
        }, 300, Phaser.Easing.Linear.In, !0, 1300);
        groupJellys.messPenalty.tweenMove.onComplete.add(function() {
            this.visible = !1
        }, groupJellys.messPenalty)
    },
    startLevel: function() {
        bPause || null != groupTutorial && 0 < groupTutorial.alpha || bStarted || (bStarted = !0, timeStart = this.game.time.now, this.game.input.onUp.removeAll(), 16 > nCurLevel && textHelp.setText(""))
    },
    clearLevel: function() {
        this.game.tweens.removeAll();
        removeGroup(groupJellys);
        jellys.length = 0;
        null != groupTutorial && (removeGroup(groupTutorial), groupTutorial = null)
    },
    initLevelGUI: function() {
        funcCurUpdate = null;
        bStarted = bPauseTimer = !1;
        timePause = fLevelTimeSec = 0;
        jellys.length = 0;
        groupJellys = this.game.add.group();
        (this.btnPause = groupJellys.create(10, 10, "sh1")).frameName = "pause_btn";
        this.setButtonWithInputDown(this.btnPause, this.onBtnPauseClick);
        var a = groupJellys.create(455, 67, "spilLogo");
        a.scale.setTo(0.8, 0.8);
        this.setButtonWithInputDown(a, this.onBtnSponsorClick, null, !1);
        (this.btnFastRestart = groupJellys.create(560, 10, "sh1")).frameName = "fast_restart_btn";
        this.setButtonWithInputDown(this.btnFastRestart, this.onBtnFastRestartClick);
        this["initLevel" + nCurLevel]();
        (groupJellys.messGreat = groupJellys.create(320, -100, "sh1")).frameName = "great";
        groupJellys.messGreat.anchor.setTo(0.5, 0.5);
        groupJellys.messGreat.visible = !1;
        textHelp = this.game.add.bitmapText(320, 210, this.arHelpStrings[nCurLevel - 1], text_style_timer);
        textHelp.anchor.setTo(0.5, 0.5);
        groupJellys.add(textHelp);
        a = this.game.add.bitmapText(320, 40, "Level - " + nCurLevel, text_style_timer);
        a.anchor.setTo(0.5, 0.5);
        groupJellys.add(a);
        textInfo = this.game.add.bitmapText(210, 70, "TIME: 00.00", text_style_timer);
        groupJellys.add(textInfo);
        groupJellys.visible = !1;
        groupTutorial = this.game.add.group();
        groupTutorial.create(40, 200, "tutor_bg");
        a = groupTutorial.create(58, 430, "tutors");
        a.anchor.setTo(0, 0.5);
        a.frame = nCurLevel - 1;
        a = groupTutorial.create(240, 30, "spilLogo");
        this.setButtonWithInputDown(a, this.onBtnSponsorClick);
        a = groupTutorial.create(240, 640, "sh1");
        a.frameName = "ok_btn";
        this.setButtonWithInputDown(a, this.onBtnTutorOkClick);
        groupTutorial.alpha = 0;
        this.game.add.tween(groupTutorial).to({
            alpha: 1
        }, 500, Phaser.Easing.Linear.In, !0)
    },
    onBtnTutorOkClick: function() {
        this.game.saves.bSound && this.game.sndClick.play();
        groupJellys.visible = !0;
        groupTutorial.getAt(groupTutorial.total - 1).events.onInputDown.removeAll();
        groupJellys.alpha = 0;
        this.game.add.tween(groupJellys).to({
            alpha: 1
        }, 500, Phaser.Easing.Linear.In, !0);
        groupTutorial.alpha = 1;
        this.game.add.tween(groupTutorial).to({
            alpha: 0
        }, 500, Phaser.Easing.Linear.In, !0).onComplete.add(function() {
                removeGroup(groupTutorial);
                groupTutorial = null
            }, this)
    },
    onBtnPauseClick: function() {
        ...
        bPause = !0;
        groupJellys.visible = !1;
        timeGlobalPause = this.game.time.now;
        this.game.tweens.pauseAll();
        this.showFinishMenu("pause")
    },
    onBtnFastRestartClick: function() {
        this.game.saves.bSound && this.game.sndClick.play();
        groupJellys.visible = !1;
        this.clearLevel();
        this.initLevelGUI();
    ...
    showFinishMenu: function(a) {
        groupFinishMenu = this.game.add.group();
        groupFinishMenu.create(0, 0, "bg2").scale.setTo(2, 2);
        groupFinishMenu.strState = a;
        var b = 0,
            c = 0;
        if ("pause" == a) groupFinishMenu.create(60, 250, "sh1").frameName = "pause_level", b = 30, c = -200, a = groupFinishMenu.create(240, 1100, "sh1"), a.frameName = "play_btn", this.setButtonWithInputDown(a, this.onBtnPlayClick), this.game.add.tween(a).to({
            y: 660 + c / 4
        }, 500, Phaser.Easing.Back.Out, !0, 200);
        else if ("loose" == a) {
            groupFinishMenu.create(85, 150, "sh1").frameName = "loose_level";
            b = 50;
            groupFinishMenu.add(this.game.add.bitmapText(215, 600, strLevelTime, text_style_timer));
            for (a = 0; 3 > a; a += 1) groupFinishMenu.add(this.game.add.bitmapText(185 + 120 * a, 1 == a ? 525 : 564, this.arLevelTimes[a][nCurLevel - 1] + "s", {
                font: "40px JandaManateeSolid",
                align: "center"
            }));
            this.game.saves.bSound && this.game.sndLoose.play()
        } else groupFinishMenu.strState = "finish";
        if ("finish" == groupFinishMenu.strState) {
            console.log(nCurLevel);
            updateShareScore(nCurLevel);
            this.arLevelTimes[0][nCurLevel - 1] > fLevelTimeSec ? ((groupFinishMenu.finishJelly = groupFinishMenu.create(105, -350, "sh1")).frameName = "finished_jelly", groupFinishMenu.create(85, 150, "sh1").frameName = "finish_level", groupFinishMenu.add(this.game.add.bitmapText(185, 600, "TIME: " + strLevelTime + " sec ", text_style_timer)), 18 > nCurLevel ? ((a = groupFinishMenu.create(240, 1100, "sh1")).frameName = "play_btn", this.setButtonWithInputDown(a, this.onBtnPlayClick), this.game.add.tween(a).to({
                y: 660 + c / 4
            }, 500, Phaser.Easing.Back.Out, !0, 200)) : b = 50, this.game.saves.bSound && this.game.sndWin.play()) : (groupFinishMenu.create(85, 150, "sh1").frameName = "loose_level", groupFinishMenu.add(this.game.add.bitmapText(185, 600, "TIME: " + strLevelTime + " sec ", text_style_timer)), b = 50, this.game.saves.bSound && this.game.sndLoose.play());
            var d = 0;
            for (a = 0; 3 > a; a += 1) if (groupFinishMenu.add(this.game.add.bitmapText(185 + 120 * a, 1 == a ? 525 : 564, this.arLevelTimes[a][nCurLevel - 1] + "s", {
                font: "40px JandaManateeSolid",
                align: "center"
            })), "finish" == groupFinishMenu.strState && this.arLevelTimes[a][nCurLevel - 1] >= fLevelTimeSec) {
                var h = groupFinishMenu.create(113 * a + (2 == a ? 170 : 160), 1 == a ? 419 : 459, "sh1");
                h.frameName = "big_star";
                h.alpha = 0;
                this.game.add.tween(h).to({
                    alpha: 1
                }, 300, Phaser.Easing.Linear.In, !0, 300 * a + 500);
                d += 1
            }
            a = this.game.saves.stars;
            var g = Number(a.substr(nCurLevel - 1, 1)),
                e = 0 == Number(a.substr(nCurLevel, 1)) && 0 < d ? "9" : a.substr(nCurLevel, 1),
                h = !1;
            if (0 < d && 9 == g || d > g) {
                this.game.saves.stars = a.substring(0, nCurLevel - 1) + d + "" + e + a.substring(nCurLevel + 1);
                this.game.saves.saveData();
                var f = this.game.saves.stars,
                    d = "0" != f[5] && "9" != f[5] && "0" != f[6] && "9" != f[6] && "0" != f[14] && "9" != f[14] && "0" != f[17] && "9" != f[17] ? "1" : "0",
                    g = "0";
                for (a = e = 0; 18 > a; a += 1) if ("3" == f[a] && (e += 1, 3 <= e)) {
                    g = "1";
                    break
                }
                var e = "3" == f[3] ? "1" : "0",
                    k = ("0" != f[5] && "9" != f[5] ? "1" : "0") + ("0" != f[11] && "9" != f[11] ? "1" : "0") + ("0" != f[17] && "9" != f[17] ? "1" : "0"),
                    l = "1";
                for (a = 0; 18 > a; a += 1) if ("3" != f[a]) {
                    l = "0";
                    break
                }
                var f = 0,
                    n = this.game.saves.trophies,
                    p = "tr_jellypad tr_mistersir tr_cubie tr_hearts tr_coolfinger tr_coolmatcher tr_cooltimer tr_starmaster".split(" "),
                    q = [d, g, e, k[0], k[1], k[2], l],
                    m = "";
                for (a = 1; 8 > a; a += 1)"0" == n[a] && "1" == q[a - 1] && (m = p[a], f = a);
                0 < f ? (a = groupFinishMenu.create(320, 360, "sh1"), a.frameName = "trophy_sun", a.anchor.setTo(0.5, 0.5), a.scale.setTo(0, 0), this.game.add.tween(a.scale).to({
                    x: 1,
                    y: 1
                }, 500, Phaser.Easing.Back.Out, !0, 1E3).to({
                        x: 0,
                        y: 0
                    }, 500, Phaser.Easing.Linear.In, !0, 2E3), a.angle = 180, this.game.add.tween(a).to({
                    angle: 0
                }, 2E3, Phaser.Easing.Linear.In).to({
                        angle: 180
                    }, 2E3, Phaser.Easing.Linear.In).loop().start(), a = groupFinishMenu.create(320, 360, "sh1"), a.frameName = "trophy_unlocked", a.anchor.setTo(0.5, 0.5), a.scale.setTo(0, 0), this.game.add.tween(a.scale).to({
                    x: 1,
                    y: 1
                }, 500, Phaser.Easing.Back.Out, !0, 1E3).to({
                        x: 0,
                        y: 0
                    }, 500, Phaser.Easing.Linear.In, !0, 2E3), a = groupFinishMenu.create(320, 360, "sh2"), a.frameName = m, a.anchor.setTo(0.5, 0.5), a.scale.setTo(0, 0), this.game.add.tween(a.scale).to({
                    x: 1,
                    y: 1
                }, 500, Phaser.Easing.Back.Out, !0, 1E3).to({
                        x: 0,
                        y: 0
                    }, 500, Phaser.Easing.Linear.In, !0, 2E3), h = !0, a = groupFinishMenu.create(417 - b, 1100, "sh1"), a.frameName = "trophies_btn", a.scale.setTo(0.92, 0.92), this.game.nShowTrophies = f, this.setButtonWithInputDown(a, this.onBtnMenuClick, null, !1), this.game.add.tween(a).to({
                    y: 660
                }, 500, Phaser.Easing.Back.Out, !0, 300), this.game.add.tween(groupFinishMenu.finishJelly).to({
                    y: 150
                }, 500, Phaser.Easing.Back.Out, !0, 200).to({
                        y: 380
                    }, 500, Phaser.Easing.Linear.In, !0).to({
                        y: 150
                    }, 500, Phaser.Easing.Linear.In, !0, 2500), this.game.saves.bSound && this.game.sndCool.play()) : this.game.add.tween(groupFinishMenu.finishJelly).to({
                    y: 150
                }, 500, Phaser.Easing.Back.Out, !0, 200);
                this.game.saves.trophies = this.game.saves.trophies[0] + d + g + e + k + l;
                this.game.saves.saveTrophies()
            } else this.game.add.tween(groupFinishMenu.finishJelly).to({
                y: 150
            }, 500, Phaser.Easing.Back.Out, !0, 200);
            this.clearLevel()
        }(a = groupFinishMenu.create(85 + b, 1100, "sh1")).frameName = "restart_btn";
        this.setButtonWithInputDown(a, this.onBtnRestartClick);
        this.game.add.tween(a).to({
            y: 660 + c
        }, 500, Phaser.Easing.Back.Out, !0, 100);
        h || (this.game.nShowTrophies = null, (a = groupFinishMenu.create(415 - b, 1100, "sh1")).frameName = "menu_btn", this.setButtonWithInputDown(a, this.onBtnMenuClick), this.game.add.tween(a).to({
            y: 660 + c
        }, 500, Phaser.Easing.Back.Out, !0, 300));
        this.createSoundBtn(groupFinishMenu);
        a = groupFinishMenu.create(20, 20, "spilLogo");
        this.setButtonWithInputDown(a, this.onBtnSponsorClick);
        a = groupFinishMenu.create(215, 1120, "moregames_btn");
        this.setButtonWithInputDown(a, this.onBtnSponsorClick);
        this.game.add.tween(a).to({
            y: 850 + c / 5
        }, 500, Phaser.Easing.Back.Out, !0, 300);
        groupFinishMenu.alpha = 0;
        this.game.add.tween(groupFinishMenu).to({
            alpha: 1
        }, 500, Phaser.Easing.Linear.In, !0);
        "finish" == groupFinishMenu.strState && GameAPI.GameBreak.request(spilRequestPauseFunc, spilRequestUnPauseFunc)
    },
    onBtnPlayClick: function() {
        1 > groupFinishMenu.alpha || (this.game.saves.bSound && this.game.sndClick.play(), "pause" != groupFinishMenu.strState ? nCurLevel += 1 : groupJellys.visible = !0, this.game.add.tween(groupFinishMenu).to({
            alpha: 0
        }, 500, Phaser.Easing.Linear.In, !0).onComplete.add(this.hideMenu, this))
    },
    onBtnRestartClick: function() {
        1 > groupFinishMenu.alpha || (this.game.saves.bSound && this.game.sndClick.play(), "pause" == groupFinishMenu.strState && (this.clearLevel(), groupFinishMenu.strState = "restart"), this.game.add.tween(groupFinishMenu).to({
            alpha: 0
        }, 500, Phaser.Easing.Linear.In, !0).onComplete.add(this.hideMenu, this))
    },
    hideMenu: function() {
        removeGroup(groupFinishMenu);
        bPause = !1;
        "pause" == groupFinishMenu.strState ? (bStarted && 17 != nCurLevel && 18 != nCurLevel && 4 != nCurLevel && 16 != nCurLevel && (timeStart += this.game.time.now - timeGlobalPause), bStarted && 16 == nCurLevel && groupJellys.isRunning && (timeStart += this.game.time.now - timeGlobalPause), timeGlobalPause = 0, this.game.tweens.resumeAll()) : 19 > nCurLevel ? this.initLevelGUI() : (this.background.destroy(), this.game.state.start("MainMenu"))
    },
    updateTimer: function() {
        if (!bPauseTimer) {
            var a = 0,
                b = 0,
                c = this.game.time.now - timeStart,
                b = Math.floor(c / 1E3) % 60,
                a = Math.floor(c) % 1E3;
            fLevelTimeSec = c / 1E3;
            10 > a ? a = "00" + a : 100 > a && (a = "0" + a);
            10 > b && (b = "0" + b);
            strLevelTime = b + "." + (a + "").substr(0, 2);
            textInfo.setText("TIME: " + strLevelTime);
            30 <= b && (strLevelTime = " TOO LATE", this.looseLevel())
        }
    },
    update: function() {
        if (!bPause && bStarted && (this.updateTimer(), null != funcCurUpdate)) this[funcCurUpdate]()
    },
    onBtnMenuClick: function() {
        1 > groupFinishMenu.alpha || (this.game.saves.bSound && this.game.sndClick.play(), "pause" == groupFinishMenu.strState && this.clearLevel(), removeGroup(groupFinishMenu), this.background.destroy(), this.game.state.start("MainMenu"))
    },
    setButtonWithInputDown: function(a, b, c, d) {
        a.inputEnabled = !0;
        a.input.useHandCursor = !0;
        a.events.onInputDown.add(b, this);
        null != c && a.events.onInputUp.add(c, this);
        null != d && !1 != d ? a.events.onInputOut.add(d, this) : !1 != d && a.events.onInputOut.add(this.onBtnMouseOut, this)
    },
    onBtnMouseOut: function(a) {
        a.scale.setTo(1, 1)
    },
    createSoundBtn: function(a) {
        this.game.device.wav ? (a = a.create(590, 54, "sh1"), a.frameName = "sound_btn", this.setButtonWithInputDown(a, this.onBtnSoundClick, this.onBtnMouseOut), a.anchor.setTo(0.5, 0.5), a.alpha = this.game.saves.bSound ? 1 : 0.5) : this.game.saves.bSound = !1
    },
    onBtnSoundClick: function(a) {
        this.game.device.wav ? (this.game.saves.bSound = !this.game.saves.bSound, a.alpha = this.game.saves.bSound ? 1 : 0.5, a.scale.setTo(1.1, 1.1), this.game.saves.bSound && this.game.sndClick.play(), this.game.saves.saveSound()) : (a.alpha = 0.5, this.game.saves.bSound = !1)
    },
    onBtnSponsorClick: function() {
        window.open("http://a10.com", "_blank")
    }
};
var jellys = [],
    timeStart = 0,
    ...
    fLevelTimeSec = 0,
    strLevelTime = "00.00",
    textHelp, textInfo, nCurLevel = 1,
    bStarted = !1,
    bPause = !1,
    bPauseTimer = !1,
    funcCurUpdate = null,
    text_style_timer, groupJellys, groupFinishMenu, groupTutorial, bShowAds = !1,
    arJellyMorphAnimations = ["bear", "cactus", "cow", "teapot", "star"],
    arJellyColorTypes = ["jelly_green", "jelly_orange", "jelly_violet", "jelly_blue", "jelly_yellow"];

function spilRequestPauseFunc() {
    bShowAds = !0;
    trace("pause")
}

function spilRequestUnPauseFunc() {
    bShowAds = !1;
    trace("unpause")
}
function trace(a) {
...
function removeGroup(a) {
    for (var b = 0; b < a.length; b += 1) try {
        a.getAt(b).destroy(), b -= 1
    } catch (c) {
        trace("destroy error")
    }
    a.destroy()
