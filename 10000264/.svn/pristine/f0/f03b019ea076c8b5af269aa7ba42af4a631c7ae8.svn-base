...
(function(t) {
    ...
    function p(t, n, r, o, a) {
        this.version = "0.9.8", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new t({
            isMaster: !0
    ...
    (function(t) {
        ...
        }, p.Promise = h, p.promise = h, h.race = f, h.all = O, h.reject = A, h.resolve = p, p.passByCopy = function(t) {
            return t
