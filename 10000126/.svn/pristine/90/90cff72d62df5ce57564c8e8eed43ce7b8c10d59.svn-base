...
(function(t) {
	...
	var p; (function(t) {
		...
		function f(t) {
			return h(function(e, n) {
				for (var i = 0,
				r = t.length; r > i; i++) l(t[i]).then(e, n)
			})
		}
		function d(t, e, n) {
		...
		l.allResolved = c(x, "allResolved", "allSettled"),
		...
		l.nsend = l.nmcall = l.ninvoke = function(t, e) {
			...
			i = p();
			return n.push(i.makeNodeResolver()),
			l(t).dispatch("post", [e, n]).fail(i.reject),
			i.promise
		},
	...
	l.prototype.loadAPI = function(t, e) {
		...
		function(t) {
			a.__.dataStore._setCache(i(t)),
			n(t)
		})) : this.IS_MASTER ? d.getGameConfig().then(function(t) {
			d.getBrandingConfig(t).then(function(e) {
				t && !t.isError && (t.branding = e.branding, a.__.dataStore._setCache(i(t))),
				n(t)
			})
		}) : o(), void 0)
	};
