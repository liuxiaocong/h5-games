...
function IsPC() {
    for (var a = navigator.userAgent,
             b = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod"], c = !0, d = 0; d < b.length; d++) if (a.indexOf(b[d]) > 0) {
        c = !1;
        break
    }
    return c
...
var buzz = {
    ...
    game = function(a) {
        this.over_t = 0,
            ...
            this.st = 0,
            this.t = 0,
            true ? (gameEnter.style.width = "320px", this.pos_y = a.height, this.p_x = 1) : (this.p_x = this.c.width / document.documentElement.clientWidth, this.pos_y = document.documentElement.clientHeight * this.p_x, a.height = this.pos_y),
            this._x = 230,
            this._y = 440,
            this.easyGameList = [],
...
game.prototype.addEventListener = function(a) {
    ...
    game.prototype.gameover = function() {
        ...
        a.to({
            ...
            30, "Bounce", "easeOut", 0);
        var b = this.createrBtn(Attack.imgDx[22], -160, this.pos_y - 90, 0);
        b.update = function() {
            this.ct++,
        ...
        h.to({
            ...
            function() {
                h.update = function() {
                    ...
                    if(window.gameScore<this.n)
                    {
                        window.gameScore = this.n;
                    }else
                    {
                        if(!window.onceLock)
                        {
                            updateShareScore(window.gameScore);
                            window.onceLock = true;
                        }
                    }
                }
            }),
...
game.prototype.ts = function(a) {
    ...
    game.prototype.start = function() {
        this.mub_list = [null, null, null, null, null, null, null, null, null],
            this.all_mub = "000000000",
            this.player = new plane(160, 600, 66, 51, Attack.imgDx[63], 2);
        var a = new stage(0, "STAGE 2", 2, 570, Attack.imgDx[32]);
        a.sT = function() {
            stage2(this.t)
        };
