...
Game9G.prototype.init = function() {
	...
	this.homeurl = this.baseurl + "/gototop.html" + (this.spid ? "?spid=" + this.spid : "");
	...
	this.shareData.imgurl = "http://game.9g.com/" + this.gameid + "/icon.png";
	this.shareData.link = "http://" + parseInt(Math.random()*100000) + "." + this.gameid + "." + this.shareDomain + "/gamecenter.html?gameid=" + this.gameid + (this.spid ? "&spid=" + this.spid : "") + (localStorage.myuid ? "&uid=" + localStorage.myuid : "");
