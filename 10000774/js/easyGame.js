...
function keydown(a) {
    ...
    if (c > 7 && 14 > c || c > 31 && 47 > c) switch (c) {
        case 37:
            zfj.fj.fx = "R";
            break;
        case 39:
...
function IsPC() {
    ...
    var b = function() {
        ...
        return e.getContext("2d"), c = {
            ...
            loading: function(a, b) {
                this.l_t = 0, this.imgList.length = 0;
                for (var c = 0; c < a.length; c++) {
                    var d = a[c];
                    this.imgList[d.id] = new Image, this.imgList[d.id].src = d.url, this.imgList.length++
                }
                this.loadfuc = b;
                var e = this;
            ...
            setEmpty: function() {
                this.objList = [], this.offtimefuc(), b.eventList = {}
            },
            createLayer: function(a) {
                var b = [];
                return !a || a >= this.objList.length - 1 ? this.objList.push(b) : 0 >= a ? this.objList.unshift(b) : this.objList.splice(a, 0, b), b
            },
            ...
            addEventListener: function(a) {
                function d(d) {
                    if ("click" != a && eG.eventList[a]) {
                        "touchstart" == a && 1 == d.targetTouches.length && (d.preventDefault(), d = d.targetTouches[0]), "touchend" == a && (d = d.changedTouches[0]);
                        for (var e = eG.eventList[a], f = 0, g = e.length, h = new b.OBB(new eG.Vector2(d.pageX * c.p_x, d.pageY * c.p_x), 0, 0, 0); g > f; f++) {
                            var i = e[f];
                            if (eG.OBBvsOBB(h, i.testObb()))
                                for (var j = 0, k = i.eventFuc[a].length; k > j; j++) i.eventFuc[a][j](d)
                        }
                    }
                    if ("click" == a && eG.eventList.touchstart) {
                        "touchstart" == a && 1 == d.targetTouches.length && (d.preventDefault(), d = d.targetTouches[0]), "touchend" == a && (d = d.changedTouches[0]);
                        for (var e = eG.eventList.touchstart, f = 0, g = e.length, h = new b.OBB(new eG.Vector2(d.pageX * c.p_x, d.pageY * c.p_x), 0, 0, 0); g > f; f++) {
                            var i = e[f];
                            if (eG.OBBvsOBB(h, i.testObb()))
                                for (var j = 0, k = i.eventFuc.touchstart.length; k > j; j++) i.eventFuc.touchstart[j](d)
                        }
                    }
                }
            ...
            __drawFPS: function(a) {
                ...
                this.lastAnimationFrameTime = a, a - this.lastFpsUpdateTime > 2e3 && (this.lastFpsUpdateTime = a, this._fps = b)
            },
            __render: function(a) {
                for (var b = 0, c = this.objList.length; c > b; b++) {
                    for (var d = 0, e = 0, f = this.objList[b]; e < f.length; e++) f[e].die && f.splice(e, 1);
                    for (var g = f.length; g > d; d++) {
                        var h = f[d];
                        h.static || (h.x += this.__viewport.speed_x * a, h.y += this.__viewport.speed_y * a), h.update(a), h.render(a)
                    }
                }
            },
            __viewport: {
            ...
            setviewPort: function(a, b) {
                this.__viewport.speed_x = a || 0, this.__viewport.speed_y = b || 0
            },
            init: function() {
                this.lastAnimationFrameTime = (new Date).getTime(), this.lastFpsUpdateTime = 0, IsPC() ? (document.getElementById("game").style.width = "360px", this.pos_y = this.canvas.height, this.p_x = 1) : (this.p_x = this.canWidth / document.documentElement.clientWidth, this.p_y = this.canHeight / document.documentElement.clientHeight, this.pos_y = document.documentElement.clientHeight * this.p_x), this.requestAnimFrame = function() {
                    var b, c = d.fps;
                    return b = c ? function(b) {
                        a.setTimeout(b, 1e3 / c)
                    } : a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame || a.oRequestAnimationFrame || a.msRequestAnimationFrame || function(b) {
                        a.setTimeout(b, 1e3 / 60)
                    }
                }.bind(this)().bind(), this.cancelAFrame = function() {
            ...
            var a, b, c, d, e = this;
            if (null != (a = arguments[0]))
                for (b in a) c = e[b], d = a[b], e !== d && (e[b] = d);
            return e
        }, c
    };
    b.versions = function() {
        ...
        var c = new Function;
        c.prototype = b.prototype, a.prototype = new c, a.prototype.constructor = a, a.superclass = b.prototype, a.prototype.constructor == Object.prototype.constructor && (a.prototype.constructor = b)
        ...
        var c = function(c) {
            b.extend(this, a), b.Sprite.call(this, c)
        };
        return b.inherit(c, b.Sprite), c
    }, b.createBitmap = function(a) {
        var c = function(c) {
            b.extend(this, a), b.Bitmap.call(this, c)
        };
        return b.inherit(c, b.Bitmap), c
    }, b.eventList = {}, b.DisplayObject = function(a) {
        this.x = 0, this.y = 0, this.width = 0, this.height = 0, this.alpha = 1, this.die = 0, this.rotation = 0, this.visible = 0, this.scaleX = 1, this.scaleY = 1, this.globalCompositeOperation = "", this.ctx = null, this.obb = [], this.eventFuc = {}, this.static = 0, this.timeline = 0, this.ontween = 0, b.extend(this, a), this.__init()
    }, b.DisplayObject.prototype = {
        __transform: function(a) {
            a.translate(this.x, this.y), this.alpha < 1 && (a.globalAlpha = this.alpha), this.rotation && a.rotate(this.rotation), (1 != this.scaleX || 1 != this.scaleY) && a.scale(this.scaleX, this.scaleY), this.globalCompositeOperation && (a.globalCompositeOperation = this.globalCompositeOperation)
        },
        render: function(a) {
            if (this.__tween(a), this.timeline++, !this.visible) {
                var b = this.ctx;
                b.save(), this.__transform(b), this.draw(b), b.restore()
            }
        },
        addEventListener: function(a, c) {
            b.eventList[a] || (b.eventList[a] = []), this.eventFuc[a] || (this.eventFuc[a] = []), b.eventList[a].push(this), this.eventFuc[a].push(c.bind(this))
        },
        removeEventListener: function(a) {
            b.eventList[a].splice(b.eventList[a].indexOf(this), 1), this.eventFuc[a] = []
        },
        testObb: function() {
            return new b.OBB(new b.Vector2(this.x - this.__obb_x, this.y - this.__obb_y), this.__w, this.__h, this.rotation)
        },
        __init: function() {
            this.__w = this.obb[2] - this.obb[0], this.__h = this.obb[3] - this.obb[1], this.__obb_x = this.width / 2 - this.obb[0] - this.__w / 2, this.__obb_y = this.height / 2 - this.obb[1] - this.__h / 2, this.w = this.width, this.h = this.height
        },
        setObb: function(a) {
            this.obb = a
        },
        ...
        to: function(a, b, c, d, e, f) {
            this.duration = b, this.pattern = c || "Linear", this.ease = d || "easeIn", this.tween_obj = a, this.ontween = 1, this.current = 0, this.delaytime = e || 0, this.delaytime_t = 0, this.fuc = f || null, this.d_obj = {};
            for (i in a) this.d_obj[i] = this[i]
        },
        __tween: function(a) {
            if (this.ontween)
                if (this.delaytime_t >= this.delaytime) {
                    this.current += a;
                    ...
                    if (this.current >= this.duration) {
                        ...
                        this.ontween = 0, this.delaytime_t = 0, this.fuc && this.fuc()
                    }
    ...
    }, b.inherit(b.Bitmap, b.DisplayObject), b.Bitmap.prototype.draw = function(a) {
        a.drawImage(this.img, 0, 0, this.width, this.height, -this.w / 2, -this.h / 2, this.w, this.h)
    }, b.Bitmap.prototype.update = function() {}, b.Sprite = function(a) {
        this.anim = null, b.DisplayObject.call(this, a)
    }, b.inherit(b.Sprite, b.DisplayObject), b.Sprite.prototype.draw = function(a) {
        ...
        for (var d = [], e = a.height / b, f = a.width / c, g = 0; b > g; g++)
            for (var h = 0; c > h; h++) d.push([h * f, e * g]);
        return d
    }, b.Animation = function(a) {
        this.ctx = null, this.img = null, this.frames = [], this.loop = 0, this.speed = 1, this.__speed_t = 0, this.duration = 0, this.frameIndex = 0, this.onplay = 1, b.extend(this, a), this.len = this.frames.length
        ...
        goframe: function(a) {
            this.frameIndex = a, this.__speed_t = 0
        }
    }, b.TextField = function(a) {
        this.type = "text", this.color = "#000", this.size = "12px", this.family = "Arial", this.text = "", this.weight = "normal", this.textAlign = "left", b.DisplayObject.call(this, a)
    }, b.inherit(b.TextField, b.DisplayObject), b.TextField.prototype.draw = function(a) {
        a.fillStyle = this.color, a.textAlign = this.textAlign, a.font = this.weight + " " + this.size + "px " + this.family, a.fillText(this.text, 0, 0), a.fill()
    }, b.TextField.prototype.update = function() {}, b.Math = {
        random: function(a, b) {
        ...
        this.centerPoint = a, this.extents = [c / 2, d / 2], this.axes = [new b.Vector2(Math.cos(e), Math.sin(e)), new b.Vector2(-Math.sin(e), Math.cos(e))], this._width = c, this._height = d, this._rotation = e
...
var buzz = {
        ...
        sound: function(a, b) {
            ...
            function e(a, b) {
                ...
                c.src = b, buzz.types[d(b)] && (c.type = buzz.types[d(b)]), a.appendChild(c)
            }
            b = b || {};
            var f = 0,
                g = [],
            ...
            if (this.load = function() {
                ...
                return i ? (this.sound.loop = "loop", this.bind("ended.buzzloop", function() {
                ...
                for (var b = 0; b < a.length; b++)
                    for (var c = a[b], d = c.split(".")[0], e = 0; e < g.length; e++) {
                        var f = g[e].idx.split(".");
                        (g[e].idx == c || f[1] && f[1] == c.replace(".", "")) && (this.sound.removeEventListener(d, g[e].func, !0), delete g[e])
                    }
                return this
            }, this.bindOnce = function(a, b) {
                if (!i) return this;
                var c = this;
                h[f++] = !1, this.bind(f + a, function() {
                    h[f] || (h[f] = !0, b.call(c)), c.unbind(f + a)
                })
                ...
                return i ? (this.fadeOut(b, function() {
                    this.stop()
                ...
                if (this.sound = document.createElement("audio"), a instanceof Array)
                    for (var k in a) a.hasOwnProperty(k) && e(this.sound, a[k]);
                else if (b.formats.length)
                    for (var l in b.formats) b.formats.hasOwnProperty(l) && e(this.sound, a + "." + b.formats[l]);
                else e(this.sound, a);
                b.loop && this.loop(), b.autoplay && (this.sound.autoplay = "autoplay"), this.sound.preload = b.preload === !0 ? "auto" : b.preload === !1 ? "none" : b.preload, this.setVolume(b.volume), buzz.sounds.push(this)
            }
        },
        group: function(a) {
            function b() {
...
zfj.loading([{
    ...
    createStart: function() {
        ...
        a.to({
            y: zfj.pos_y / 2 + 120
        }, 400, "Circ", "easeOut", 0, function() {
            a.update = function(a) {
                a > 40 && (a = 20), this.ct += a, this.y -= Math.sin(Math.PI / 500 * this.ct)
            }
        });
        ...
        b.to({
            x: 180
        }, 500, "Back", "easeOut", 0), this.btnlayer.push(b), a.addEventListener("touchstart", function() {
            zfj.overBg.hide(), zfj.fx1.addEventListener("touchstart", function() {
                zfj.fj.fx = "R"
            }), zfj.fx2.addEventListener("touchstart", function() {
                zfj.fj.fx = "L"
            }), zfj.fx1.addEventListener("touchend", function() {
                zfj.fj.fx = "CL"
            }), zfj.fx2.addEventListener("touchend", function() {
                zfj.fj.fx = "CL"
            }), b.to({
                x: 580
            }, 400, "Back", "easeIn", 0, function() {
                this.remove()
            }), this.to({
                x: 620
            }, 300, "Back", "easeIn", 0, function() {
                this.remove(), zfj.onstop = 0
            })
    ...
    collide: function() {
        zfj.fj.to({
            ...
            c.to({
                y: 240
            }, 400, "Back", "easeOut", 200), zfj.overlayer.push(zfj.winBg);

            
            //pk: ending
            str0 = "我下降了" + zfj.jl.text + "," + "我击败了全国" + zfj.sortScore() + "的飞机手" + "。你敢来与我挑战吗？";
            updateShareScore(parseFloat(zfj.jl.n.toFixed(1)), str0);
            
            //pk: remove share button
            ...
            //     zfj.fxBox.show()
            // }), 
            zfj.btnlayer.push(d), zfj.btnlayer.push(b, c)
        }), zfj.setviewPort(0, 0), zfj.onstop = 1
    },
    getItext: function() {
    ...
    startReady: function() {
        this.n = 0, this.prize_n = 0, this.onstop = 1, this.createBg(), this.squarelayer = zfj.createLayer(), this.mainlayer = zfj.createLayer(), this.overlayer = zfj.createLayer(), this.btnlayer = zfj.createLayer(), this.createStart(), this.createsquare(500, zfj.getImg("sg" + eG.Math.random(1, 6))), zfj.getLast_y(), this.createsquare(this.last_y + 250, zfj.getImg("sg" + eG.Math.random(1, 6))), this.fj = new Plane({
            x: 180,
            speed: 1200,
            y: -40,
            "static": 0,
            ...
            this.x = zfj.fj.x + 40, this.y = zfj.fj.y + 40, this.rotation = zfj.fj.rotation
        }, this.mainlayer.push(this.fj_yy, this.fj), this.jl = new easyGame.TextField({
            x: 160,
            y: 30,
            text: "0m",
            "static": 1,
            ...
            n: 0,
            size: 28
        }), this.mainlayer.push(this.jl), this.fx1 = new easyGame.Bitmap({
            x: 75,
            y: zfj.pos_y - 75,
            "static": 1,
            img: zfj.getImg("fx_n"),
            ...
            obb: [0, 0, 150, 150],
            ctx: zfj.ctx
        }), this.mainlayer.push(this.fx1, this.fx2), this.overBg = new easyGame.Bitmap({
            x: 180,
            y: 330,
            "static": 1,
            ...
            alpha: 1
        }, 300, "Linear", "easeIn", 0), this.overBg.show = function() {
            zfj.overBg.die = 0, zfj.overBg.alpha = 1, zfj.disable = 0, zfj.overlayer.push(zfj.overBg)
        }, this.overBg.hide = function() {
            zfj.disable = 1, zfj.overBg.remove()
        }, this.overBg.show(), this.fxBox = new easyGame.Bitmap({
            x: 180,
            y: 330,
            "static": 1,
            img: zfj.getImg("fx"),
            ...
            alpha: 0
        }, 300, "Linear", "easeIn", 2e3, function() {
            zfj.fxBox.remove()
        }), this.fxBox.show = function() {
            zfj.fxBox.die = 0, zfj.fxBox.alpha = 1, zfj.fxBox.to({
                alpha: 0
            }, 300, "Linear", "easeIn", 2e3, function() {
                zfj.fxBox.remove()
            ...
            alpha: 1
        }, 400, "Linear", "easeIn", 400), this.winBg.update = function(a) {
    ...
    createBlockList: function(a) {
        ...
        switch (b) {
            case 1:
                return this.createlxx(a - 220), this.createBlock(50 - 5 * eG.Math.random(1, 20), a, block.getImg("b"), 0);
            case 2:
                return this.createlxx(a - 220), this.createBlock(430 + 5 * eG.Math.random(1, 20), a, block.getImg("b"), 0)
        }
    },
    hasGift: function() {
        this.score.update = function() {
            this.y = block.over1.y - 148
        }, block.score.text = block.sortScore(), block.overlayer.push(block.winBg, block.over1, block.over1btn1, block.over1btn2, block.score), block.over1btn2.addEventListener("touchstart", function() {
            block.setEmpty(), block.startReady(), block.canvas.className = ""
        }), block.over1btn1.addEventListener("touchstart", function() {})
    },
    sortScore: function() {
        var a = 0;
        return a = zfj.jl.n < 110 ? .88 * zfj.jl.n : zfj.jl.n < 305 ? 95.92 + .1 * Math.round((zfj.jl.n - 105) / 5) : 100, a.toFixed(2) + "%"
    },
    getLast_y: function() {
...
}), IsPC() ? zfj.addEventListener("click") : (zfj.addEventListener("touchstart"), zfj.addEventListener("touchend"));
var square = eG.createBitmap({
    kg: 1
});
square.prototype.update = function() {
    eG.OBBvsOBB(this.testObb(), zfj.fj.testObb()) && this.kg && !zfj.onstop && (this.kg = 0, zfj.collide()), this.y <= -this.height / 2 && this.kg && (this.kg = 0, 1 == this.type && (zfj.getLast_y(), zfj.createsquare(zfj.last_y + 250, zfj.getImg("sg" + eG.Math.random(1, 6)))), this.remove())
};
...
Boo.prototype.update = function(a) {
    this.y += this.speed * a / 15 * Math.cos(-this.rotation), this.x += this.speed * a / 15 * Math.sin(-this.rotation), this.w -= 1, this.h -= 1, this.alpha -= .002 * a, this.w < 2 && this.remove()
};
var Plane = eG.createBitmap();
Plane.prototype.update = function(a) {
    if (!zfj.onstop) {
        a > 200 && (a = 20), this.move();
        var b = Math.cos(this.rotation),
            c = Math.sin(this.rotation);
        this.y <= 200 && !this.static ? (this.y += this.speed / 2e4 * a * b * (2 * b + 2) / 3, this.x -= this.speed / 2e4 * a * c * (2 * b + 2) / 3) : (this.static = 1, zfj.setviewPort(0, -this.speed / 2e4 * b * (2 * b + 2) / 3), this.x -= this.speed / 2e4 * a * c * (2 * b + 2) / 3), this.speed < 14e3 && this.speed++, (this.x < -40 || this.x > 360 || this.y > 660) && zfj.collide(), zfj.jl.n += this.speed / 24e4 * b * (2 * b + 2) / 3, zfj.jl.text = zfj.jl.n.toFixed(1) + "m"
    }
...
//             img_url: "http://www.iweiyang.cn/zhifeiji0901/img/icon.jpg",
//             img_width: "120",
//             img_height: "120",
//             link: "http://www.iweiyang.cn/zhifeiji00901/",
//             desc: zfj.getItext(),
//             title: "纸飞机"
//         }, function(a) {
...
//             img_width: "120",
//             img_height: "120",
//             link: "http://www.iweiyang.cn/zhifeiji0901/",
//             desc: zfj.getItext(),
//             title: zfj.getItext()
//         }, function(a) {
