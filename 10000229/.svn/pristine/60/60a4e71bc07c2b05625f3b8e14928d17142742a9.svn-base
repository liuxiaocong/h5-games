...
var pkGame = (function() {
    ...
    function pkGameReady(callbackfunc) {
        ...
        reader.onreadystatechange = function() {
            if (reader.readyState == 4) {
                try {
                    ...
                    _pkGameInfo.gameId = obj.gameId;
                } catch (e) {
                    _pkGameInfo.link = 'http://www.pkleyou.cn';
                    _pkGameInfo.imgUrl = 'http://www.pkleyou.cn/logo.png';
        ...
        if (navigator.userAgent.indexOf('PK') == -1 && navigator.userAgent.indexOf('Crosswalk') == -1) {
