...
(function() {
    ...
    link = {
        ...
        main: function(e) {
            ...
            return s == "ipad" || s == "iphone" ? (n.event.focused = !0, window.addEventListener("pageshow", i.pageFocus, !1), window.addEventListener("pagehide", i.pageUnFocus, !1)) : (s == "firefox" && (n.event.focused = !0), window.addEventListener("focus", i.pageFocus, !1), window.addEventListener("blur", i.pageUnFocus, !1)), this.canvas.fillStyle(n.canvas.bgColor).fillRect(0, 0, this.canvas.screen.getWidth(), this.canvas.screen.getHeight()), n.image.inited = !1, this.gameFlow.run().base().play(), n.image.imgObjs.length > 0 
                ? this.loadImage(n.image.imgObjs) 
                : i.pageLoaded(), this
        },
        menu: function(e) {
        ...
        canvas: {
            ...
            drawImageT: function(e, t, r, u, a) {
                var d = m.getImage(e);
                s.drawImage(d, t, r, u, a);
                return d = null, this
            },
            ...
            e.run(function() {
                ...
                if (!l.died) {
                    ...
                    for (var s = 0, f; f = l.scenes[s]; s++) {
                        var yy = ((innerHeight - 50) / 3) * (s + 1);
                        f.action(0, yy, i, n, -8).render();
                        if (f.hostDied) {
                ...
                var h = w * 138 / 480;
                e.canvas.fillStyle("#FFF").fillScreen().drawImageT("logo", 0, 10, w, h), e.buttonLayout.released("difficulty1") ? (l.moduleName = "我的成绩", hideAd(), c(2)) : e.buttonLayout.released("difficulty2") ? (l.moduleName = "噩梦模式", c(3)) : e.buttonLayout.released("difficulty3") ? (l.moduleName = "地狱模式", c(4)) : e.buttonLayout.released("difficulty4") ? (l.moduleName = "炼狱模式", c(5)) : e.buttonLayout.released("rank") && dp_Ranking()
            }).zone(function() {
                e.canvas.fillStyle("#F00").fillScreen().fillStyle("#FFF").drawString(l.moduleName, 0, u + 110, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑").fillStyle("#000").drawString(a(l.time, "秒"), 0, u + 340, e.graphics.VCENTER, !1, null, null, "60px 微软雅黑").fillStyle("#000").drawString("最佳:" + a(l.bestTime, "秒"), 0, u + 400, e.graphics.VCENTER, !1, null, null, "30px 微软雅黑"), l.time > l.bestTime && e.canvas.fillStyle("#FF0").drawString("新纪录", 0, u + 240, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑"), e.buttonLayout.released("return") ? f() : e.buttonLayout.released("restart") && dp_share2(l.time)
            ...
            var l = {
                    ...
                    Scene: e.extend(function(t) {
                        ...
                        action: function(t, n, r, i, s) {
                            var h = (innerHeight - 50) / 3;
                            this.x = t, this.baseY = n, this.width = r, this.height = h;
                            if (!this.hostDied) {
