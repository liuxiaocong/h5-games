...
cc._initSys = function(a, b) {
    ...
    if (1 === e || 0 === e && (c.isMobile || d) || "file://" == location.origin) l = cc._RENDER_TYPE_CANVAS;
    ...
    if (f.DeviceMotionEvent ||
        f.DeviceOrientationEvent) r.accelerometer = !0;
                ...
                if (q) {
                    ...
                    if (this.__getters__ && this.__getters__[n]) {
                        var q = this.__getters__[n],
                            u;
                        for (u in this.__setters__)
                            if (this.__setters__[u] == q) {
                                v = u;
                                break
                            }
                    ...
                    if (this.__setters__ && this.__setters__[n]) {
                        ...
                        for (u in this.__getters__)
                            if (this.__getters__[u] == q) {
                                s = u;
                                break
                            }
...
cc.defineGetterSetter = function(a, b, c, d, e, f) {
    if (a.__defineGetter__) c && a.__defineGetter__(b, c), d && a.__defineSetter__(b, d);
        ...
        for (var g = null != c, h = void 0 != d, k = Object.getOwnPropertyNames(a), l = 0; l < k.length; l++) {
            var m = k[l];
...
cc._fontLoader = {
    ...
    _loadFont: function(a, b, c) {
        ...
        if (b instanceof Array)
            for (var k = 0, l = b.length; k < l; k++) c = e.extname(b[k]).toLowerCase(), h += "url('" + b[k] + "') format('" + f[c] + "')", h += k == l - 1 ? ";" : ",";
...
cc.EGLView = cc.Class.extend({
    ...
    convertToLocationInView: function(a,
        b, c) {
        return {
...
cc._tmp.PrototypeCCNode = function() {
    ...
    cc.defineGetterSetter(a,
        "cascadeColor", a.isCascadeColorEnabled, a.setCascadeColorEnabled)
};
...
cc.Node = cc.Class.extend({
    ...
    setRotation: function(a) {
        ...
        this._rotationRadiansY =
            0.017453292519943295 * this._rotationY;
        this.setNodeDirty()
    },
    ...
    addChild: function(a, b, c) {
        ...
        this.addChildHelper(a, b, c, d, e)
    },
    addChildHelper: function(a, b, c, d, e) {
        this._children || (this._children = []);
        this._insertChild(a, b);
        e ? a.setTag(c) : a.setName(d);
        a.setParent(this);
        a.setOrderOfArrival(this.s_globalOrderOfArrival++);
    ...
    removeAllChildren: function(a) {
        ...
        if (null != b) {
            ...
            for (var c = 0; c < b.length; c++) {
                var d = b[c];
                d && (this._running && (d.onExitTransitionDidStart(),
                    d.onExit()), a && d.cleanup(), d.parent = null)
            }
    ...
    _setCachedParent: function(a) {
        if (this._cachedParent != a) {
            ...
            for (var b =
                this._children, c = 0, d = b.length; c < d; c++) b[c]._setCachedParent(a)
        }
    },
    getCamera: function() {
    ...
    _nodeToParentTransformForWebGL: function() {
        if (this._transformDirty) {
            ...
            if (0 !== this._rotationX || 0 !== this._rotationY) k = Math.cos(-this._rotationRadiansX),
                l = Math.sin(-this._rotationRadiansX), m = Math.cos(-this._rotationRadiansY), n = Math.sin(-this._rotationRadiansY);
            ...
            this._additionalTransformDirty && (r = cc.affineTransformConcat(r,
                this._additionalTransform), this._additionalTransformDirty = !1);
            this._transform = r;
    ...
    setColor: function(a) {
        ...
        b.g = c.g = a.g;
        b.b = c.b = a.b;
        b = (b = this._parent) && b.cascadeColor ?
            b.getDisplayedColor() : cc.color.WHITE;
    ...
    setCascadeColorEnabled: function(a) {
        this._cascadeColorEnabled !== a && ((this._cascadeColorEnabled =
...
cc.LoaderScene = cc.Scene.extend({
    ...
    init: function() {
        var a = this,
            b = 200,
            c = a._bgLayer = cc.LayerColor.create(cc.color(255, 255, 255, 255));
...
if (cc._renderType === cc._RENDER_TYPE_CANVAS) {
    ...
    p = null
} else cc.assert("function" === typeof cc._tmp.LayerDefineForWebGL, cc._LogInfos.MissingFile, "CCLayerWebGL.js"), cc._tmp.LayerDefineForWebGL(),
...
cc._renderType === cc._RENDER_TYPE_CANVAS ? (_p = cc.LayerColor.prototype, _p.ctor = function(a, b, c) {
    ...
    return a
}, _p = null) : (cc.assert("function" === typeof cc._tmp.WebGLLayerColor, cc._LogInfos.MissingFile, "CCLayerWebGL.js"),
    cc._tmp.WebGLLayerColor(), delete cc._tmp.WebGLLayerColor);
...
cc._renderType === cc._RENDER_TYPE_CANVAS ? (_p = cc.LayerGradient.prototype, _p.draw = function(a) {
    ...
    var b = this._displayedOpacity / 255,
        ...
        d = this._displayedColor,
        g = this._endColor;
    c.addColorStop(0, "rgba(" + Math.round(d.r) +
        "," + Math.round(d.g) + "," + Math.round(d.b) + "," + (b * (this._startOpacity / 255)).toFixed(4) + ")");
    c.addColorStop(1, "rgba(" + Math.round(g.r) + "," + Math.round(g.g) + "," + Math.round(g.b) + "," + (b * (this._endOpacity / 255)).toFixed(4) + ")");
    a.fillStyle = c;
    a.fillRect(0, 0, e, -f);
...
cc.generateTintImageWithMultiply = function(a, b, c, d) {
    ...
    e.drawImage(a, c.x, c.y, c.width,
        c.height, 0, 0, c.width, c.height);
    return d
};
...
cc.Sprite = cc.Node.extend({
    ...
    _changeTextureColor: function() {
        ...
        if (b && (c.validRect && this._originalTexture) && (a = b.getHtmlElementObj())) this._colorized = !0, a instanceof HTMLCanvasElement && !this._rectRotated && !this._newTextureWhenChangeColor ?
            cc.generateTintImageWithMultiply(this._originalTexture._htmlElementObj, this._displayedColor, c, a) : (a = cc.generateTintImageWithMultiply(this._originalTexture._htmlElementObj, this._displayedColor, c), b = new cc.Texture2D, b.initWithElement(a), b.handleLoadedTexture(), this.texture = b)
    },
...
cc._renderType === cc._RENDER_TYPE_CANVAS ? (_p = cc.Sprite.prototype, _p._spriteFrameLoadedCallback = function(a) {
        ...
        var b = this.color;
        b.r === a.r && b.g === a.g && b.b === a.b || cc.Node.prototype.setColor.call(this,
            a)
        ...
        a && "string" === typeof a ? (a = cc.textureCache.addImage(a), this.setTexture(a), a = a.getContentSize(), this.setTextureRect(cc.rect(0, 0, a.width, a.height))) : (cc.assert(!a ||
            a instanceof cc.Texture2D, cc._LogInfos.CCSpriteBatchNode_setTexture), this._texture != a && (a && a.getHtmlElementObj() instanceof HTMLImageElement && (this._originalTexture = a), this._texture = a))
    }, _p.draw = function(a) {
        if (this._textureLoaded) {
            a = a || cc._renderContext;
            this._isLighterMode && (a.globalCompositeOperation = "lighter");
            ...
            h *= b;
            k *= c;
            this._texture && l.validRect ? (e = this._texture.getHtmlElementObj(), this._colorized ? a.drawImage(e, 0, 0, l.width, l.height, h, k, g.width, g.height) : a.drawImage(e, l.x, l.y, l.width, l.height, h, k, g.width, g.height)) : !this._texture && l.validRect && (g = this.color, a.fillStyle = "rgba(" + g.r + "," + g.g + "," + g.b + ",1)", a.fillRect(h,
                k, e.width * b, e.height * c));
...
cc.SpriteFrame = cc.Class.extend({
    ...
    initWithTexture: function(a, b, c, d, e) {
        ...
        if ((a = this.getTexture()) && a.url) {
            ...
            f > a.width &&
                cc.error(cc._LogInfos.RectWidth, a.url);
...
cc.LabelTTF = cc.Sprite.extend({
    ...
    _checkNextline: function(a, b) {
        ...
        n = a.substr(0, d);
        for (e = d; h = l.exec(n);)
            if (e = h[1].length, n = h[1], f = this._measure(n), f < b) {
                m.test(h[2]) && e++;
                break
            }
        return e || 1
    ...
    initWithString: function(a, b, c, d, e, f) {
        ...
        this._opacityModifyRGB = !1;
        this._dimensions = cc.size(d.width,
            d.height);
    ...
    setString: function(a) {
        a = String(a);
        this._originalText != a && (this._originalText =
            a + "", this._updateString(), this._needUpdateTexture = !0)
    },
    ...
    setDimensions: function(a, b) {
        ...
        if (c != this._dimensions.width || b != this._dimensions.height) this._dimensions.width = c, this._dimensions.height = b,
            this._updateString(), this._needUpdateTexture = !0
    },
    ...
    setFontSize: function(a) {
        this._fontSize !== a && (this._fontSize = a,
            this._fontStyleStr = a + "px '" + this._fontName + "'", this._fontClientHeight = cc.LabelTTF.__getFontHeightByDiv(this._fontName, a), this._needUpdateTexture = !0)
    },
    ...
    _setFont: function(a) {
        ...
        b && (this._fontSize =
            parseInt(b[1]), this._fontName = b[2], this._fontStyleStr = a, this._fontClientHeight = cc.LabelTTF.__getFontHeightByDiv(this._fontName, this._fontSize), this._needUpdateTexture = !0)
    },
    _drawTTFInCanvas: function(a) {
        if (a) {
            ...
            if (this._isMultiLine) {
                ...
                e === cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM ?
                    k = g + d - g * f : e === cc.VERTICAL_TEXT_ALIGNMENT_CENTER && (k = g / 2 + (d - g * f) / 2);
    ...
    _updateTTF: function() {
        ...
        a = 0 === a ? this._isMultiLine ? cc.size(0 | Math.max.apply(Math, d) + b, 0 | this._fontClientHeight * this._strings.length + c) : cc.size(0 | this._measure(this._string) + b, 0 | this._fontClientHeight + c) : 0 === this._dimensions.height ? this._isMultiLine ? cc.size(0 | a + b, 0 | this._fontClientHeight * this._strings.length + c) : cc.size(0 | a + b, 0 | this._fontClientHeight + c) : cc.size(0 | a + b, 0 |
            this._dimensions.height + c);
    ...
    _setTextureCoords: function(a) {
        ...
        if (b) {
            var c = b.pixelsWidth,
                d = b.pixelsHeight,
                e, f = this._quad;
            this._rectRotated ? (cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL ? (b = (2 * a.x + 1) / (2 * c), c = b + (2 * a.height - 2) / (2 * c), e = (2 * a.y + 1) / (2 * d), a = e + (2 * a.width - 2) / (2 *
                ...
                e = a, a = d), f.bl.texCoords.u = b, f.bl.texCoords.v = a, f.br.texCoords.u = c, f.br.texCoords.v = a, f.tl.texCoords.u = b, f.tl.texCoords.v = e, f.tr.texCoords.u = c, f.tr.texCoords.v = e);
            this._quadDirty = !0
        }
    }
});
...
cc.cardinalSplineAt = function(a, b, c, d, e, f) {
    var g = f * f,
        ...
        k = (1 - e) / 2;
    e = k * (-h + 2 * g - f);
    var l = k * (-h + g) + (2 * h - 3 * g + 1);
    f = k * (h - 2 * g + f) + (-2 * h + 3 * g);
    g = k * (h - g);
    return cc.p(a.x * e + b.x * l + c.x * f + d.x * g, a.y * e + b.y * l + c.y * f + d.y * g)
};
