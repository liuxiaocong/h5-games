...
var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        this.delegate(tileNode, 'click', function(touch){
            ...
            if(!this.gameOverB && tile && self._numbers.length){
