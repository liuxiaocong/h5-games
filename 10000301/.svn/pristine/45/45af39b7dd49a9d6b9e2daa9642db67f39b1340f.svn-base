...
! function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.init = function() {
            a.Main.spilAPI = window.__SpilAPI, this.game.device.android && !this.game.device.chrome && (this.game.canvas.parentElement.style.overflow = "visible");
            var b = {
                    font: "46px TF2 Build"
                },
                c = this.add.text(0, 0, "0", b);
            c.destroy()
    ...
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.init = function() {
            if (this.cache.checkImageKey("spilLogo")) {
                ...
                b.scale.set(1.5, 1.5), b.x = .5 * (a.Config.GAME_WIDTH - b.width), b.y = 300, b.inputEnabled = !0, b.events.onInputDown.add(a.Main.logoAction, this), b.input.useHandCursor = !0
            }
        }, c.prototype.preload = function() {
            ...
            this.game.device.webAudio && (
                this.load.audio("sand_block", ["assets/audio/SandTile.wav"], !0), 
                this.load.audio("valve", ["assets/audio/valve.wav"], !0), 
                this.load.audio("tap", ["assets/audio/TapSound.wav"], !0), 
                this.load.audio("water", ["assets/audio/WaterSound.wav"], !0), 
                ...
                this.load.atlasJSONHash("valve", "assets/graphics/valve.png", "assets/graphics/valve.json"), 
                this.load.atlasJSONHash("flower", "assets/graphics/flower.png", "assets/graphics/flower.json"), 
                this.load.atlasJSONHash("gnome", "assets/graphics/gnome.png", "assets/graphics/gnome.json"), 
                this.load.atlasJSONHash("tutorial_hand", "assets/graphics/tutorial_hand.png", "assets/graphics/tutorial_hand.json"), this.load.atlasJSONHash("levelGraphics", "assets/graphics/levelGraphics.png", "assets/graphics/levelGraphics.json"), this.load.atlasJSONHash("gui", "assets/graphics/gui.png", "assets/graphics/gui.json"), a.Main.development ? this.load.json("startLevel", "assets/levels/StartLevel.json") : this.load.json("levelConfigs", "assets/levels/Levels.json")
        }, c.prototype.create = function() {
    ...
    var b = function(a) {
        function b(b, c, d, e) {
            ...
            a.call(this, b, c, d, "gui", e), this._callback = new Phaser.Signal, this.anchor.set(.5, .5), this.inputEnabled = !0, this.game.device.desktop && (this.input.useHandCursor = !0), this.inputEnabled && (this.events.onInputDown.add(function() {
                ...
                f.tint = 16777215, f.game.add.tween(f.scale).to({
                    x: 1,
                    y: 1
                }, 100, Phaser.Easing.Cubic.Out, !0)
            }, this, 1), this.events.onInputUp.add(function() {
                f.game.time.events.add(100, f._callback.dispatch, f, [f])
            }, this, 2))
        }
...
! function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.init = function(a) {
            ...
            this.add.image(-16, -75, "gui", "LevelsMenu_Background0000"), this.add.image(-1, a.Config.GAME_HEIGHT - 388, "gui", "MainMenu_Back0000"), this.title = this.add.image(0, 0, "gui", "GameTitle0000"), this.title.anchor.set(.5, .5), this.title.x = a.Config.HALF_GAME_WIDTH - .5, this.title.y = 150, this.cache.checkImageKey("spilLogo") && (this.logo = this.game.add.image(0, 0, "spilLogo"), this.logo.scale.set(1.5, 1.5), this.logo.x = 5, this.logo.y = 730, this.logo.inputEnabled = !0, this.logo.events.onInputDown.add(a.Main.logoAction, this), this.logo.input.useHandCursor = !0)
            ...
            }, this), this.creditsButton = new a.SimpleButton(this.game, a.Config.GAME_WIDTH - c, a.Config.GAME_HEIGHT - c, "Credits_Button0000"), this.creditsButton.callback.add(this.toggleCredits, this), this.moreGamesButton = new a.SimpleButton(this.game, this.creditsButton.x - 86, a.Config.GAME_HEIGHT - c, "MoreGames_Button0000"), this.moreGamesButton.callback.add(a.Main.moreGamesAction, this), this.buttons = [this.playButton, this.soundButton, this.creditsButton, this.moreGamesButton], this.buttons.forEach(function(a) {
                b.world.add(a)
            })
            ...
            this.title.y -= 280, this.game.add.tween(this.title).to({
                y: this.title.y + 280
            }, 600, Phaser.Easing.Back.Out, !0, 300), this.logo && (this.logo.y += 200, this.game.add.tween(this.logo).to({
                y: this.logo.y - 200
...
! function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.create = function() {
            ...
            if (1 === a) return !1;
            var b = a - 1;
            return !("true" === window.localStorage.getItem('LetMeGrow'+b.toString()))
...
! function(a) {
    ...
    var c = function(b) {
        ...
        return __extends(c, b), c.prototype.init = function(b) {
            ...
            this.game.state.onShutDownCallback = this.destroy, this.state = 1, this.addLayers(), this.parse(), this.initKeyCallbacks(), a.Main.development && this.addFPSMeter(), this.grid.init(), 5 === this._settings.levelNumber && (this.tutorHands[1].visible = !1, this.tutorHands[2].visible = !1), this._settings.levelNumber > 1 && this.showAds(), this.state = 0
        }, c.prototype.showAds = function() {
            var b = this;
            a.Main.spilAPI.GameBreak.request(function() {
                a.Main.wasMuted = b.game.sound.mute, b.game.sound.mute = !0, b.game.tweens.pauseAll()
            }, function() {
                b.game.sound.mute = a.Main.wasMuted, b.game.tweens.resumeAll()
            })
            ...
            updateShareScore(this.settings.levelNumber);
            ...
            window.localStorage.setItem('LetMeGrow'+this.settings.levelNumber.toString(), "true")
        }, c.prototype.render = function() {
