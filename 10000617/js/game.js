...
(function(t) {
    ...
    function d(t, n, o, s, u) {
        this.version = "0.13.1", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new t({
            isMaster: !0
    ...
    g.argsToArray = function(t) {
        ...
        }), a && (r = ["", o, i, a].join("/"), n.open("GET", r, !0), n.timeout = 3e3, n.ontimeout = function() {
            e(404, null)
        }, n.send())
