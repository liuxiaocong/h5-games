...
play.init = function(a) {
    ...
    play.getClickPoint = function(a) {
        ...
        console.log(a.pageY);
        console.log(com.pointStartY);
        console.log(com.spaceY*x);
        var c = Math.round((a.pageX - b.x - com.pointStartX - 30*x) / (com.spaceX*x));

        var d = Math.round((a.pageY - b.y - com.pointStartY - 30*x) / (com.spaceY*x));
        console.log(d);
        return c > 14 && (c = 14),
            d > 14 && (d = 14),
            0 > c && (c = 0),
