...
I18n.defaultLocale = "en", I18n.fallbacks = !1, I18n.defaultSeparator = ".", I18n.locale = null, I18n.PLACEHOLDER = /(?:\{\{|%\{)(.*?)(?:\}\}?)/gm, I18n.fallbackRules = {}, I18n.pluralizationRules = {
    ...
    var t = t || {},
        ...
        o;
    typeof e == "object" && (e = e.join(this.defaultSeparator)), t.scope && (e = t.scope.toString() + this.defaultSeparator +
        e), e = e.split(this.defaultSeparator);
...
I18n.translations = {
    ...
    function() {
        Softgames.prototype.bannerIdIngameAdPopup = 296, Softgames.prototype.bannerIdGameDetailsPage = 380, Softgames.prototype.bannerIdMoreGamesPage = 381, Softgames.prototype.bannerIdPrerollAdPopup = 382, Softgames.prototype.bannerIdOnCloseEndLevelAdPopup = 383, Softgames.prototype.adRefreshCount = -1, Softgames.prototype.pageGameDetails = "page_game-details", Softgames.prototype.pageMoreGames = "page_more-games", Softgames.prototype.popupPreroll = "popup_preroll", Softgames.prototype.popupIngame = "popup_ingame", Softgames.prototype.adPopups = [Softgames.prototype.popupPreroll, Softgames.prototype.popupIngame], Softgames.prototype.c3poAdTypeAdsenseContent = "adsense_content", Softgames.prototype.c3poAdTypeAdsenseGames = "adsense_games", Softgames.prototype.c3poAdTypeAdxContent = "adx_content", Softgames.prototype.c3poAdTypeAdxGames = "adx_games", Softgames.prototype.c3poAdTypeDirectVast = "direct_vast", Softgames.prototype.c3poAdTypeDfpBanner = "dfp_banner", Softgames.prototype.c3poAdTypeDfpVideo = "dfp_video", Softgames.prototype.c3poAdTypeLiverail = "liverail", Softgames.prototype.c3poAdTypeSmartclip = "smartclip", Softgames.prototype.adsConfigurations = {}, Softgames.prototype._showAd = function(e, t, n) {
            var r;
            return this.displayBannerLastTime = SG_jQuery.now(), this.adRefreshCount++, this.adsConversionPoints === this.adRefreshCount && (this.adConversionBanner = !0), this.adConversionBanner && this._trackConversion(), r = this._adSettings(e, t, n), this.ad_close_callback = null, this.ad_place = null, this.adsConfigurations[e].type === "openx" ? (this.ad_close_callback = n, this.ad_place = e, this._openxAd(t, r)) : this._c3poAd(r)
            ...
            var r, i;
            return r = this.adsConfigurations[e].params, typeof this[i = "_adSettings_" + this.adsConfigurations[e]["type"]] == "function" && this[i](r), r.ad_container_id = this._adContentId(t), r.partner = this.subplatform, r.game = this.game_slug, r.language = this.locale, r.ad_type = this.adsConfigurations[e].type, r.custom_params = {
                partner: this.subplatform,
                game: this.game_slug,
                affgame: this._shortAgentGameName(this.subplatform, this.game_slug),
                lang: this.locale
            }, this._isPlaceWithCloseButton(e) && (r.close_button = document.getElementById("voyager-close-popup-btn")), r.close_ad_callback = n, r.refreshcount = this.adRefreshCount, r.conversion = this.adConversionBanner, r
            ...
            return console.log(e), c3po.showAd(e)
            ...
            var e;
            return e = "http://tracking.softgames.de/aff_l?offer_ref=" + this.game_slug + "-cpa", this._cleanupConverionPointTracker(), this._createConverionPointTracker(e)
        }, Softgames.prototype._createConverionPointTracker = function(e) {
            var t;
            return console.log("Conversion tracking"), t = SG_jQuery(document.createElement("iframe")), t.attr("src", e), t.attr("id", "voyager_conversion_point_tracker"), t.attr("width", "1px"), t.attr("height", "1px"), t.attr("scrolling", "no"), t.attr("frameborder", "0"), t.css({
                display: "none"
    ...
    function() {
        window.SoftgamesVoyagerTracker = function() {
            function e(e) {
                var t, n, r = this;
                this.externalGACode = e, this.messageQueue = [], this.eventQueue = [], this.ready = !1, this.mainNamespace = "softgames", this.trackers = [this.mainNamespace], this.externalGACode !== undefined && this.externalGACode !== "" && this.trackers.push("external"), window._gaq = window._gaq || [], this._pushGA("_setAccount", "UA-33273423-1", this.mainNamespace), this.externalGACode !== undefined && this.externalGACode !== "" && this._pushGA("_setAccount", this.externalGACode, "external"), t = document.createElement("script"), t.type = "text/javascript", t.async = !0, t.onload = function() {
                    return r.ready = !0, r._sendMessageQueue(), r._sendEventQueue()
                }, t.src = ("https:" === document.location.protocol ? "https://" : "http://") + "stats.g.doubleclick.net/dc.js", n = document.getElementsByTagName("script")[0], n.parentNode.insertBefore(t, n)
            }
            return e.prototype.trackPageview = function(e, t, n, r, i, s) {
                ...
                var t, n, r, i, s, o;
                try {
                    console.log("Track:", JSON.stringify(e)), t = e.action, o = e.params, n = e.custom, r = 1;
                ...
                try {
                    return console.log("Track event:", JSON.stringify(e)), window._gaq.push(["_trackEvent", e.category, e.action, e.opt_label])
                } catch (t) {
                ...
                var r;
                return r = e, n !== this.mainNamespace && (r = n + "." + e), window._gaq.push([r, t])
            }, e
        }()
    }.call(this),
    function() {
        Softgames.prototype.eventStartingGame = "starting-game", Softgames.prototype.eventLevelUp = "level-up", Softgames.prototype.eventGameOver = "game-over", Softgames.prototype.eventGameCompleted = "game-completed", Softgames.prototype.eventGamePause = "game-pause", Softgames.prototype.eventGameRestart = "game-restart", Softgames.prototype.eventSelectLevel = "select-level", Softgames.prototype.eventGoto = "goto", Softgames.prototype.eventSound = "sound", Softgames.prototype.trigger = function(e, t) {
            var n, r;
            n = null, r = null;
            switch (e.type) {
                case this.eventLevelUp:
                    n = "level", r = e.level, this.levelUp(e.level), e.prevoius_level_score !== undefined && this.sendScore(e.prevoius_level_score), this._enabledEndLevelFlow() ? this._startEndLevelFlow(t) : this.displayBanner(t), this.gameBubbleConfig.on_level_up && window.addToHome.show();
                    break;
                case this.eventGameOver:
                    n = "score", r = e.score, e.score !== undefined && this.sendScore(e.score), this._enabledEndLevelFlow() ? this._startEndLevelFlow(t) : this.displayBanner(t), this.gameBubbleConfig.on_game_over && window.addToHome.show();
                    break;
                case this.eventGameCompleted:
                    n = "score", r = e.score;
                    break;
                case this.eventGamePause:
                    n = "state", r = e.state, this.gameBubbleConfig.on_pause_on && e.state === "on" && window.addToHome.show();
                    break;
    ...
    function() {
        Softgames.prototype._invalidScore = function(e) {
            ...
            if (this._invalidScore(e)) {
                console.log("Invalid score: " + e), typeof t == "function" && t();
                return
            }
...
(function() {
    window.VoyagerApi = function() {
        ...
        return e.prototype.getScore = function() {}, e.prototype.sendScore = function(e, t) {}, e.prototype.levelUp = function(e, t) {}, e.prototype.rate = function(e, t) {}, e.prototype._apiRequest = function(e, t, n, r, i) {
            var s;
            return t = this._apiUrl(t, n), navigator.userAgent.toLowerCase().indexOf("android") >= 0 && e === "GET" && (t += "&android-buster=" + Math.random()), s = this._openXHR(e, t), s.setRequestHeader("Content-Type", "application/json-rpc"), s.setRequestHeader("Softgames-Voyager-Version", "2014-08-15 08:25:36 +0000"), s.onload = function() {
    ...
    function() {
        window.SG_jQuery = jQuery.noConflict(!0), I18n.fallbacks = !0, SG_jQuery('<link rel="stylesheet" type="text/css" href="//d3tlss08qwqpkt.cloudfront.net/assets/voyager-7070e2c6885cd82db46f9b4940eb073b.css" >').appendTo("head"), Softgames.prototype.defaultSubsystem = "m.softgames.de", Softgames.prototype.changeScreenSize = null, Softgames.prototype.changeScreenOrientation = null, Softgames.prototype.externalStyles = "", Softgames.prototype.splashScreenLogoLoaded = !1, Softgames.prototype.splashScreenLogoOnload = null, Softgames.prototype.splashScreenReady = !1, Softgames.prototype.skipAds = !1, Softgames.prototype.showAdPage = !1, Softgames.prototype.showGameDetailsPageWithoutAd = !1, Softgames.prototype.showAdPreroll = !1, Softgames.prototype.ingame_menu = "", Softgames.prototype.displayedBanner = !1, Softgames.prototype.externalGACode = "", Softgames.prototype.sessionBestScore = 0, Softgames.prototype.displayBannerLastTime = 0, Softgames.prototype.displayBannerInterval = 45e3, Softgames.prototype.endLevelEventCounter = 0, Softgames.prototype.endLevelEventCountInterval = 0, Softgames.prototype.enabledEndLevelFlow = !0, Softgames.prototype.displayEndLevelLastTime = 0, Softgames.prototype.displayEndLevelInterval = 45e3, Softgames.prototype.activeEndLevelFlow = !1, Softgames.prototype.endLevelCloseButtonTimer = 5e3, Softgames.prototype.displayLoadingPageTime = 1800, Softgames.prototype.adsConversionPoints = void 0, Softgames.prototype.adsConversionPointsMobile = void 0, Softgames.prototype.adsConversionPointsDesktop = void 0, Softgames.prototype.gameInitCallbackToCall = !1, Softgames.prototype.closeAdBannerCallback = !1, Softgames.prototype.isStarted = !1, Softgames.prototype.gameBubbleConfig = {
            on_start: !1,
            on_level_up: !1,
            on_game_over: !1,
            on_pause_on: !1
            ...
            var t = this;
            return this.host = "m.sgc.io/", this.isStarted ? null : (this.isStarted = !0, this.selectExperiment(), window.softgamesDocumentReady ? (this.system_id = this._getSystemId(), this.game_slug = this._getGameSlug(), this._isOperamini() ? this._redirectToOperaminiFallback() : this._init(function(e) {
                var n;
                return t._trackEvent("ready", t.locale), t._isiPhone() && !t._hasAppleMetaTag() && t._addAppleMetaTag(), n = SG_jQuery("head"), t._addExternalStyles(n), t.external_js_filename && t._loadScript(t.external_js_filename, !1), t._loadScript("http://c3po.softgames.de/c3po.js?_t=" + Math.random(), function() {
            ...
            var t, n = this;
            if (this.showAdPage !== "true" || this.skipAds === !0 && (this.showGameDetailsPageWithoutAd === undefined || this.showGameDetailsPageWithoutAd === !1)) return this._loadingFlowNextStep(e);
            t = this._randomId(), this._trackAction("gameDetailsPage"), this._dumpGameBody(), this._buildGameDetailsPage(t, function() {
                return n.displayBannerLastTime = 0, n._loadingFlowNextStep(e)
            }), this.ChannelId = this.afc_unit_details_page_id, this.bannerId = this.bannerIdGameDetailsPage;
            if (!this.showGameDetailsPageWithoutAd) return this._showAd(Softgames.prototype.pageGameDetails, t)
            ...
            var t, n = this;
            return this._trackAction("displayMoreGames-" + this.selectedExperimentName() + "/" + this.adRefreshCount), t = this._randomId(), this._destroyLoadingPage(), this._dumpGameBody(), this._buildMoreGamesPage(t, function() {
                return n._endLevelFlowNextStep(e)
            }), this.ChannelId = this.afc_unit_more_games_page_id, this.bannerId = this.bannerIdMoreGamesPage, this._showAd(Softgames.prototype.pageMoreGames, t)
        }, Softgames.prototype._displayOnCloseEndLevelAdPopup = function(e) {
            var t, n = this;
            return this._displayBannerShortInterval() || this.displayedBanner === !0 || this.skipAds === !0 ? typeof e == "function" ? e() : void 0 : (SG_jQuery("#voyager-menu-button-container").toggle(), this._trackAction("closeEndLevelAdPopup/" + this.adRefreshCount), t = this._randomId(), this._buildAdPopup(t, function() {
                return SG_jQuery("#voyager-menu-button-container").toggle(), typeof e == "function" ? e() : void 0
            }), this.ChannelId = this.afg_cc_id, this.ChannelTvId = this.tv_cc_id, this.bannerId = this.bannerIdOnCloseEndLevelAdPopup, this._showAd(Softgames.prototype.popupIngame, t, function() {
                return n.closeButton.click()
            }))
        }, Softgames.prototype._displayPrerollAdPopup = function(e) {
            var t, n = this;
            return this._displayBannerShortInterval() || this.displayedBanner === !0 || this.showAdPreroll !== "true" || this.skipAds === !0 ? this._loadingFlowNextStep(e) : (SG_jQuery("#voyager-menu-button-container").toggle(), this._trackAction("prerollAdPopup/" + this.adRefreshCount), t = this._randomId(), this._buildAdPopup(t, function() {
                return SG_jQuery("#voyager-menu-button-container").toggle(), n._loadingFlowNextStep(e)
            }), this.ChannelId = this.afg_cc_id, this.ChannelTvId = this.tv_cc_id, this.bannerId = this.bannerIdPrerollAdPopup, this._showAd(Softgames.prototype.popupPreroll, t, function() {
                return n.closeButton.click()
            }))
        }, Softgames.prototype._displayIngameAdPopup = function(e) {
            var t, n = this;
            return this._displayBannerShortInterval() || this.displayedBanner === !0 || this.skipAds === !0 ? typeof e == "function" ? e() : void 0 : (this.endLevelEventCounter = this.endLevelEventCounter + 1, SG_jQuery("#voyager-menu-button-container").toggle(), this._trackAction("ingameAdPopup/" + this.adRefreshCount), t = this._randomId(), this._buildAdPopup(t, function() {
                return SG_jQuery("#voyager-menu-button-container").toggle(), typeof e == "function" ? e() : void 0
            }), this.ChannelId = this.afg_cc_id, this.ChannelTvId = this.tv_cc_id, this.bannerId = this.bannerIdIngameAdPopup, this._showAd(Softgames.prototype.popupIngame, t, function() {
                return n.closeButton.click()
            }))
            ...
            return SG_jQuery("body").append(this.ingame_menu), e = SG_jQuery("#voyager-menu-button"), this._registerClick(e, function(e) {
                var t, n;
                return e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation(), t = document.getElementById("voyager-menu-container"), classie.toggle(t, "cbp-spmenu-open"), n = SG_jQuery("#voyager-menu-button").css("opacity") === "1" ? "0.5" : "1", SG_jQuery("#voyager-menu-button").css({
                    opacity: n
                }), e.cancelBubble = !0, !1
            })
            ...
            var n, r, i, s = this;
            return SG_jQuery("body").append(this.end_level_popup), this.closeButton = SG_jQuery("#voyager-close-button"), this._registerClick(this.closeButton, function(e) {
                return e.preventDefault(), clearTimeout(s.closeButtonTimer), SG_jQuery(".voyager-popup").remove(), typeof t == "function" ? t() : void 0
            ...
            }), this.closeButton.hide(), this.closeButtonTimer = setTimeout(function() {
                ...
                return t.preventDefault(), clearTimeout(s.closeButtonTimer), typeof e == "function" ? e() : void 0
            })
            ...
            return i = this["more_games_page_" + this.Experiments[this.selectedExperiment]], SG_jQuery("body").append(i), this._changeAdContainerId(e), n = SG_jQuery("#voyager-play-again-btn"), this._registerClick(n, function(e) {
                return e.preventDefault(), a._trackEvent("play-again-" + a.selectedExperimentName()), a._restoreGameBody(t)
            }), u = SG_jQuery("#voyager-score-value"), u.html(this.sessionBestScore), o = SG_jQuery("#voyager-ranking-value"), s = Math.floor(Math.random() * 10001) + 1, o.html("#" + s), r = SG_jQuery(".voyager-game-info-container"), SG_jQuery.each(r, function(e, t) {
                return a._registerClick(SG_jQuery(r[e]), function(e) {
                    return e.preventDefault(), a._trackEvent("goto-similar-game-" + a.selectedExperimentName()), setInterval(function() {
            ...
            var n, r = this;
            return SG_jQuery("body").append(this.first_page), this._changeAdContainerId(e), n = SG_jQuery(".voyager-success-btn"), this._registerClick(n, function(e) {
                return e.preventDefault(), r._restoreGameBody(t)
            })
        }, Softgames.prototype._dumpGameBody = function() {
            return this.gameBody = SG_jQuery("body").children(), this.gameBodyStyles = SG_jQuery("body").attr("style"), SG_jQuery("body").attr("style", ""), SG_jQuery("body").html("")
        }, Softgames.prototype._restoreGameBody = function(e) {
            var t = this;
            return SG_jQuery("body").text(""), SG_jQuery("body").attr("style", this.gameBodyStyles), this.gameBody.each(function(e, n) {
                return SG_jQuery("body").append(t.gameBody), t.gameBody[e].parent = SG_jQuery("body")
            }), typeof e == "function" ? e() : void 0
        }, Softgames.prototype._closeAdBanner = function(e) {
            return this.adOverlayContainer.remove(), this._trackEvent("close-ad"), this.displayedBanner = !1, typeof this.closeAdBannerCallback == "function" && this.closeAdBannerCallback(), typeof e == "function" ? e() : void 0
            ...
            var s;
            //return t = this._apiUrl(t, n), by jiazom
			return t = "./4399.json", navigator.userAgent.toLowerCase().indexOf("android") >= 0 && e === "GET" && (t += "&android-buster=" + Math.random()), s = this._openXHR(e, t), s.setRequestHeader("Content-Type", "application/json-rpc"), s.setRequestHeader("Softgames-Voyager-Version", "2014-08-15 08:25:33 +0000"), s.onload = function() {
                return typeof i == "function" ? i(JSON.parse(s.responseText)) : void 0
            }, s.onerror = function() {
                return console.log("Request failed.", e, t)
            }, s.send(JSON.stringify(r)), s
        }, Softgames.prototype._apiUrl = function(e, t) {
            return t = this._addToken(t), "http://" + this.host + e + "?" + this._queryString(t)
            ...
            }, !1), n = this.kirk_host + "session/?game_slug=" + this.game_slug, t = [], window.softgames._getUrlParameter("locale") !== undefined && (t[t.length] = "locale=" + window.softgames._getUrlParameter("locale")), window.softgames._getUrlParameter("p") !== undefined && (t[t.length] = "p=" + window.softgames._getUrlParameter("p")), window.softgames._getUrlParameter("uid") !== undefined && (t[t.length] = "uid=" + window.softgames._getUrlParameter("uid")), window.softgames._getUrlParameter("aff") !== undefined && (t[t.length] = "aff=" + window.softgames._getUrlParameter("aff")), t.length && (n = n.indexOf("?") === -1 ? n + "?" : n + "&", n += t.join("&")), this._createIframe(n)
            ...
            return t._apiRequest("GET", "" + t.system_id + "/games/" + t.game_slug + ".json/", n, {}, function(e) {
                return t.gameTitle = e.game_title, t.project = e.project, t.social_network = e.social_network, t.subplatform = e.subsystem, t.affiliate = e.affiliate, t.game_bubble_text = e.game_bubble_text, t.game_bubble_configs = t._convertGameBubblConfig(e.game_bubble_configs), t.showMenu = e.show_ingame_menu, t.back_url = e.back_url, t.externalStyles = e.external_styles, t.showAdPage = e.show_ad_page, t.showGameDetailsPageWithoutAd = e.show_game_details_page_without_ad, t.showAdPreroll = e.show_ad_preroll, t.enabledEndLevelFlow = e.enabled_end_level_flow, t.endLevelEventCountInterval = e.end_level_interval, e.end_level_close_button_timer !== void 0 && (t.endLevelCloseButtonTimer = e.end_level_close_button_timer * 1e3), t.external_js_filename = e.external_js_filename, e.ads_configuration !== void 0 && (t.adsConfigurations = SG_jQuery.parseJSON(e.ads_configuration)), t.ingame_header = e.ingame_header, t.ingame_footer = e.ingame_footer, t.first_page = e.first_page, t.ingame_ad_popup = e.ingame_ad_popup, t.ingame_menu = e.ingame_menu, t.splash_screen_page = e.splash_screen, t.loading_page = e.loading_page, t.end_level_popup = e.end_level_popup, t.more_games_page_a = e.more_games_page_a, t.more_games_page_b = e.more_games_page_b, t.externalGACode = e.agent_ga_code, t.skipAds = e.skip_ads, e.banner_interval_time !== void 0 && (t.displayBannerInterval = e.banner_interval_time * 1e3), t.displayEndLevelInterval = t.displayBannerInterval, e.ads_conversion_points_mobile !== void 0 && (t.adsConversionPointsMobile = e.ads_conversion_points_mobile), e.ads_conversion_points_desktop !== void 0 && (t.adsConversionPointsDesktop = e.ads_conversion_points_desktop), t.adsConversionPoints = t._isMobile() ? t.adsConversionPointsMobile : t.adsConversionPointsDesktop, t.adsConversionPoints === void 0 && (t.adsConversionPoints = t.adsConversionPointsMobile), t.tv_cc_id = e.tv_cc_id, t.afg_cc_id = e.afg_cc_id, t.afc_unit_details_page_id = e.afc_unit_details_page_id, t.afc_unit_more_games_page_id = e.afc_unit_more_games_page_id, e.premium_game = t.premium_game, e.subplatform = t.subplatform, t.locale = e.locale, I18n.locale = e.locale, t.tracker = new SoftgamesVoyagerTracker(t.externalGACode), t.openx = new OpenXJS({
                    deliveryUrl: t.openx_host,
                    parameters: t._getOpenxParams(e)
                }), t.ingame_header !== "" && t.ingame_header !== void 0 && SG_jQuery("body").append(t.ingame_header), t.ingame_footer !== "" && t.ingame_footer !== void 0 && SG_jQuery("body").append(t.ingame_footer), typeof r == "function" ? r() : void 0
            })
            ...
            var t, n, r = this;
            return this.openx_host = "http://ads.softgames.de/www/delivery/", this._getUrlParameters().host ? this.kirk_host = "//" + unescape(this._getUrlParameters().host) + "/api/" : this.kirk_host = "http://m.softgames.de/api/", this.defaultBackUrl = "http://m.softgames.de/", this.system_id === "sandbox" ? this._requestGameData("sandbox", this, void 0, function() {
                return r._setParamsFromUrl(), r._addToHomeConfig(), typeof e == "function" ? e() : void 0
            }) : this.system_id === "kirk" || this.system_id === "direct" ? (this.system_id = "kirk", this._getUrlParameters().p ? n = this._getUrlParameters().p : this._getUrlParameters().host ? n = this._getUrlParameters().host : n = this.defaultSubsystem, t = {}, t.subsystem = n, this._getUrlParameters().aff !== void 0 && (t.affiliate = this._getUrlParameters().aff), this._getUrlParameters().cache !== void 0 && (t.cache = this._getUrlParameters().cache), this._getUrlParameters().locale !== void 0 && (t.locale = this._getUrlParameters().locale), this._getUrlParameters().mobile_spec !== void 0 && (t.mobile_spec = this._getUrlParameters().mobile_spec), this._requestGameData(n, window.softgames, t, function() {
        ...
        }, Softgames.prototype.loadingFlowOrder = [Softgames.prototype._displayGameDetailsPage, Softgames.prototype._displaySplashScreen, Softgames.prototype._displayPrerollAdPopup], Softgames.prototype.loadingFlowStep = 0, Softgames.prototype.endLevelFlowOrder = [Softgames.prototype._displayEndLevelPopup, Softgames.prototype._displayLoadingPage, Softgames.prototype._displayMoreGamesPage, Softgames.prototype._displayLoadingPage], Softgames.prototype.endLevelFlowStep = 0, SG_jQuery(document).ready(function() {
