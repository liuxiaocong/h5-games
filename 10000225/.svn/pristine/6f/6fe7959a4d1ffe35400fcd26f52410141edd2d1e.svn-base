...
var SG = {
    ...
    loadVoyager : function(){
        ...
        //sgc.src = '//assets.sgc.io/assets/api/voyager.js?_='+random; // by jiazom
		sgc.src = './assets/api/voyager.js?_='+random; // by jiazom
        sgc.onload = SG.boot;
    ...
    detectPortalUrl:function(){
        ...
        if(typeof url !== "string") {
			//url="http://m.softgames.de"; by jiazom
			url ="#";
		} else {
			if (url.match(/^http:\/\//) == false) {
				//url="http://"+url;	by jiazom
				url = "#";
			}
		}
